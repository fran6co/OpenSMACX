...
class DecompilationState:
    ...
    annotation claims, and the lesson vocabulary recorded beside it. No
    parsing metadata leaks into the record - how the marker was spelled is
    the parser's concern, not the result's.
    """
    address: int
    mode: Mode
    state: State
