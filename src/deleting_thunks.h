...
typedef void(__thiscall func_deleting_dtor)(void *self);
typedef void *(__thiscall func_deleting_forward)(void *self,
                                                 unsigned int arg0);
typedef void *(__thiscall func_deleting_forward_nullary)(void *self);
