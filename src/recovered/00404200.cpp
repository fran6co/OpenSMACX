...
// 0x00404200  ?UNK1@AlphaMovie@@QAEXXZ  ->  ?UNK1@AlphaMovie@@QAEXXZ
//
...
/*
Purpose: Forward to the object's own virtual slot 58.
Original Offset: 00404200
Return Value: n/a
Status: Complete
*/
...
void AlphaMovie::UNK1() {
    reinterpret_cast<MovieVCall *>(this)->slot058();
}
