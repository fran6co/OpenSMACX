// ORIGINAL: 0x00447550 ?basewin_hide@UAmbience@@QAEXXZ 0x00447550-0x00447563 BYTE_EXACT
// size      19 bytes
...
/*
Purpose: Hide the base window through virtual slot 68, then clear the flag
         byte at +0x6C.
Original Offset: 00447550
Return Value: n/a
Status: Complete
*/
...
void UAmbience::basewin_hide() {
    reinterpret_cast<HideVCall *>(this)->slot068(6);
    *(reinterpret_cast<char *>(this) + 0x6c) = 0;
}
