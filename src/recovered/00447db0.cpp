...
// calls     (none)
// indirect  0x00447DB5 0x00447DBE
// 0x00447DB0  ?begin@AAmbience@@QAEXXZ  ->  ?begin@AAmbience@@QAEXXZ
//
...
void AAmbience::begin() {
    reinterpret_cast<BeginVCall *>(this)->slot007();
    reinterpret_cast<BeginVCall *>(this)->slot067(3);
}
