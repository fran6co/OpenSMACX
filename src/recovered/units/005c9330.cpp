...
// indirect  0x005C936A 0x005C937C
...
//   build/byte-match/005c9330/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?close@Gamma@@QAEXXZ  at 0x005C9330  (91 bytes)
//
...
void Gamma::close() {
    ...
    *reinterpret_cast<int *>(self + 0xa64) = 0;
    ...
    reinterpret_cast<Scroll *>(self + 0xef0)->close();
    reinterpret_cast<EditBox *>(self + 0x303c)->close();
    reinterpret_cast<VCall *>(self + 0x3bb0)->slot090();
    reinterpret_cast<VCall *>(self + 0x46b0)->slot090();
