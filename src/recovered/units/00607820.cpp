...
//   build/byte-match/00607820/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_mouse_leave@BaseButton@@QAEXHH@Z  at 0x00607820  (45 bytes)
//
...
void BaseButton::on_mouse_leave(int a1, int a2) {
    VCall *active = reinterpret_cast<VCall *>(
        *g_009b7acc != 0 ? *g_009b7acc : *g_009b7ad0);
    if (active == reinterpret_cast<VCall *>(this) &&
        *g_009b7ad4 == 1) {
