...
// calls     (none)
// indirect  0x005F1428 0x005F1440 0x005F1469
...
//   build/byte-match/005f1420/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?OnNCHitTest@Win@@QAAJPAXHH@Z  at 0x005F1420  (81 bytes)
//
...
// This body dispatches through slot(s): 75
class VCall { public:
    ...
    virtual long slot075(int, int);  // <-- used
};
...
long __cdecl OnNCHitTest(void *a1, int a2, int a3) {
    long p = (*reinterpret_cast<GetWindowLongAFn *>(g_0066934c))(a1, -0x15);
    if (p != 0) {
        return reinterpret_cast<VCall *>(p)->slot075(a2, a3);
    }
    return (*reinterpret_cast<DefWindowProcAFn *>(g_006692b0))(
        a1, 0x84, 0,
        (static_cast<unsigned int>(static_cast<unsigned short>(a3)) << 16)
