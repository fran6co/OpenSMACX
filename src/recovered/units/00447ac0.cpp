...
// calls     (none)
// indirect  0x00447ACB 0x00447AD7 0x00447AE3
...
//   build/byte-match/00447ac0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?design_window_hide@BAmbience@@QAEXXZ  at 0x00447AC0  (43 bytes)
//
...
void BAmbience::design_window_hide() {
    char *self = reinterpret_cast<char *>(this);
    VCall *object = reinterpret_cast<VCall *>(this);
    *reinterpret_cast<uint8_t *>(self + 0x6d) = 0;
    object->slot068(0x14);
    object->slot068(0x15);
    object->slot068(0x16);
}
