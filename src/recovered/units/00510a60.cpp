...
//   build/byte-match/00510a60/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?prev_cursor@Console@@QAEXXZ  at 0x00510A60  (272 bytes)
//
...
void Console::prev_cursor() {
    char *self = reinterpret_cast<char *>(this);
    int had_move = *reinterpret_cast<int *>(self + 0x23C00);
    *reinterpret_cast<int *>(self + 0x23BF8) = 0;
    ...
    if (*g_00939288 != 0) {
        ambience(0x1E);
        int had_move2 = *reinterpret_cast<int *>(self + 0x23C00);
        *reinterpret_cast<int *>(self + 0x23BD8) = 0;
        *reinterpret_cast<int *>(self + 0x23BF8) = 1;
        *reinterpret_cast<int *>(self + 0x23BFC) = 1;
        if (had_move2 != 0) {
            *reinterpret_cast<int *>(self + 0x23C00) = 0;
            reinterpret_cast<MapWin *>(*g_007d3c3c)->draw_map(1);
        }
    ...
    int cursor_timer = *reinterpret_cast<int *>(self + 0x23C08) - 1;
    *reinterpret_cast<int *>(self + 0x23C08) = cursor_timer;
    if (cursor_timer < 0) {
        *reinterpret_cast<int *>(self + 0x23C08) = 0x1F;
    }
    int idx = *g_009392b8;
    reinterpret_cast<StatusWin *>(g_008c5568)->set_loc(g_009392c0[idx], g_00939340[idx]);
    idx = *g_009392b8;
    reinterpret_cast<MapWin *>(*g_007d3c3c)->focus(g_009392c0[idx], g_00939340[idx]);
}
