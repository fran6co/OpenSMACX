...
// calls     0x00420F90 0x00462870 0x005D4DD0 0x005D7410 0x00607040 0x00607DA0 0x00616200 0x00618EE0 0x006252B0 0x006456E4
...
//   build/byte-match/005adf10/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ??1ReplayWin@@QAE@XZ  at 0x005ADF10  (667 bytes)
//
...
static int *const g_00662442 = (int *)0x00662442;
...
static int *const g_0067f1b0 = (int *)0x0067F1B0;
...
ReplayWin::~ReplayWin() {
    ...
    reinterpret_cast<Time *>(self + 0x252ec)->~Time();

    char *btn = self + 0x247a0;
    *reinterpret_cast<void **>(btn) = g_00669754;
    *reinterpret_cast<void **>(btn + 0x444) = g_0066974c;
    reinterpret_cast<FlatButton *>(btn)->close();
    reinterpret_cast<BaseButton *>(btn)->~BaseButton();

    char *gw = self + 0x23d8c;
    char *mapWin = gw - 0x21a6c;  // == self + 0x2320

    {
        int *vtbl = *reinterpret_cast<int **>(mapWin);
        int voff = vtbl[1];
        *reinterpret_cast<void **>(gw - 0x21a6c + voff) = g_0066a57c;
    }
    {
        int *vtbl = *reinterpret_cast<int **>(mapWin);
        int voff = vtbl[1];
        *reinterpret_cast<void **>(gw - 0x21628 + voff) = g_0066a574;
    }
    {
        int *vtbl = *reinterpret_cast<int **>(mapWin);
        int voff = vtbl[1];
        *reinterpret_cast<int *>(gw - 0x21a70 + voff) = voff - 0x21a6c;
    }

    reinterpret_cast<MapWin *>(mapWin)->clear(0);

    fn_006456e4(gw - 0x2b18, 0xabc, 4,
                reinterpret_cast<void (*)(void *)>(g_00625310));

    reinterpret_cast<Font *>(gw - 0x2b4c)->~Font();
    reinterpret_cast<Font *>(gw - 0x2b78)->~Font();
    reinterpret_cast<Font *>(gw - 0x2ba4)->~Font();
    reinterpret_cast<Buffer *>(gw - 0x3134)->~Buffer();
    reinterpret_cast<Buffer *>(gw - 0x36bc)->~Buffer();
    reinterpret_cast<Buffer *>(gw - 0x3c44)->~Buffer();
    reinterpret_cast<TextureStore *>(gw - 0x3f60)->~TextureStore();

    fn_006456e4(gw - 0x210e0, 0x260, 0xc4,
                reinterpret_cast<void (*)(void *)>(g_006252b0));
    fn_006456e4(gw - 0x21a60, 0x260, 4,
                reinterpret_cast<void (*)(void *)>(g_006252b0));

    reinterpret_cast<GraphicWin *>(gw)->~GraphicWin();
