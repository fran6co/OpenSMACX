...
//   build/byte-match/005f2940/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_rects@Win@@QAEXXZ  at 0x005F2940  (378 bytes)
//
...
// The emitter's VCall shim declares slot067 nullary; this call needs two
// int arguments, so a second shim mirrors the same vtable layout with
// only that slot's signature widened.
...
void Win::set_rects() {
    if (this->iSomeFlag_ & 2) {
        ...
        reinterpret_cast<VCall67 *>(this)->slot067(0, -1);
    }
}
