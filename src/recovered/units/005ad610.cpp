...
// calls     0x005AD560 0x005D5250 0x005DAC70 0x005DACB0 0x005DD130 0x005E2DD3 0x006453E0
// indirect  0x005AD715
...
//   build/byte-match/005ad610/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_redraw@ReplayWin@@QAEXXZ  at 0x005AD610  (271 bytes)
//
...
void ReplayWin::on_redraw() {
    ...
    buf->box_sprite(&r, reinterpret_cast<BoxSpriteParams *>(g_0078d690));
    ...
    char *name = self + 0x2220;
    if (name) {
        size_t len = _strlen(name);
        buf->write_cent_l(name, &r, static_cast<int>(len));
    }

    make_bases();

    int *a = *reinterpret_cast<int **>(self + 0x2320);
    int b = *reinterpret_cast<int *>(reinterpret_cast<char *>(a) + 4);
    VCall *target = reinterpret_cast<VCall *>(self + 0x2320 + b);
    target->slot012();
}
