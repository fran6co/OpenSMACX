// ORIGINAL: 0x00614B60 BYTE_EXACT FILE
// name      ?UNK5@FileWin@@QAEXXZ
// size      24 bytes
// spans     0x00614B60-0x00614B78
// prototype void (__thiscall ?UNK5@FileWin@@QAEXXZ)(FileWin* this)
...
//   build/byte-match/00614b60/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?UNK5@FileWin@@QAEXXZ  at 0x00614B60  (24 bytes)
//
...
// This body tail-dispatches through slot 58 (offset 0xe8).
class VCall { public:
    ...
    virtual void slot057(); virtual void slot058();  // <-- used
};
...
void FileWin::UNK5() {
    *reinterpret_cast<int *>(reinterpret_cast<char *>(this) + 0x638) = 0x12c;
    reinterpret_cast<VCall *>(*reinterpret_cast<void **>(reinterpret_cast<char *>(this) + 0x63c))->slot058();
}
