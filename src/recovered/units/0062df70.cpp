...
//   build/byte-match/0062df70/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?start_voice@Net@@QAEHJ@Z  at 0x0062DF70  (78 bytes)
//
...
int Net::start_voice(long a1) {
    ...
    if ((*reinterpret_cast<unsigned int *>(self + 0xd8) & 0x60000000) == 0) {
        ...
        *reinterpret_cast<int *>(self + 0xd4) = a1;
