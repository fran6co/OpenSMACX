...
// calls     0x0044AE50 0x00496670 0x004ACB80 0x004E25B0 0x0050BA30 0x0052E050 0x005900D0 0x005A9EB0 0x005ABD10 0x005ABD20 0x005ADBF0 0x005BF310 0x006262F0
...
//   build/byte-match/00514b30/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?retire_game@Console@@QAEXXZ  at 0x00514B30  (507 bytes)
//
...
void __cdecl hall_of_fame(int);
void __cdecl kill_auto_save();
void __cdecl log_say(char *, int, int, int);
void __cdecl quayle(int);
void __cdecl report_score(int);
void __cdecl show_replay();

// ---- fixed globals this body references ----
// The const-pointer spelling reproduces the original's
// encoding including the address; `extern T *g` does not.
static int *const g_0068a818 = (int *)0x0068A818;
static int *const g_0068a828 = (int *)0x0068A828;
static int *const g_0068a838 = (int *)0x0068A838;
static int *const g_0068a848 = (int *)0x0068A848;
...
void Console::retire_game() {
    ...
    if ((*g_0093f660 != 0 || *g_0093a95c != 0)
        && bit_count(1 < static_cast<uint8_t>(*reinterpret_cast<uint8_t *>(g_009a64e8))) != 0) {
        msg = reinterpret_cast<const char *>(g_0068a818);
    } else {
        msg = reinterpret_cast<const char *>(g_0068a828);
        if ((*g_009a649c & 0x400) == 0) {
            msg = reinterpret_cast<const char *>(g_0068a838);
        }
    }
    ...
    if (X_pop(msg, 0) != 0) {
        ...
        if (*g_0093f660 != 0) {
            ...
            *g_0093e960 = 0xff;
            *g_0093e908 = 0;
            memset(g_0093e910, 0, 8 * sizeof(int32_t));
        ...
        report_score(1);
        if ((*reinterpret_cast<uint8_t *>(g_009a64c0) & 0x10) == 0) {
            quayle(*g_00939284);
            hall_of_fame(1);
        }
        if (closedNet == 0) {
        ...
        *g_0093a948 = closedNet == 0;
        *g_009b2068 = 1;
        log_say(reinterpret_cast<char *>(g_0068a848), 0, 0, 0);
    }
}
