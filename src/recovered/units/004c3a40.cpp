// ORIGINAL: 0x004C3A40 ?hide_all@WorldWin@@QAEXXZ 0x004C3A40-0x004C3A6B FILE
// size      43 bytes
...
//   build/byte-match/004c3a40/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?hide_all@WorldWin@@QAEXXZ  at 0x004C3A40  (43 bytes)
//
...
void WorldWin::hide_all() {
    reinterpret_cast<ButtonGroup *>(g_007cd12c)->set(-1, 0);

    char *obj = *reinterpret_cast<char **>(g_007d3c40);
    int *vtable = *reinterpret_cast<int **>(obj);
    int delta = vtable[1];
    reinterpret_cast<VCall *>(obj + delta)->slot002();
