...
//   build/byte-match/004aca40/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?report_ops@@YAXXZ  at 0x004ACA40  (76 bytes)
//
...
// Slot 57 needs (int, void*, void*), so a shadow of VCall gives it the
// right signature at the same vtable position; the 57 filler slots
// ahead of it exist only to hold the layout, per the shim's own comment.
...
void __cdecl report_ops() {
    int index = *g_007d392c;
    *g_00885f40 = 4;
    if (reinterpret_cast<int *>(g_007ae778)[index] != 5) {
        reinterpret_cast<VCall57 *>(g_00876478)->slot057(
