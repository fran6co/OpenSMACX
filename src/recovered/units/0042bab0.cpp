...
// EXTERN-SYMBOL LEVER: both tables are walked by pointer arithmetic
// (add reg, 0xC / add reg, 0x20 each iteration), not a plain load, so they
// need real linkage rather than the scaffold's folded literal pointer.
extern int g_0096c8ac_sym[];
extern int g_00691884_sym[];
