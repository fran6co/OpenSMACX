...
// calls     0x004E2A30 0x004E2E50 0x005BF420
...
//   build/byte-match/004e29e0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?do_join_or_create@AlphaNet@@QAEHXZ  at 0x004E29E0  (79 bytes)
//
...
class AlphaNet { public:
    int create();
    int join();
    int do_join_or_create();
};

int AlphaNet::do_join_or_create() {
    int result = X_pop(reinterpret_cast<char *>(g_0068925c),
                        reinterpret_cast<const char *>(g_00689240),
                        0x50, 0);
    if (result < 0) {
        return 1;
    }
