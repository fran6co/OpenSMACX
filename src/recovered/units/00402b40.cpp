...
//   build/byte-match/00402b40/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: SessionStruct::dt  at 0x00402B40  (102 bytes)
//
...
extern "C" int __stdcall fn_00402b40(int a1)
{
    __asm {
        lea     esi, [ecx-1Ch]
        _emit   57h
        ...
        mov     dword ptr [ecx+esi+4], 669404h
        _emit   8Bh
        _emit   0CFh
        call    fn_00402970
