...
// indirect  0x005F643C 0x005F64A9 0x005F64B4 0x005F64C2 0x005F64CD 0x005F64D8 0x005F64E9 0x005F64F4 0x005F64FB 0x005F652E
...
//   build/byte-match/005f63c0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_l_button_down@Win@@QAEXJHHIH@Z  at 0x005F63C0  (398 bytes)
//
...
// This body dispatches through slot(s): 7, 23, 28, 38, 61, 65, 88
class VCall { public:
...
class Win { public:
    ...
    void left_down_event(int, int, int);
    void __cdecl update_zorder();
    void bring_child_to_top(Win *);
    void on_l_button_down(long, int, int, unsigned int, int);
};

// Same vtable shape as the emitted VCall, but the slots this body dispatches
// through need arguments/return values the emitter's nullary-void slots don't
// carry.
class VCallX { public:
    virtual void slot000();
    virtual void slot001();
    ...
    virtual void slot086();
    virtual void slot087();
    virtual int slot088(int, int);  // <-- used
};
...
void Win::on_l_button_down(long a1, int a2, int a3, unsigned int a4, int a5) {
    ...
    if (child != 0) {
        ...
        if (count > 0) {
            int32_t *p = g_009b6e48;
            for (;;) {
                if (*p == reinterpret_cast<int32_t>(self)) {
                    if (idx < count) {
                        if (idx > 0) {
                            int32_t *q = g_009b6e48 + idx;
                            do {
                                *q = *(q - 1);
                                --q;
                                --idx;
                        ...
                        *g_009b6e48 = reinterpret_cast<int32_t>(self);
                    }
                    break;
                }
                ++idx;
    ...
    if (a4 == 0) {
        *g_009b7ad0 = 0;
        *g_009b7acc = reinterpret_cast<int32_t>(self);
    } else {
        *g_009b7acc = 0;
