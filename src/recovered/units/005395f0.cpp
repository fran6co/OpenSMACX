...
//   build/byte-match/005395f0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?net_tech@@YAXHHHH@Z  at 0x005395F0  (108 bytes)
//
...
void __cdecl tech_achieved(int factionID1, int techID, int factionID2, int);
...
void __cdecl net_tech(int a1, int a2, int a3, int a4) {
    if (*g_0093f660 != 0) {
        log_say(reinterpret_cast<char *>(g_0068d4f0), a1, a2, a3);
