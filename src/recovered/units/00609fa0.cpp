...
//   build/byte-match/00609fa0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_selected_id@ListBox@@QAEXH@Z  at 0x00609FA0  (115 bytes)
//
...
void ListBox::set_selected_id(int a1) {
    char *self = reinterpret_cast<char*>(this);
    int base0 = *reinterpret_cast<int*>(self);
    int iVar1 = *reinterpret_cast<int*>(base0 + 8);
    char *arr = self + iVar1 + 0xBC;
    int iVar2 = *reinterpret_cast<int*>(self + iVar1 + 0xC4);
    if (iVar2 != 0) {
        int iVar3 = *reinterpret_cast<int*>(arr + 0x10);
        *reinterpret_cast<int*>(arr + 0x14) = 0;
        *reinterpret_cast<int*>(arr + 0xC) = iVar2;
        if (iVar3 > 0) {
            int count = 0;
            do {
                int node = *reinterpret_cast<int*>(arr + 0xC);
                if (*reinterpret_cast<int*>(node + 4) == a1) {
                    int base0b = *reinterpret_cast<int*>(self);
                    int iVar1b = *reinterpret_cast<int*>(base0b + 8);
                    set_selected_pos(*reinterpret_cast<int*>(self + iVar1b + 0xD0), 1);
                    return;
                }
                ++count;
                *reinterpret_cast<int*>(arr + 0x14) = *reinterpret_cast<int*>(arr + 0x14) + 1;
                *reinterpret_cast<int*>(arr + 0xC) = *reinterpret_cast<int*>(node + 0xC);
            } while (count < iVar3);
        }
    }
    set_selected_pos(-1, 1);
}
