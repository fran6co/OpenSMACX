...
// The catalogue's _itoa has forgotten its parameters (an empty-parens C
// declaration means exactly zero args in C++, not "unspecified"), and it
// can't be redeclared here without colliding with the scaffold's own
// extern "C" line above - so its address is retyped through a function
// pointer cast at the call site instead.
