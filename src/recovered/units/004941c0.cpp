// ORIGINAL: 0x004941C0 ?on_left_click@ProdPicker@@QAEXHH@Z 0x004941C0-0x0049422F FILE
// size      111 bytes
...
//   build/byte-match/004941c0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_click@ProdPicker@@QAEXHH@Z  at 0x004941C0  (111 bytes)
//
...
void ProdPicker::on_left_click(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    int q1 = a2 / *reinterpret_cast<int *>(self + 0xa820);
    int old_val = *reinterpret_cast<int *>(self + 0xa774);
    int prod = q1 * *reinterpret_cast<int *>(self + 0xa810);
    int q2 = a1 / *reinterpret_cast<int *>(self + 0xa81c);
    int new_val = *reinterpret_cast<int *>(self + 0xa77c) + prod + q2;
    *reinterpret_cast<int *>(self + 0xa774) = new_val;
    if (old_val != new_val) {
        field_B64_ = 0;
        draw_item(old_val, 0);
        draw_item(*reinterpret_cast<int *>(self + 0xa774), 0);
