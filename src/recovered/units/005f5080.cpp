// ORIGINAL: 0x005F5080 BYTE_EXACT FILE
// name      ?add_parent@Win@@QAAXPAUWin@@@Z
// size      85 bytes
// spans     0x005F5080-0x005F50D5
// prototype 
...
void __cdecl add_parent(Win * a1) {
    ...
    if (flags & 0x2000000) {
        reinterpret_cast<Win **>(g_009b6e48)[count] = a1;
        *g_009b7b34 = count + 1;
        return;
    }
    if (count > 0) {
        Win **p = reinterpret_cast<Win **>(g_009b6e48) + count;
        int n = count;
        do {
            Win *tmp = *(p - 1);
            *p = tmp;
    ...
    reinterpret_cast<Win **>(g_009b6e48)[0] = a1;
    *g_009b7b34 = count + 1;
}
