...
// The emitter's VCall shim declares every slot nullary; slot057 here is
// called with three arguments, so it needs its own shim with the real
// signature on that one slot (rule 4).
