// ORIGINAL: 0x0042B300 FILE
// name      ?set_cat_concept@Datalink@@QAEXXZ
// size      391 bytes
// spans     0x0042B300-0x0042B487
// prototype void (__thiscall ?set_cat_concept@Datalink@@QAEXXZ)(Datalink* this)
// callers   2   call targets   13
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x005D5930 0x005DAC70 0x005DACB0 0x005DD130 0x005E2DD3 0x005FD530 0x005FD550 0x005FD570 0x0060C920 0x006169A0 0x006453E0 0x00645470 0x0064FC88
...
//   build/byte-match/0042b300/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_cat_concept@Datalink@@QAEXXZ  at 0x0042B300  (391 bytes)
//
...
// Moved ahead of BaseButton/FlatButton, which embed a Buffer BY VALUE
// (`Buffer buffer_;`) - the emitter placed the full Buffer definition
// after them (it only needs a forward declaration for everyone else,
// who hold Buffer* pointers), which left the by-value members using an
// incomplete type (C2079). Spot moves with it since Buffer embeds a
// Spot BY VALUE too. Declaration order only; no field or method here
// differs from what the emitter computed.
class Spot { public:
    void * spots_;
    uint32_t max_count_;
    uint32_t add_count_;
...
// (Buffer moved above BaseButton - see comment there.)
...
static int *const g_006832f8 = (int *)0x006832F8;
static int *const g_00683300 = (int *)0x00683300;
static int *const g_0068330c = (int *)0x0068330C;
...
void Datalink::set_cat_concept() {
    if (text_open(reinterpret_cast<char *>(g_00683300), reinterpret_cast<char *>(g_006832f8)) == 0) {
        text_get();
        int32_t i = 0;
        while (*reinterpret_cast<char **>(g_009b7d00) != 0 &&
               strlen(*reinterpret_cast<char **>(g_009b7d00)) != 0) {
            *reinterpret_cast<char *>(g_009b86a0) = 0;
            ...
            if (*g_009a64c0 & 0x1000) {
                strcat(reinterpret_cast<char *>(g_009b86a0), reinterpret_cast<char *>(g_0068330c));
                char numBuf[0x60];
                reinterpret_cast<ItoaFn>(_itoa)(i, numBuf, 10);
                strcat(reinterpret_cast<char *>(g_009b86a0), numBuf);
            }
            reinterpret_cast<ListBox *>(reinterpret_cast<char *>(this) + 0xf628)->item(
                reinterpret_cast<char *>(g_009b86a0), i);
            ++i;
            text_get();
        }
        text_close();
        ...
        int32_t *src = reinterpret_cast<int32_t *>(self + 0x103d4);
        ...
        int32_t idx = *reinterpret_cast<int32_t *>(*reinterpret_cast<char **>(g_009b90f8) + 0xb20);
        char *str = reinterpret_cast<char *>(reinterpret_cast<Strings *>(g_009b90d8)->get(idx));
        if (str != 0) {
            uint32_t len = strlen(str);
            buf->write_cent_l(str, &r, len);
        }
