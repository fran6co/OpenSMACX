...
//   build/byte-match/005f4ab0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?bring_to_top@Win@@QAEXXZ  at 0x005F4AB0  (372 bytes)
//
...
void Win::bring_to_top() {
    ...
    int i = 0;
    if (count > 0) {
        int *slot = g_zorder_list;
        do {
            if (*slot == reinterpret_cast<int>(this)) break;
            i++;
            slot++;
        } while (i < count);
    }
