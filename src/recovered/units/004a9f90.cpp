// ORIGINAL: 0x004A9F90 BYTE_EXACT FILE
// name      ?close_ops@ReportIf@@QAEXXZ
// size      287 bytes
// spans     0x004A9F90-0x004AA0AF
// prototype void (__thiscall ?close_ops@ReportIf@@QAEXXZ)(ReportIf* this)
// callers   2   call targets   3
// kind      game
// flags     sp_ready;purged_ok
// calls     0x004C3A40 0x005EDCD0 0x00609F20
// indirect  0x004A9FAA 0x004A9FB9 0x004A9FC8 0x004A9FD7 0x004A9FE6 0x004A9FF5 0x004AA004 0x004AA013 0x004AA022 0x004AA09C
...
//   build/byte-match/004a9f90/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?close_ops@ReportIf@@QAEXXZ  at 0x004A9F90  (287 bytes)
//
...
// g_007b39e8's address does work here: it is the base of a pointer that a
// do-while loop steps by a constant stride (0xb4c) and the two endpoints
// (0x7B39E8, 0x7B4534) are exactly one stride apart, so a folded literal
// base lets /O2 see the whole 2-entry walk at compile time and unroll it
// into two straight-line calls instead of a loop. The indexed-table-base
// lever: `extern int name[];` keeps the base opaque to the optimizer.
extern int g_007b39e8_tbl[];
...
void ReportIf::close_ops() {
    char *self = reinterpret_cast<char *>(this);

    reinterpret_cast<ListBox *>(self + 0xa2d0)->close();
    reinterpret_cast<VCall *>(self + 0xd138)->slot002();
    reinterpret_cast<VCall *>(self + 0xdc84)->slot002();
    reinterpret_cast<VCall *>(self + 0xe7d0)->slot002();
    reinterpret_cast<VCall *>(self + 0xf31c)->slot002();
    reinterpret_cast<VCall *>(self + 0xfe68)->slot002();
    reinterpret_cast<VCall *>(self + 0x109b4)->slot002();
    reinterpret_cast<VCall *>(self + 0x11500)->slot002();
    reinterpret_cast<VCall *>(self + 0x1204c)->slot002();
    reinterpret_cast<VCall *>(self + 0x12b98)->slot002();
    ...
    if (state != 4 && state != 5) {
        ...
        int p = reinterpret_cast<int>(g_007b39e8_tbl);
        do {
            reinterpret_cast<VCall *>(p)->slot002();
            p += 0xb4c;
        } while (p <= reinterpret_cast<int>(g_007b4534));
    }
}
