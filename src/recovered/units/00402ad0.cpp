// ORIGINAL: 0x00402AD0 sub_402ad0 0x00402AD0-0x00402B36 FILE
// size      102 bytes
// prototype 
...
//   build/byte-match/00402ad0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_402ad0  at 0x00402AD0  (102 bytes)
//
...
extern "C" __declspec(naked) int __stdcall sub_402ad0(int a1)
{
    __asm {
        push    ebp
        mov     ebp, esp
        ...
        push    edi
        lea     edi, [esi]
        mov     dword ptr [edi], 6693F4h
        mov     eax, [esi+4]
        mov     ecx, [eax+4]
        mov     dword ptr [ecx+esi+4], 6693F0h
        mov     ecx, edi
        call    fn_00402970
