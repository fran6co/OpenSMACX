...
// calls     0x005D5930 0x005D8000 0x005DAC70 0x005DACB0 0x005DC360 0x005DD130 0x005DD3B0 0x005DD530 0x005E2DD3 0x005FD2B0 0x005FD530 0x005FD550 0x005FD570 0x005FD670 0x005FD740 0x006169A0 0x006453E0 0x00645460 0x00645470 0x0064FC88
...
// refusal        u004b0410.cpp(212) : error C2079: 'buffer_' uses undefined class 'Buffer' u004b0410.cpp(343) : error C2079: 'buffer_' uses undefined class 'Buffer'
//
// The WHOLE unit as measured, scaffolding included: for the units
// that are byte-exact yet refuse extraction, the agent tuned the
// emitted scaffolding and the body alone will not reproduce the
// verdict. To resume, copy everything below back over
//   build/byte-match/004b0410/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?draw_overview@SocialWin@@QAEXXZ  at 0x004B0410  (1162 bytes)
//
...
static int *const g_007aec74 = (int *)0x007AEC74;
static int *const g_007aec94 = (int *)0x007AEC94;
static int *const g_00946580 = (int *)0x00946580;
static int *const g_009466b8 = (int *)0x009466B8;
...
void SocialWin::draw_overview() {
    ...
    int *base1f250 = (int *)((char *)this + 0x1f250);
    *g_007aec74 = 5;

    int local_1c = base1f250[0];
    int local_18 = base1f250[1];
    int local_14 = base1f250[2];
    int local_10 = base1f250[3];
    {
        RECT ra = {local_1c, local_18, local_14, local_10};
        buf->box_sprite(&ra, (BoxSpriteParams *)g_0078d5a0);
    }

    int local_40 = local_1c + 3;
    int local_3c = local_18 + 3;
    local_10 = local_10 - 3;
    int local_38 = local_14 - 3;
    int local_34 = local_18 + 0x17;
    local_1c = local_40;
    local_18 = local_3c;
    local_14 = local_38;
    {
        RECT rb = {local_40, local_3c, local_38, local_10};
        buf->box_sprite(&rb, (BoxSpriteParams *)g_0078d618);
    }

    ((Buffer *)((char *)this + 0x1ee68))->set_font(0, 0, 0, 0);
    buf->set_text_color(0x9f, -1, 1, 1);

    int strAddr = ((Strings *)g_009b90d8)->get(*(int *)(*(int *)g_009b90f8 + 0xb90));
    if (strAddr != 0) {
        char *s = (char *)strAddr;
        unsigned len = strlen(s);
        RECT ra2 = {local_1c, local_18, local_14, local_10};
        buf->write_cent_l(s, &ra2, len);
    }

    local_18 = local_34 + 2;
    {
        RECT rc = {local_1c, local_18, local_14, local_10};
        buf->box_sprite(&rc, (BoxSpriteParams *)g_0078d528);
    }

    ((Buffer *)((char *)this + 0x1ef58))->set_font(0, 0, 0, 0);
    int local_30 = local_1c + 0xf;
    local_14 = local_14 - 3;
    int local_2c = local_18;
    int local_c = 0;
    local_1c = local_1c + 0x14;
    text_open((char *)g_00691afc, (char *)g_00687494);

    char local_b98[2816];
    char *pcVar2 = local_b98;
    char *puVar7 = (char *)g_00946580;
    int *piVar6 = (int *)((char *)this + 0xd08);
    int local_8 = 0;
    unsigned local_48 = 0;

    do {
        if (puVar7 != (char *)g_009466b8) {
            *(char *)g_009b86a0 = 0;
            strcat((char *)g_009b86a0, (char *)g_0068749c);
            strcat((char *)g_009b86a0, puVar7);
            int rc4 = text_open(0, (char *)g_009b86a0);
            if (rc4 != 0) {
                text_close();
                return;
            }
            *pcVar2 = 0;
            text_get();
            local_8 = text_item_number();
            char *item = text_item();
            strcpy(pcVar2, item);
            if (local_8 < *piVar6) {
                do {
                    text_get();
                    char *s2 = *(char **)g_009b7d00;
            ...
            int wh = buf->wrap_height(pcVar2, local_14 - local_1c);
            local_c += wh;
        }
        puVar7 += 0x68;
        piVar6 += 1;
        pcVar2 += 0x100;
    } while ((int)(unsigned char *)puVar7 < (int)g_009469f8);

    text_close();

    local_18 = local_18 + ((local_10 - local_c) - local_18) / 2;
    char *local_28 = local_b98;
    local_c = 0;
    piVar6 = (int *)((char *)this + 0xd08);
    int faction = *(int *)((char *)this + 0xcf4);
    do {
        int *outPiVar6 = piVar6;
        if (local_c != 3) {
            if (local_20 == local_c) {
                buf->set_text_color(0xff, -1, 1, 1);
            } else {
                int color;
                int tableVal = *(int *)((char *)g_0096cc2carr + local_c * 4 + faction * 0x20cc);
                if (*(int *)((char *)this + 0x2c24) == local_c) {
                    color = 0x9c;
                } else if (*piVar6 == tableVal) {
                    color = 0xa0;
                } else if (tableVal < *piVar6) {
                    color = 0xfa;
                } else {
                    color = 0xf9;
                }
            ...
            *(char *)g_009b86a0 = 0;
            if (*piVar6 > 0) {
                strcat((char *)g_009b86a0, (char *)g_006874a0);
            }
            char numbuf[80];
            my_itoa(*piVar6, numbuf, 10);
            strcat((char *)g_009b86a0, numbuf);
            Buffer *buf1ef58 = (Buffer *)((char *)this + 0x1ef58);
            buf1ef58->set_font(0, 0, 0, 0);
            int y = local_18;
            unsigned n2 = strlen((char *)g_009b86a0);
            buf->write_right_l((char *)g_009b86a0, local_30, y, n2);

            int tableVal2 = *(int *)((char *)g_0096cc2carr + local_c * 4 + faction * 0x20cc);
            outPiVar6[0xb] = tableVal2;

            if (local_48 != 0) {
                buf1ef58->set_font(0, 0, 0, 0);
                RECT rw = {local_1c, local_18, local_14, local_10};
                local_18 = buf->wrap(local_28, &rw);
            }

            int off;
            if (*piVar6 < 0) {
                off = *(int *)((char *)this + 0x1ef64);
            } else {
                off = *(int *)((char *)this + 0x1ef68) + *piVar6;
            }
            local_2c += off;
        }
        local_c++;
    ...
    *g_007aec74 = 5;
    ((GraphicWin *)g_007ae820)->soft_update((RECT *)base1f250);
    do_sound();
}
