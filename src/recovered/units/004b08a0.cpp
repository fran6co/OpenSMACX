...
// `_itoa` is catalogued nullary; the call site pushes three real arguments.
extern "C" char *__cdecl my_itoa(int, char *, int);
// Per-faction record fields the emitter left as plain pointers (indexed via
// a register-scaled address, `[eax*4 + ADDR]`-style through a hoisted
// `faction * 0x20CC` offset).
extern int g_0096cd08[];
extern int g_0096cd04[];
