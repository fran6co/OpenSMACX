// ORIGINAL: 0x00402BB0 sub_402bb0 0x00402BB0-0x00402C16 FILE
// size      102 bytes
// prototype 
...
//   build/byte-match/00402bb0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_402bb0  at 0x00402BB0  (102 bytes)
//
...
extern "C" __declspec(naked) int __stdcall sub_402bb0(int a1) {
    __asm {
        push    ebp
        mov     ebp, esp
        push    esi
        ...
        push    edi
        lea     edi, [esi]
        mov     dword ptr [edi], 66943ch
        mov     eax, [esi+4]
        mov     ecx, [eax+4]
        mov     dword ptr [ecx+esi+4], 669438h
        mov     ecx, edi
        call    fn_00402970
        mov     cl, byte ptr [ebp+8]
        mov     dword ptr [edi+14h], 0
        mov     eax, [esi+20h]
        mov     dword ptr [esi+1ch], 6693ach
        test    cl, 1
        mov     dword ptr ds:[9b3374h], eax
        je      L2
        test    esi, esi
        je      L2
        test    eax, eax
