...
//   build/byte-match/004926c0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?show@ProdPicker@@QAEXH@Z  at 0x004926C0  (117 bytes)
//
...
// Local shim for the indirect call through the global at 0x6C2FD8:
// its own first field is a vtable pointer, and slot 62 (0xf8/4) is
// called with no arguments.
class GlobalVCall { public:
...
void ProdPicker::show(int a1) {
    char *self = reinterpret_cast<char *>(this);
    Win *base = reinterpret_cast<Win *>(this);

    if (!base->is_visible()) {
        if (field_B68_ != 0) {
            *g_006c3a74 = 1;
            reinterpret_cast<GlobalVCall *>(g_006c2fd8)->slot062();
        }
