...
//   build/byte-match/00496610/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_496610  at 0x00496610  (88 bytes)
//
...
extern "C" void __cdecl sub_496610(int a1) {
    if (*g_0093f660 == 0) {
        if (reinterpret_cast<QuayleWin *>(g_00872cb0)->init() == 0) {
            if (a1 >= 0x19) {
                a1 = 0x18;
            } else if (a1 < -1) {
                a1 = -1;
            ...
            *g_00874df8 = a1;
            *g_00874df4 = -1;
            reinterpret_cast<VCall *>(g_00872cb0)->slot057(0, 0, 0);
        }
    }
}
