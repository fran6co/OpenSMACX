...
// calls     (none)
// indirect  0x0048A815 0x0048A821 0x0048A82E
...
//   build/byte-match/0048a810/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?go_girl@PickWin@@QAEHXZ  at 0x0048A810  (44 bytes)
//
...
int PickWin::go_girl() {
    ...
    target->slot062();
    target->slot001(0);
    target->slot057(0, 0, 0);
    return *reinterpret_cast<int *>(reinterpret_cast<char *>(this) + 0x5da8);
}
