...
//   build/byte-match/00444fc0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ??0DiploWin@@QAE@XZ  at 0x00444FC0  (274 bytes)
//
...
static int *const g_00654a3d = (int *)0x00654A3D;
static int *const g_0066a6e4 = (int *)0x0066A6E4;
static int *const g_0066b5e0 = (int *)0x0066B5E0;
static int *const g_0066b62c = (int *)0x0066B62C;
static int *const g_0066b634 = (int *)0x0066B634;
static int *const g_00674e80 = (int *)0x00674E80;
...
// Placement new: needed to construct sub-objects at fixed offsets since
// DiploWin's own shell leaves GraphicWin/Spot/StringBox/ListBox opaque.
...
DiploWin::DiploWin() {
    ...
    *reinterpret_cast<int *>(self + 0xa14) = reinterpret_cast<int>(g_0066a6e4);
    ...
    // 13 FlatButton elements (size 0xB4C each) starting at +0x10ac,
    // constructed via the compiler's vector-constructor-iterator helper -
    // matches the original's direct call rather than a real array member.
    fn_006457c2(self + 0x10ac, 0xb4c, 0xd,
                reinterpret_cast<void (*)(void *)>(g_00607cf0),
                reinterpret_cast<void (*)(void *)>(g_00406880));

    new (self + 0xa388) StringBox();
    new (self + 0xcf28) ListBox(1);
    new (&edit_box_) EditBox();

    *reinterpret_cast<int *>(self) = reinterpret_cast<int>(g_0066b634);
    *reinterpret_cast<int *>(self + 0x444) = reinterpret_cast<int>(g_0066b62c);
    *reinterpret_cast<int *>(self + 0xa14) = reinterpret_cast<int>(g_0066b5e0);
}
