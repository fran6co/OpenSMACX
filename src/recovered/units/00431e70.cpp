...
// calls     0x0042BF10 0x0045C290 0x005D8000
...
//   build/byte-match/00431e70/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_redraw@Datalink@@QAEXXZ  at 0x00431E70  (54 bytes)
//
...
void Datalink::on_redraw() {
    reinterpret_cast<Buffer *>(g_007aec64)->set_clip(reinterpret_cast<RECT *>(g_007aec94));

    Buffer *sub = reinterpret_cast<Buffer *>(reinterpret_cast<char *>(this) + 0x444);
    sub->set_clip(reinterpret_cast<RECT *>(reinterpret_cast<char *>(sub) + 0x30));
