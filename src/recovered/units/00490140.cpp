...
// calls     0x006074E0 0x006169A0 0x00645470
// indirect  0x00490172 0x00490190 0x004901AE 0x004901DB 0x004901F9 0x0049023F 0x0049025D 0x0049027B 0x0049028C 0x0049029D 0x004902AE 0x004902BF 0x004902D0 0x004902E1 0x004902F2 0x00490303 0x00490321
...
//   build/byte-match/00490140/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?update_pref_buttons@PrefWin@@QAEXXZ  at 0x00490140  (486 bytes)
//
...
static int *const g_00490328 = (int *)0x00490328;
...
// the const-pointer globals above, per the extern-symbol lever.
class VCallArg { public:
    virtual void slot000();
    virtual void slot001(int);  // <-- used
};
extern Strings g_x9b90d8;
extern char g_x9b86a0[];

void PrefWin::update_pref_buttons() {
    char *self = reinterpret_cast<char *>(this);
    switch (*reinterpret_cast<int *>(self + 0xa14)) {
    case 0: {
        char *obj = self + 0x5974;
        int delta = *reinterpret_cast<int *>(*reinterpret_cast<int *>(obj) + 4);
        reinterpret_cast<VCallArg *>(obj + delta)->slot001(0);
        return;
    }
    case 1: {
        char *obj = self + 0x649c;
        int delta = *reinterpret_cast<int *>(*reinterpret_cast<int *>(obj) + 4);
        reinterpret_cast<VCallArg *>(obj + delta)->slot001(0);
        return;
    }
    case 2: {
        char *obj = self + 0x8614;
        int delta = *reinterpret_cast<int *>(*reinterpret_cast<int *>(obj) + 4);
        reinterpret_cast<VCallArg *>(obj + delta)->slot001(0);
    ...
    case 3: {
        char *obj = self + 0x6fc4;
        int delta = *reinterpret_cast<int *>(*reinterpret_cast<int *>(obj) + 4);
        reinterpret_cast<VCallArg *>(obj + delta)->slot001(0);
        return;
    }
    case 4: {
        char *obj = self + 0x7aec;
        int delta = *reinterpret_cast<int *>(*reinterpret_cast<int *>(obj) + 4);
        reinterpret_cast<VCallArg *>(obj + delta)->slot001(0);

        reinterpret_cast<VCallArg *>(self + 0xa78c)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0xc8d8)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0xea24)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0x10b70)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0x14e08)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0x164a0)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0x15954)->slot001(0);
        reinterpret_cast<VCallArg *>(self + 0x16fec)->slot001(0);
        return;
    }
    case 5: {
        char *obj = self + 0x9c64;
        int delta = *reinterpret_cast<int *>(*reinterpret_cast<int *>(obj) + 4);
        reinterpret_cast<VCallArg *>(obj + delta)->slot001(0);
        break;
    }
