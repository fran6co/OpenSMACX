...
//   build/byte-match/00402a60/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ServiceStruct::dt  at 0x00402A60  (102 bytes)
//
...
extern "C" int __stdcall fn_00402a60(int a1) {
    __asm {
        lea  esi, [ecx-1ch]
        _emit 057h
        _emit 08Dh
        ...
        mov  eax, [esi+4]
        mov  ecx, [eax+4]
        mov  dword ptr [ecx+esi+4], 06693d0h
        _emit 08Bh
        _emit 0CFh
        call fn_00402970
