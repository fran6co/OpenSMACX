// ORIGINAL: 0x004B26D0 ?close@SocialWin@@QAEXXZ 0x004B26D0-0x004B273C FILE BYTE_EXACT
// size      108 bytes
...
//   build/byte-match/004b26d0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?close@SocialWin@@QAEXXZ  at 0x004B26D0  (108 bytes)
//
...
void SocialWin::close() {
    char *self = reinterpret_cast<char *>(this);
    char *p1 = self + 0x6020;
    int n1 = 0x23;
    do {
        reinterpret_cast<VCall *>(p1)->slot090();
        p1 += 0xb4c;
    } while (--n1);
    char *p2 = self + 0x1eb84;
    int n2 = 4;
    do {
        reinterpret_cast<ButtonGroup *>(p2)->close();
        p2 += 0x94;
    } while (--n2);
    reinterpret_cast<ButtonGroup *>(self + 0x1edd4)->close();
    *reinterpret_cast<int *>(self + 0x2c28) = 0;
    *reinterpret_cast<int *>(self + 0xa2c) = -1;
    *reinterpret_cast<int *>(self + 0xa30) = -1;
    *reinterpret_cast<int *>(self + 0x2c24) = -1;
}
