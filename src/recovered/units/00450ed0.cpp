...
//   build/byte-match/00450ed0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_450ed0  at 0x00450ED0  (81 bytes)
//
...
class Sprite { public:
    int extract(Buffer*, int, int xCoord, int yCoord, int width, int height, #120*);
};
...
extern "C" int __cdecl sub_450ed0(Sprite *a1, int a2, int a3, int a4, int a5) {
    Buffer *buf = reinterpret_cast<Buffer *>(g_00798668);
    buf->change_color(0x107, 0x109);
    buf->change_color(0x106, 0x109);
    return a1->extract(buf, 0x109, a2, a3, a4, a5, 0);
}
