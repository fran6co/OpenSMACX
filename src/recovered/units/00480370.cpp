...
// calls     0x0047B380 0x004E25E0 0x005882F0 0x005D5930 0x005D8000 0x005DAC70 0x005DACB0 0x005DCF40 0x005DD130 0x005E2DD3 0x005E4B4A 0x005E4B9A 0x005FA960 0x005FAA90 0x006074E0 0x006169A0 0x00631A20 0x006453E0 0x00645470 0x00645660 0x0064FC88
// indirect  0x00480403 0x004807B7 0x004808E5
...
//   build/byte-match/00480370/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?draw_player_names@NetWin@@QAEXXZ  at 0x00480370  (1410 bytes)
//
...
static int *const g_006868b0 = (int *)0x006868B0;
...
static int *const g_0078dca8 = (int *)0x0078DCA8;
static int *const g_007ac040 = (int *)0x007AC040;
static int *const g_007ac048 = (int *)0x007AC048;
static int *const g_007ac06c = (int *)0x007AC06C;
static int *const g_007ac074 = (int *)0x007AC074;
static int *const g_0090db99 = (int *)0x0090DB99;
...
static int *const g_0093e1fc = (int *)0x0093E1FC;
...
// Time-boxed: only the header (both kill_type calls, the title box_sprite
// pair, the player-name string build + CharUpperA + font/color/write_cent_l)
// is transcribed. The per-player status-icon loop that follows - most of
// this 1410-byte function - is not; see the report.
void NetWin::draw_player_names() {
    ...
    int myIdx = reinterpret_cast<AlphaNet *>(g_0093cd90)->pid_2_idx(*g_0093d4f0);

    RECT *rectA = reinterpret_cast<RECT *>(self + 0xa64);
    buf->box_sprite(rectA, reinterpret_cast<BoxSpriteParams *>(g_0078d5a0));

    RECT *rectB = reinterpret_cast<RECT *>(self + 0xa54);
    buf->box_sprite(rectB, reinterpret_cast<BoxSpriteParams *>(g_0078d618));

    char *strbuf = reinterpret_cast<char *>(g_009b86a0);
    Strings *strings = reinterpret_cast<Strings *>(g_009b90d8);
    strbuf[0] = 0;
    int nameId = *reinterpret_cast<int *>(*g_009b90f8 + 0x414);
    strcat(strbuf, reinterpret_cast<char *>(strings->get(nameId)));
    ...
    if (strbuf) {
        buf->write_cent_l(strbuf, rectB, strlen(strbuf));
    }
