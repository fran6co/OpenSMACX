// ORIGINAL: 0x0044B100 ??1FameWin@@QAE@XZ 0x0044B100-0x0044B1FF;0x00654D60-0x00654DF6 FILE
// size      405 bytes
...
//   build/byte-match/0044b100/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ??1FameWin@@QAE@XZ  at 0x0044B100  (405 bytes)
//
...
static int *const g_00654dec = (int *)0x00654DEC;
static int *const g_0066974c = (int *)0x0066974C;
static int *const g_00669754 = (int *)0x00669754;
static int *const g_00675090 = (int *)0x00675090;
...
FameWin::~FameWin() {
    ...
    fn_006456e4(self + 0xb48c, 0x2c, 0xc,
                 reinterpret_cast<void (*)(void *)>(g_00406850));

    reinterpret_cast<Buffer *>(self + 0xaea4)->~Buffer();
    reinterpret_cast<Buffer *>(self + 0xa91c)->~Buffer();

    char *flat = self + 0x9dcc;
    *reinterpret_cast<void **>(flat) = g_00669754;
    *reinterpret_cast<void **>(flat + 0x444) = g_0066974c;
    reinterpret_cast<FlatButton *>(flat)->close();
    reinterpret_cast<BaseButton *>(flat)->~BaseButton();

    fn_006456e4(self + 0x5a04, 0xb4c, 6,
                 reinterpret_cast<void (*)(void *)>(g_00406880));

    reinterpret_cast<ButtonGroup *>(self + 0x5970)->close();

    fn_006456e4(self + 0xa5c, 0xb4c, 7,
                 reinterpret_cast<void (*)(void *)>(g_00406880));

    reinterpret_cast<Spot *>(self + 0xa50)->~Spot();
