// ORIGINAL: 0x004B1BC0 ?on_right_click@SocialWin@@QAEXHH@Z 0x004B1BC0-0x004B1CD1 FILE
// size      273 bytes
...
//   build/byte-match/004b1bc0/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_right_click@SocialWin@@QAEXHH@Z  at 0x004B1BC0  (273 bytes)
//
...
void SocialWin::on_right_click(int a1, int a2) {
    reinterpret_cast<TutWin *>(g_008c6e68)->reset();

    char *self = reinterpret_cast<char *>(this);
    RECT *box = reinterpret_cast<RECT *>(self + 0x1F110);
    ...
    {
        RECT *box2 = reinterpret_cast<RECT *>(self + 0x1F2A0);
        if (in_box(a1, a2, box2)) {
            char *base = reinterpret_cast<char *>(*g_009b90f8);
            int x = a1;
            int y = a2;
            int id = *reinterpret_cast<int *>(base + 0xD20);
            char *text = reinterpret_cast<char *>(reinterpret_cast<Strings *>(g_009b90d8)->get(id));

            reinterpret_cast<Win *>(this)->client_to_screen(&x, &y);
            ...
            rect.right = x;
            rect.bottom = y;
            reinterpret_cast<Win *>(this)->set_bubble_text(text, &rect);
        }
        return;
    }
...
hit_table: {
        ...
        int x = a1;
        int y = a2;
        int id = *reinterpret_cast<int *>(base + 0xCF0);
        char *text = reinterpret_cast<char *>(reinterpret_cast<Strings *>(g_009b90d8)->get(id));
