// ORIGINAL: 0x00630A40 BYTE_EXACT FILE
// name      sub_630a40
// size      61 bytes
// spans     0x00630A40-0x00630A7D
// prototype 
...
//   build/byte-match/00630a40/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_630a40  at 0x00630A40  (61 bytes)
//
...
int NetHost::sub_630a40(int a1, int a2) {
    if (*g_009be600 == 0) {
        return 0;
    }
    if (a1 == 0) {
    ...
    NetFifo *fifo = reinterpret_cast<NetFifo *>(reinterpret_cast<char *>(this) + 0x10c);
    return fifo->get(g_009bc4bc, reinterpret_cast<unsigned int *>(a1), 0,
