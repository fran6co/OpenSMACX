...
// calls     0x005FAB00
// indirect  0x004AE36C 0x004AE373
...
//   build/byte-match/004ae340/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_click@SetupWin@@QAEXHH@Z  at 0x004AE340  (64 bytes)
//
...
// This body dispatches through slot(s): 17, 58
class VCall { public:
...
void SetupWin::on_left_click(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    Spot *spot = reinterpret_cast<Spot *>(self + 0xfd4);
