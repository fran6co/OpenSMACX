...
//   build/byte-match/00637870/unit.cpp
// and score it with tools/agent_brief.py.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?decode_frame_process@Video@@QAEXXZ  at 0x00637870  (64 bytes)
//
...
class Video { public:
    ...
    int play_frame();
    int decode_frame_process();
};

int Video::decode_frame_process() {
    typedef int (__stdcall *TimeGetTimeFn)();
    log_say(reinterpret_cast<int8 *>(g_0069887c), reinterpret_cast<int8 *>(g_00698870),
            (*reinterpret_cast<TimeGetTimeFn *>(g_00669368))(), 0, 0);
    char *self = reinterpret_cast<char *>(this);
    if ((self[0x4ac] & 0x10) != 0) {
        return 0;
    }
    play_frame();
    return decode_frame(0);
}
