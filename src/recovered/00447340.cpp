...
// calls     (none)
// indirect  0x00447347 0x00447351
// 0x00447340  ?begin@MAmbience@@QAEXXZ  ->  ?begin@MAmbience@@QAEXXZ
//
...
void MAmbience::begin() {
    reinterpret_cast<BeginVCall *>(this)->slot067(1);
