// ORIGINAL: 0x004C7FF0 sub_4c7ff0 0x004C7FF0-0x004C8017 BYTE_EXACT
// size      39 bytes
// prototype 
...
// calls     (none)
// indirect  0x004C8004
// 0x004C7FF0  sub_4c7ff0  ->  _sub_4c7ff0
//
...
/*
Purpose: Forward two arguments to the sound delegate's virtual slot 46.
Original Offset: 004C7FF0
...
int S_004C7FF0::Call(int a1, int a2) {
    if (other) {
        return other->slot046(a1, a2);
    }
    return 0x14;
}
