// ORIGINAL: 0x0045D140 BYTE_EXACT
// name      ?on_iface_selected@MainInterface@@QAEXHH@Z
// size      25 bytes
// spans     0x0045D140-0x0045D159
// prototype void (__thiscall ?on_iface_selected@MainInterface@@QAEXHH@Z)(MainInterface* this, int, int)
