...
// calls     0x00629490
// indirect  0x006299FF 0x00629A11 0x00629A29

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?UNK2@StringBox@@QAEXHH@Z  at 0x00629980  (227 bytes)
//
...
void StringBox::UNK2(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    char *tree = self + 0x2b70;
    if (*reinterpret_cast<int *>(tree + 8) != 0) {
        int i = 0;
        if (0 < *reinterpret_cast<int *>(tree + 0x10)) {
            do {
                int *node = *reinterpret_cast<int **>(tree + 0xc);
                unsigned int field4 = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(node) + 4);
                if (field4 < static_cast<unsigned int>(a1) && field4 > static_cast<unsigned int>(a2)) {
                    *reinterpret_cast<int **>(tree + 0xc) =
                        reinterpret_cast<int *>(*reinterpret_cast<int *>(reinterpret_cast<char *>(node) + 0xc));
                } else {
                    int *nodeNext = reinterpret_cast<int *>(*reinterpret_cast<int *>(reinterpret_cast<char *>(node) + 0xc));
                    *reinterpret_cast<int *>(reinterpret_cast<char *>(nodeNext) + 0x10) =
                        *reinterpret_cast<int *>(reinterpret_cast<char *>(node) + 0x10);

                    int *cur1 = *reinterpret_cast<int **>(tree + 0xc);
                    int *cur1Prev = reinterpret_cast<int *>(*reinterpret_cast<int *>(reinterpret_cast<char *>(cur1) + 0x10));
                    *reinterpret_cast<int *>(reinterpret_cast<char *>(cur1Prev) + 0xc) =
                        *reinterpret_cast<int *>(reinterpret_cast<char *>(cur1) + 0xc);

                    int *piVar2 = *reinterpret_cast<int **>(tree + 0xc);
                    if (piVar2 == *reinterpret_cast<int **>(tree + 8)) {
                        *reinterpret_cast<int **>(tree + 8) =
                            reinterpret_cast<int *>(*reinterpret_cast<int *>(reinterpret_cast<char *>(piVar2) + 0xc));
                    }
                    *reinterpret_cast<int **>(tree + 0xc) =
                        reinterpret_cast<int *>(*reinterpret_cast<int *>(reinterpret_cast<char *>(piVar2) + 0xc));
                    int *piVar3 = reinterpret_cast<int *>(*reinterpret_cast<int *>(reinterpret_cast<char *>(piVar2) + 8));

                    reinterpret_cast<VObj1 *>(tree)->slot1(piVar3);

                    if (piVar3 != 0) {
                        char *vt = *reinterpret_cast<char **>(piVar3);
                        int off = *reinterpret_cast<int *>(vt + 4);
                        char *adjusted = reinterpret_cast<char *>(piVar3) + off;
                        reinterpret_cast<VObjD *>(adjusted)->slot0(1);
                    }
                    *reinterpret_cast<int *>(reinterpret_cast<char *>(piVar2) + 8) = 0;
                    if (piVar2 != 0) {
                        char *vt = *reinterpret_cast<char **>(piVar2);
                        int off = *reinterpret_cast<int *>(vt + 4);
                        char *adjusted = reinterpret_cast<char *>(piVar2) + off;
                        reinterpret_cast<VObjD *>(adjusted)->slot0(1);
                    }
                    *reinterpret_cast<int *>(tree + 0x10) = *reinterpret_cast<int *>(tree + 0x10) - 1;
                }
                i = i + 1;
            } while (i < *reinterpret_cast<int *>(tree + 0x10));
        }
        if (*reinterpret_cast<int *>(tree + 0x10) == 0) {
            *reinterpret_cast<int *>(tree + 8) = 0;
        }
        *reinterpret_cast<int *>(tree + 0x14) = *reinterpret_cast<int *>(tree + 0x10) - 1;
    }
    add_fixup();
}
