...
// calls     0x00471530 0x00618EA0 0x00618EE0 0x00629710

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_message@MainInterface@@QAEXPADHHHH@Z  at 0x0045C0F0  (132 bytes)
//
...
static int *const g_0065574d = (int *)0x0065574D;
static int *const g_00675788 = (int *)0x00675788;
...
void MainInterface::set_message(char * a1, int a2, int a3, int a4, int a5) {
    Font font;
    string_box_.add(a1, 5000, 2);
    reinterpret_cast<MessageWin *>(g_007f67f8)->add_message(a1, 0);
}
