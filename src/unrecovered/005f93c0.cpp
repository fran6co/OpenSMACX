// ORIGINAL: 0x005F93C0 FILE
// working copy - scaffold materialised by --work
// name      ?on_left_down@PullDown@@QAEXHH@Z
// size      155 bytes
// spans     0x005F93C0-0x005F945B
// prototype void (__thiscall ?on_left_down@PullDown@@QAEXHH@Z)(PullDown* this, int, int)
// callers   0   call targets   2
// kind      game
// flags     sp_ready;purged_ok
// calls     0x005FC9F0 0x005FD120
// indirect  0x005F93F8 0x005F9406 0x005F944E

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_down@PullDown@@QAEXHH@Z  at 0x005F93C0  (155 bytes)
//
...
// This body dispatches through slot(s): 2, 20
class VCall { public:
...
typedef int (__stdcall *PtInRectFn)(const RECT *, POINT);

// Second vtable shim: slot 20 (offset 0x50) needs two int arguments.
class VCall2 { public:
    virtual void slot000();
    virtual void slot001();
    ...
    virtual void slot018();
    virtual void slot019();
    virtual void slot020(int, int);
};

void PullDown::on_left_down(int a1, int a2) {
    RECT rc;
    POINT pt;
    Menu *m;
    ...
    pt.x = a1;
    pt.y = a2;
    if (!(*(PtInRectFn *)g_006692cc)(&rc, pt)) {
        ...
        selected_ = -1;
        if (m != 0) {
            reinterpret_cast<VCall2 *>(m)->slot020(
                (outer_rect_.top - m->outer_rect_.top) + a1,
                (outer_rect_.right - m->outer_rect_.right) + a2);
        }
    }
    //
