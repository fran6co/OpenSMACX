...
// calls     0x005E3820 0x00609F20 0x00614F30 0x00645470
// indirect  0x00613910 0x00613922 0x0061399D

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?close@FileWin@@QAEXXZ  at 0x00613900  (172 bytes)
//
...
static int *const g_0069711c = (int *)0x0069711C;
...
void FileWin::close() {
    ...
    reinterpret_cast<VCall *>(self + 0x660)->slot090();
    reinterpret_cast<VCall *>(self + 0x11AC)->slot090();
    reinterpret_cast<EditBox *>(self + 0x1CF8)->close();
    reinterpret_cast<ListBox *>(self + 0x286C)->close();
    *reinterpret_cast<unsigned char *>(self + 0x208) = 0;
    *reinterpret_cast<unsigned char *>(self + 0x30C) = 0;
    *reinterpret_cast<unsigned char *>(self + 0x410) = 0;
    *reinterpret_cast<int *>(self + 0x514) = 0;
    *reinterpret_cast<unsigned char *>(self + 0x531) = 0;
    strcat(self + 0x531, reinterpret_cast<char *>(g_0069711c));
    reinterpret_cast<Sprite *>(g_009b9048)->close();
    reinterpret_cast<Sprite *>(g_009b9018)->close();
    reinterpret_cast<Sprite *>(g_009b9078)->close();
    *reinterpret_cast<int *>(self + 0x63C) = 0;
    if (*reinterpret_cast<void **>(self + 0x33C0) != 0) {
        DestroyWindowFn destroy = (DestroyWindowFn)*g_0066930c;
        destroy(*reinterpret_cast<void **>(self + 0x33C0));
        *reinterpret_cast<int *>(self + 0x33C0) = 0;
    }
}
