...
// Local vtable shim for `menu_`'s slot 91, which returns int - unlike the
// scaffold's default nullary-void `VCall` above, which this body does not
// use. Only declaration order matters (emit_translation_unit.py's own
// technique); see 0x005F9570 for precedent.
class MenuVCall {
public:
    virtual void slot000();
    virtual void slot001();
