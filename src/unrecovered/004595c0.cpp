...
// calls     0x005DAC70 0x005DACB0 0x005ED9D0 0x006292D0 0x00629780

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?bung_momma@@YAXXZ  at 0x004595C0  (191 bytes)
//
...
static int *const g_007af558 = (int *)0x007AF558;
static int *const g_007cd2ec = (int *)0x007CD2EC;
static int *const g_007cd730 = (int *)0x007CD730;
static int *const g_007cdd00 = (int *)0x007CDD00;
static int *const g_007cdd04 = (int *)0x007CDD04;
static int *const g_007cfedc = (int *)0x007CFEDC;
static int *const g_007cfee8 = (int *)0x007CFEE8;
static int *const g_007cfeec = (int *)0x007CFEEC;
static int *const g_009156b0 = (int *)0x009156B0;
static int *const g_009b7b1c = (int *)0x009B7B1C;
void __cdecl bung_momma() {
    int a = *g_009b7b1c;
    int flag = *g_007cfedc;
    int edi = a - 0x140;
    int cnt;
    ...
    eax = eax / 2;
    ecx = ecx - esi;
    Font *fnt = reinterpret_cast<Font *>(g_009156b0);
    int fontVal = 0;
    if (fnt != 0) {
        fontVal = reinterpret_cast<int>(fnt) + *reinterpret_cast<int *>(reinterpret_cast<char *>(fnt) + 4);
    }
    reinterpret_cast<StringBox *>(g_007cd2ec)->init(eax, ecx, edi, esi, reinterpret_cast<Win *>(fontVal), 0, 0x1000022);
    *g_007cdd00 = 1;
    *g_007cdd04 = 4;
    reinterpret_cast<Buffer *>(g_007cd730)->set_font(reinterpret_cast<Font *>(g_007cfedc), 0, 0, 0);
    reinterpret_cast<Buffer *>(g_007cd730)->set_text_color(0x5f, -1, 1, 1);
    reinterpret_cast<StringBox *>(g_007cd2ec)->clear();
    reinterpret_cast<Win *>(g_007cd2ec)->show(0);
