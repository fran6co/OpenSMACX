...
// calls     0x0040E360 0x00415080 0x004E39D0 0x004EC3B0 0x00530D50 0x00530E50 0x005F8500

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_iface_mouse_leave@BaseWin@@QAEXHH@Z  at 0x0041E3E0  (224 bytes)
//
...
void BaseWin::on_iface_mouse_leave(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    char *outer = self - 0xa14;
    ...
    if (*reinterpret_cast<int *>(self + 0x4011c) != 0) {
        *reinterpret_cast<int *>(self + 0x4011c) = 0;
        reinterpret_cast<BaseWin *>(outer)->draw_queue(0);
    }
    ...
    if (*reinterpret_cast<int *>(self + 0x400ec) >= 0) {
        ...
        *reinterpret_cast<int *>(self + 0x400f0) = 0;
        ...
        int val = *reinterpret_cast<int *>(self + 0x400f8);
        int oldTable = reinterpret_cast<int *>(g_0097d0b8)[val * 77];

        set_base(val);
        base_compute(0);

        if (*g_0093f660 != 0 && *g_0093a938 == 0) {
            int val2 = *reinterpret_cast<int *>(self + 0x400f8);
            int newTable = reinterpret_cast<int *>(g_0097d0b8)[val2 * 77];
            if (oldTable != newTable) {
                int arg = *g_00689370;
                int rc = reinterpret_cast<NetDaemon *>(g_0093cd90)->lock_base(arg, 0, -1, -1);
                if (rc == 0) {
        ...
        reinterpret_cast<BaseWin *>(outer)->draw_production(1);
    }
}
