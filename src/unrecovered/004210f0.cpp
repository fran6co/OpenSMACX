// ORIGINAL: 0x004210F0 ??1Caviar@@QAE@XZ 0x004210F0-0x004210F5 FILE BYTE_EXACT
...
// size      5 bytes
// prototype void (__thiscall ??1Caviar@@QAE@XZ)(Caviar* this)
...
// subject: ??1Caviar@@QAE@XZ  at 0x004210F0  (5 bytes)
//
...
class CaviarCloseShim { public:
    void close();
};

Caviar::~Caviar() {
    reinterpret_cast<CaviarCloseShim *>(this)->close();
}
