...
// calls     0x005D4DD0 0x005FA870 0x00644EF2
// indirect  0x005FAD6E

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ??1Menu@@QAE@XZ  at 0x005FAD00  (225 bytes)
//
...
static int *const g_00662d18 = (int *)0x00662D18;
static int *const g_006700a8 = (int *)0x006700A8;
static int *const g_006700b0 = (int *)0x006700B0;
static int *const g_0067f988 = (int *)0x0067F988;
...
Menu::~Menu() {
    ...
    *reinterpret_cast<void **>(self) = g_006700b0;
    *reinterpret_cast<void **>(self + 0x444) = g_006700a8;

    char *entry = self + 0xa38;
    for (int i = 0; i < 15; ++i) {
        char *text = *reinterpret_cast<char **>(entry);
        if (text != 0) {
            free(text);
        }
        *reinterpret_cast<char **>(entry) = 0;
        *reinterpret_cast<int *>(entry - 4) = -1;
        *reinterpret_cast<unsigned char *>(entry + 4) = 0;
        *reinterpret_cast<int *>(entry + 8) = 0;
        void *pullDown = *reinterpret_cast<void **>(entry + 0xc);
        if (pullDown != 0) {
            reinterpret_cast<VObjD *>(pullDown)->slot0(1);
        }
        *reinterpret_cast<void **>(entry + 0xc) = 0;
        entry += 0x14;
    }
