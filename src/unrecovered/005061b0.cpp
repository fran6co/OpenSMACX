...
// TRIED: nothing tried beyond the direct transcription below - landed at first compiling candidate given batch size. Mnemonic similarity 0.93, first divergence is a `movsx` the rebuilt body splits into two `mov`s (short-to-int widening scheduled differently around the record-base computation, #25).
// size      242 bytes
