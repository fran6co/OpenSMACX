// ORIGINAL: 0x0048A840 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?on_dialog_item_back_draw@PickWin@@QAEHPAUGraphicWin@@HHPAURECT@@@Z
// size      147 bytes
// spans     0x0048A840-0x0048A8D3
...
// calls     0x005D8000 0x005DACB0 0x005E2DD3

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_dialog_item_back_draw@PickWin@@QAEHPAUGraphicWin@@HHPAURECT@@@Z  at 0x0048A840  (147 bytes)
//
...
static int *const g_008c6c9c = (int *)0x008C6C9C;
static int *const g_008c6ca0 = (int *)0x008C6CA0;

class PickWin { public:
    int on_dialog_item_back_draw(GraphicWin *, int, int, RECT *);
};
int PickWin::on_dialog_item_back_draw(GraphicWin * a1, int a2, int a3, RECT * a4) {
    if (a1 == 0 || a4 == 0) {
        return 0;
    }
    char *base = reinterpret_cast<char *>(a1) + 0x444;
    Buffer *buf = reinterpret_cast<Buffer *>(base);
    RECT *clipRect = reinterpret_cast<RECT *>(base + 0x30);
    buf->set_clip(clipRect);

    RECT local = *a4;
    BoxSpriteParams *params = reinterpret_cast<BoxSpriteParams *>(0x0078D960 + a3 * 0x28);
    buf->box_sprite(&local, params);

    int off = a3 * 8;
    int arg1 = *reinterpret_cast<int *>(0x008C6C9C - off);
    int arg2 = *reinterpret_cast<int *>(0x008C6CA0 - off);
    buf->set_text_color(arg1, arg2, 1, 1);
