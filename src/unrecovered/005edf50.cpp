...
// subject: ?set_caption@Win@@QAEXPAD@Z  at 0x005EDF50  (133 bytes)
//
...
// Vtable shim for slot 74 (0x128), called with two int args; the emitter's
// own VCall class types every slot void().
...
void Win::set_caption(char * a1) {
    ...
    if (*reinterpret_cast<uint8_t *>(self + 0x9c) & 1) {
        ...
        reinterpret_cast<WinVCall074 *>(this)->slot074(0, -1);
    }
}
