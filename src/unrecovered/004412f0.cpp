...
// TRIED: const-pointer style for the 0x946a50 table (indexed lea would fold); own `extern char g_00946a50[]` used instead. #3 push/mov is register-allocation order, not a logic mismatch
...
// calls     0x00629710 0x00645470
// indirect  0x00441345

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?new_chat@DiploWin@@QAEXPADH@Z  at 0x004412F0  (183 bytes)
//
...
void DiploWin::new_chat(char * a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    char local_104[256];
    local_104[0] = '\0';
    *g_009bbff0 = 0;
    char *record = g_00946a50 + a2 * 0x59c;
    *g_009bbfec = *reinterpret_cast<int *>(record);
    strcat(local_104, record + 0x34);
    typedef int (__stdcall *CharUpperAFn)(char *);
    (*reinterpret_cast<CharUpperAFn *>(g_0066931c))(local_104);
    strcat(local_104, reinterpret_cast<char *>(g_00682e94));
    strcat(local_104, reinterpret_cast<char *>(g_00682820));
    strcat(local_104, a1);
    reinterpret_cast<StringBox *>(self + 0xa388)->add(local_104, a2, 1);
    *g_007492d0 = 1;
}
