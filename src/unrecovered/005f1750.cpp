...
// calls     0x005DFF00 0x005EFD20
// indirect  0x005F17C7

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_5f1750  at 0x005F1750  (194 bytes)
//
...
extern "C" void __cdecl win_flip_stub(RECT *);

void __cdecl sub_5f1750(int a1) {
    if (*g_009b7a2c != 0) {
        reinterpret_cast<Buffer *>(g_009b6f08)->copy(
            reinterpret_cast<Buffer *>(g_009b7490), 0, 0,
            *g_009b7a30, *g_009b7a34, *g_009b7a40, *g_009b7a44);
        int x = *g_009b7a30;
        int y = *g_009b7a34;
        RECT local;
        local.right = x + *g_009b7a40;
        local.left = x;
        local.bottom = y + *g_009b7a44;
        local.top = y;
        UnionRect(reinterpret_cast<RECT *>(g_009b6ee8), reinterpret_cast<RECT *>(g_009b6ee8), &local);
        if (a1 != 0) {
            int saved = *g_009b7a2c;
            *g_009b7a2c = 0;
            win_flip_stub(reinterpret_cast<RECT *>(g_009b6ee8));
            *g_009b7a2c = saved;
            *g_009b6ee8 = 0;
            *g_009b6ef0 = 0;
        }
