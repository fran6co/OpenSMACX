// ORIGINAL: 0x004C49A0 FILE
// RULED-OUT: custom VCallW(int) shim for slot001 (scaffold's slot001 is
//            nullary); byte-read/dword-write split for g_00939ed8's flag
//            bit. MISMATCH from #4: register push scheduling around the
//            four af51c/af520/af524/af528 locals differs
// working copy - scaffold materialised by --work
// name      ?init@WorldWin@@QAEXH@Z
// size      198 bytes
// spans     0x004C49A0-0x004C4A66
// prototype void (__thiscall ?init@WorldWin@@QAEXH@Z)(WorldWin* this, int)
// callers   1   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x00462870 0x00470A90 0x005D50A0
// indirect  0x004C4A5D

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?init@WorldWin@@QAEXH@Z  at 0x004C49A0  (198 bytes)
//
...
void WorldWin::init(int a1) {
    char *self = reinterpret_cast<char *>(this);
    if ((*reinterpret_cast<unsigned char *>(g_00939ed8) & 8) == 0) {
        int v1 = *g_007af51c;
        int v2 = *g_007af520;
        int v3 = *g_007af524;
        *g_00939f08 = v1;
    ...
    *g_0090d938 = 1;
    *reinterpret_cast<int *>(self + 0x239bc) = 0;
    *reinterpret_cast<int *>(self + 0x239c0) = 0;
    *reinterpret_cast<int *>(self + 0x239cc) = 0;
    *reinterpret_cast<int *>(self + 0x239d0) = 0;
    *reinterpret_cast<int *>(self + 0x1f2a4) = 1;

    MapWin *mapWin = reinterpret_cast<MapWin *>(self + 0x152c);
    if (a1 != 0) {
        mapWin->clear(1);
    }
    mapWin->init(1, 0);

    *reinterpret_cast<int *>(self + 0x239bc) = 8;
    reinterpret_cast<GraphicWin *>(this)->init(reinterpret_cast<RECT *>(g_00939f08), 0, 0x20,
        reinterpret_cast<Win *>(g_007ae820), 0, 0);

    reinterpret_cast<VCallW *>(this)->slot001(0);
}
