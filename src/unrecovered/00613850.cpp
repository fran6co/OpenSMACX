...
// subject: ??0FileWin@@QAE@XZ  at 0x00613850  (221 bytes)
//
...
static int *const g_0066310a = (int *)0x0066310A;
static int *const g_0067fdb8 = (int *)0x0067FDB8;
static int *const g_00697118 = (int *)0x00697118;
...
FileWin::FileWin() {
    ...
    new (self + 0x660) FlatButton();
    new (self + 0x11ac) FlatButton();
    new (self + 0x1cf8) EditBox();
    new (self + 0x286c) ListBox(1);

    *reinterpret_cast<char *>(self + 0x208) = 0;
    *reinterpret_cast<char *>(self + 0x30c) = 0;
    *reinterpret_cast<char *>(self + 0x410) = 0;
    *reinterpret_cast<int *>(self + 0x514) = 0;
    *reinterpret_cast<char *>(self + 0x531) = 0;
    strcat(self + 0x531, reinterpret_cast<char *>(g_00697118));
