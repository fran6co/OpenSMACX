// ORIGINAL: 0x0045CF80 FILE
// working copy - scaffold materialised by --work
// name      ?on_iface_right_down@MainInterface@@QAEXHH@Z
// size      125 bytes
// spans     0x0045CF80-0x0045CFFD
// prototype void (__thiscall ?on_iface_right_down@MainInterface@@QAEXHH@Z)(MainInterface* this, int xCoord, int yCoord)
// callers   0   call targets   4
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x005ED240 0x005F83D0 0x005FAB00 0x006169A0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_iface_right_down@MainInterface@@QAEXHH@Z  at 0x0045CF80  (125 bytes)
//
...
void MainInterface::on_iface_right_down(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    Spot *spot = reinterpret_cast<Spot *>(self + 0x24620);
    int spotType = 0;
    int r = spot->check(a1, a2, &spotType, 0);
    if (r != -1 && spotType == 5) {
        Win *winThis = reinterpret_cast<Win *>(self - 0xa14);
        winThis->client_to_screen(&a1, &a2);
        RECT rect;
        rect.left = a1;
        rect.top = a2;
        rect.right = a1;
        ...
        int strId = *reinterpret_cast<int *>(obj + 0xc4c);
        Strings *strings = reinterpret_cast<Strings *>(g_009b90d8);
        char *text = reinterpret_cast<char *>(strings->get(strId));
        winThis->set_bubble_text(text, &rect);
    }
}
