// ORIGINAL: 0x00600330 sub_600330 0x00600330-0x00600393 FILE
...
// calls     0x005EC690 0x005EC6F0
// indirect  0x00600342 0x0060037A 0x0060038A

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_600330  at 0x00600330  (99 bytes)
//
...
extern int __stdcall win_get_hdc();
extern void __stdcall win_release_hdc();

class Blitter { public:
    void draw();
};

void Blitter::draw() {
    char *self = reinterpret_cast<char *>(this);
    if (*reinterpret_cast<int *>(self + 0x468) != 0) {
        int hwnd = *reinterpret_cast<int *>(self + 8);
        int hDC = reinterpret_cast<Fn1>(*g_0066927c)(hwnd);
        if (hDC != 0) {
            int cy = *reinterpret_cast<int *>(self + 0x478);
            int cx = *reinterpret_cast<int *>(self + 0x474);
            int y = *reinterpret_cast<int *>(self + 0x470);
            int x = *reinterpret_cast<int *>(self + 0x46C);
            reinterpret_cast<Fn9>(*g_00669054)(win_get_hdc(), x, y, cx, cy, hDC, 0, 0, 0xCC0020);
            win_release_hdc();
            reinterpret_cast<Fn2>(*g_00669280)(*reinterpret_cast<int *>(self + 8), hDC);
        }
    }
}
