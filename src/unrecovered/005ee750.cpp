...
// subject: ?left_down_event@Win@@QAEXHHH@Z  at 0x005EE750  (178 bytes)
//
...
// This body dispatches through slot(s): 7, 20, 23, 33
class VCall { public:
...
class VCall2 { public:
    ...
    virtual void slot05();
    virtual void slot06();
    virtual void slot07();          // offset 0x1c
    virtual void slot08();
    virtual void slot09();
    virtual void slot10();
    virtual void slot11();
    ...
    virtual void slot18();
    virtual void slot19();
    virtual void slot20(int, int); // offset 0x50
    virtual void slot21();
    virtual void slot22();
    virtual int  slot23();          // offset 0x5c
    virtual void slot24();
    virtual void slot25();
    virtual void slot26();
    virtual void slot27();
    ...
    virtual void slot31();
    virtual void slot32();
    virtual void slot33(int, int); // offset 0x84
};
...
void Win::left_down_event(int a1, int a2, int a3) {
    ...
    if (a3 == 0) {
        reinterpret_cast<VCall2 *>(this)->slot20(a1, a2);
        Win *child = *reinterpret_cast<Win **>(self + 0x24);
        if (child != 0) {
            int r = reinterpret_cast<VCall2 *>(child)->slot23();
            if (r == 0) {
                reinterpret_cast<VCall2 *>(child)->slot07();
            }
        }
    } else {
        reinterpret_cast<VCall2 *>(this)->slot33(a1, a2);
