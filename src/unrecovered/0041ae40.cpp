...
// calls     0x0041A920 0x004E39D0 0x004EC3B0 0x00530D50 0x00530E50 0x005F7E90

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?soft_zoom@BaseWin@@QAEXH@Z  at 0x0041AE40  (210 bytes)
//
...
void BaseWin::soft_zoom(int a1) {
    char *self = reinterpret_cast<char *>(this);
    if (!reinterpret_cast<Win *>(this)->is_visible()) {
        *reinterpret_cast<int *>(self + 0x40B0C) = a1;
        *g_00689374 = 0xffffffff;
        int v = *reinterpret_cast<int *>(self + 0x40B0C);
        int cached = g_97d0b8[v * 0x4D];
        set_base(v);
        base_compute(0);
        if (*g_0093f660 != 0 && *g_0093a938 == 0) {
            int v2 = *reinterpret_cast<int *>(self + 0x40B0C);
            if (cached != g_97d0b8[v2 * 0x4D]) {
                NetDaemon *nd = reinterpret_cast<NetDaemon *>(0x0093CD90);
                if (nd->lock_base(*g_00689370, 0, -1, -1) == 0) {
                    nd->unlock_base(*g_00689370);
                }
            }
        }
        *reinterpret_cast<int *>(self + 0x40B34) = g_97d090[a1 * 0x4D];
        return;
    }
    zoom(a1, 0);
}
