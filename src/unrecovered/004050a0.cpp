...
// calls     0x00604A90 0x00645470 0x0064FD20
// indirect  0x004050DE 0x004050F6

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_link_clicked@Popup@@QAEHHPAD@Z  at 0x004050A0  (145 bytes)
//
...
static int *const g_006827b8 = (int *)0x006827B8;
static int *const g_006827c4 = (int *)0x006827C4;
static int *const g_006827dc = (int *)0x006827DC;
static int *const g_007591c8 = (int *)0x007591C8;
...
// _strcmpi is declared nullary above; redeclare with its real signature
// under a different name to avoid C2733, calling through to the same CRT
// import.
extern "C" int __cdecl strcmpi_real(const char *, const char *);

typedef int (__stdcall *ShowWindowFn)(void *, int);
typedef void * (__stdcall *ShellExecuteAFn)(void *, const char *, const char *, const char *, const char *, int);

int Popup::on_link_clicked(int a1, char * a2) {
    if (a2 == 0) {
        return 1;
    }
    if (strcmpi_real(a2, reinterpret_cast<const char *>(g_006827b8)) == 0) {
        *g_009b2068 = 1;
        fallout();
        ShowWindowFn showWindow = reinterpret_cast<ShowWindowFn>(*g_00669320);
        showWindow(reinterpret_cast<void *>(*g_009b7b28), 0);
        ShellExecuteAFn shellExecuteA = reinterpret_cast<ShellExecuteAFn>(*g_00669268);
        shellExecuteA(0, reinterpret_cast<const char *>(g_006827dc), reinterpret_cast<const char *>(g_006827c4), 0, 0, 1);
        return 1;
    }
    *reinterpret_cast<char *>(g_007591c8) = 0;
    strcat(reinterpret_cast<char *>(g_007591c8), a2);
    *g_007592c8 = 1;
    fallout();
    return 0;
}
