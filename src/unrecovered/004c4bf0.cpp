...
// subject: ??0WorldWin@@QAE@XZ  at 0x004C4BF0  (165 bytes)
//
...
static int *const g_00659e74 = (int *)0x00659E74;
static int *const g_0066df28 = (int *)0x0066DF28;
static int *const g_0066df30 = (int *)0x0066DF30;
static int *const g_00679010 = (int *)0x00679010;
...
WorldWin::WorldWin() {
    ...
    new (reinterpret_cast<void *>(self)) GraphicWin();
    try {
        new (reinterpret_cast<void *>(self + 0xA1C)) Buffer();
        new (reinterpret_cast<void *>(self + 0xFA4)) Buffer();
        new (reinterpret_cast<void *>(self + 0x152C)) MapWin(1);
    } catch (...) {
        throw;
    }
    *reinterpret_cast<int *>(self) = 0x66DF30;
    *reinterpret_cast<int *>(self + 0x444) = 0x66DF28;
