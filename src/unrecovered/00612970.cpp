...
// symbol    ?attach@Dialogs@@QAEHHPAVGraphicWin@@HHH@Z
...
// subject: ?attach@Dialogs@@QAEHHPAUGraphicWin@@HHH@Z  at 0x00612970  (216 bytes)
//
...
static int *const g_00612a48 = (int *)0x00612A48;
...
int Dialogs::attach(int a1, GraphicWin * a2, int a3, int a4, int a5) {
    char *self = reinterpret_cast<char *>(this);
    int type = a1 & 0x1f;
    *reinterpret_cast<int *>(self + 0x180) = type;
    switch (type) {
    case 0x10:
        return reinterpret_cast<RadioButton *>(self + 0xa74)->attach(a2, a3, a4, a5);
    case 2:
        return reinterpret_cast<ListBox *>(self + 0xa60)->attach(a2, a3, a4, a5);
    case 1:
        return reinterpret_cast<CheckBox *>(self + 0xa8c)->attach(a2, a3, a4, a5);
    case 8:
        return reinterpret_cast<SpriteBox *>(self + 0xb14)->attach(a2, a3, a4, a5);
    case 4:
        return reinterpret_cast<EditGroup *>(self + 0xb9c)->attach(a2, a3, a4, a5);
    default:
        return 3;
    }
}
