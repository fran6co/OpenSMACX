...
// RULED-OUT: same shape as 0x005D8740/0x005D8930 - see 0x005D8740's note for
//   what the stdcall-Unlock and opaque-field access forms rule out.
...
// subject: ?draw_dest@Buffer@@QAEHPAVBuffer@@HHHHHPAE@Z  at 0x005D8B20  (248 bytes)
//
...
int Buffer::draw_dest(Buffer * a1, int a2, int a3, int a4, int a5, int a6, unsigned char * a7) {
...
forward:
    {
        int result = reinterpret_cast<Sprite *>(g_009b3a50)
                         ->draw_dest(a1, a2, a3, a4, a5, a6, a7);
        *g_009b3a54 = 0;
        return result;
    }
}
