...
// calls     0x0048FDD0 0x0062B8A0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_key_click@PrefWin@@QAEHHH@Z  at 0x0048FCD0  (200 bytes)
//
...
static int *const g_0048fd98 = (int *)0x0048FD98;
...
int PrefWin::on_key_click(int a1, int a2) {
    ...
    switch (a2) {
        ...
        case 0x1b:
            ...
            return 1;
        case 0x26: {
            int cur = *reinterpret_cast<int *>(self + 0xa14);
            *reinterpret_cast<int *>(self + 0xa18) = cur;
            if (cur < 1) {
                *reinterpret_cast<int *>(self + 0xa14) = 5;
            } else {
                *reinterpret_cast<int *>(self + 0xa14) = cur - 1;
            }
            *reinterpret_cast<int *>(self + 0xa1c) = 1;
            reinterpret_cast<ButtonGroup *>(0x8577f0)->button_click(*reinterpret_cast<int *>(self + 0xa14));
            return 1;
        }
        case 0x28: {
            int cur = *reinterpret_cast<int *>(self + 0xa14);
