...
// calls     0x006098D0 0x00609F20 0x0060D1B0 0x0060E7C0 0x006104B0 0x00611A90

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?init@Dialogs@@QAEHPAUHeap@@@Z  at 0x006136B0  (132 bytes)
//
...
int Dialogs::init(Heap * a1) {
    char *self = reinterpret_cast<char *>(this);
    int result;

    char *radioButton = self + 0x44;
    reinterpret_cast<RadioButton *>(radioButton)->close();
    result = reinterpret_cast<Dialog *>(
        radioButton + (*reinterpret_cast<int **>(radioButton))[2])->init(a1);
    if (result != 0) {
        return result;
    }
    ...
    result = reinterpret_cast<Dialog *>(
        self + (*reinterpret_cast<int **>(self))[2])->init(a1);
    if (result != 0) {
        return result;
    }

    char *checkBox = self + 0x58;
    reinterpret_cast<CheckBox *>(checkBox)->close();
    result = reinterpret_cast<Dialog *>(
        checkBox + (*reinterpret_cast<int **>(checkBox))[2])->init(a1);
    if (result != 0) {
        return result;
    }

    result = reinterpret_cast<SpriteBox *>(self + 0x70)->init(a1);
    if (result != 0) {
        return result;
    }
    ...
    result = reinterpret_cast<Dialog *>(
        editGroup + (*reinterpret_cast<int **>(editGroup))[2])->init(a1);
    return result;
}
