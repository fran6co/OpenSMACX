...
// calls     0x005ED7D0
// indirect  0x005FC5E3 0x005FC613

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?adjust@Menu@@QAEXXZ  at 0x005FC5A0  (123 bytes)
//
...
// This body dispatches through slot(s): 3, 92
class VCall { public:
...
// Separate shim (distinct from the emitter's VCall above, which is
// always nullary): slot003 needs a real signature to reproduce the
// three pushed args at 0x005FC5E3.
class MenuVCall { public:
    virtual void slot000();
    virtual void slot001();
    virtual void slot002();
...
void Menu::adjust() {
    ...
    int field = *reinterpret_cast<int *>(self + 0xc4);
    if (field != 0) {
        int scaled = *reinterpret_cast<int *>(val + 0x10) << 1;
        int diff = *reinterpret_cast<int *>(field + 0x144) - *reinterpret_cast<int *>(field + 0x13c);
        reinterpret_cast<MenuVCall *>(this)->slot003(diff, scaled, 0);

        val = *g_009b7b94;
        field = *reinterpret_cast<int *>(self + 0xc4);
        int scaled2 = *reinterpret_cast<int *>(val + 0x10) << 1;
        int a = *reinterpret_cast<int *>(field + 0x13c);
        int b = *reinterpret_cast<int *>(field + 0x140) - scaled2;
        this->move(a, b);
    }
    reinterpret_cast<MenuVCall *>(this)->slot092();
}
