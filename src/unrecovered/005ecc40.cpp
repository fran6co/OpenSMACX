...
// TRIED: for(;;)/break loop shape for the list search instead of a do/while counted against field_D4_
...
// calls     (none)
// indirect  0x005ECCED 0x005ECD0E

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_dialog_focus@Win@@QAEXPAVWin@@@Z  at 0x005ECC40  (219 bytes)
//
...
class Win { public:
    ...
    void set_dialog_focus(Win *);
};
class DummySlotCC { public:
    void call(int);
};
typedef void (DummySlotCC::*SlotCCFn)(int);
union SlotCCCast { void *fn; SlotCCFn mfp; };

static void call_slot_cc(int *obj, int arg) {
    void *vtbl = *reinterpret_cast<void **>(obj);
    void *fn = *reinterpret_cast<void **>(reinterpret_cast<char *>(vtbl) + 0xcc);
    SlotCCCast cast;
    cast.fn = fn;
    (reinterpret_cast<DummySlotCC *>(obj)->*cast.mfp)(arg);
}
