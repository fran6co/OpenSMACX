...
// size      144 bytes
// spans     0x00513FC0-0x00514050
// prototype void (__thiscall ?end_of_turn@Console@@QAEXXZ)(Console* this)
// callers   0   call targets   3
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x004BC6E0 0x0051F200 0x00524870

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?end_of_turn@Console@@QAEXXZ  at 0x00513FC0  (144 bytes)
//
...
void Console::end_of_turn() {
    field_23BE4_ = 1;
    int savedFlag = *g_009a64c8;

    if (*g_00939288 == 0) {
        for (;;) {
            if (field_23BE4_ == 0) break;
            if (field_23BE8_ == 0) break;
            if (*g_009b2068 != 0) break;

            int r = end_of_game(0);
            if (r != 0) break;
            if (savedFlag != *g_009a64c8) break;

            if (*g_0093f660 != 0) {
                if (*g_009a64c0 & 0x800) break;
            }
