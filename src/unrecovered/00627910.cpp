// ORIGINAL: 0x00627910 FILE
// working copy - scaffold materialised by --work
// name      ?pop_ask@@YAHPADPADHPADP6AHXZH@Z
// size      167 bytes
// spans     0x00627910-0x006279B7
// prototype int (__cdecl ?pop_ask@@YAHPADPADHPADP6AHXZH@Z)(int8* srcFileID, int8* sectionID, int, int8*, int (__cdecl *)(), int)
// callers   6   call targets   6
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x005F7E90 0x005FCBB0 0x00600F00 0x00601BB0 0x00601BF0 0x00602600

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?pop_ask@@YAHPADPADHPADP6AHXZH@Z  at 0x00627910  (167 bytes)
//
...
int __cdecl pop_ask(char * a1, char * a2, int a3, char * a4, int (__cdecl *a5)(), int a6) {
    ...
    BasePop *pop = reinterpret_cast<BasePop *>(visible != 0 ? *g_009bc078 : *g_009bc074);

    if (pop->start(a1, a2, a3, a4, a6 | 0x44, 0) != 0) {
        return -1;
    }

    pop->write_check(*g_009bc06c);

    char *self = reinterpret_cast<char *>(pop);
    int *vbt = *reinterpret_cast<int **>(self + 0x21d0);
    int disp = vbt[2];
    int val = *reinterpret_cast<int *>(self + 0x21d0 + disp);
    if (val == 0) {
        return -1;
    }

    int result = pop->exec(0, a5);
    if (pop->field_A14_ == 0) {
        do_all_draws();
    }
