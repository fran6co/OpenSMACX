// ORIGINAL: 0x005EE190 FILE
// RULED-OUT: 0.90 mnemonic similarity - the original keeps a register
//            pinned to 0 across the whole function (xor ebx,ebx once,
//            reused for every zero-store and the two early-return `xor
//            eax,eax`s); writing plain `0` literals throughout lets the
//            compiler re-derive zero per site instead, which is a
//            register-allocation choice not reachable from source form.
// working copy - scaffold materialised by --work
// name      ?set_modal@Win@@QAEHHP6AHXZPAVWin@@@Z
// size      235 bytes
// spans     0x005EE190-0x005EE27B
// prototype int (__thiscall ?set_modal@Win@@QAEHHP6AHXZPAVWin@@@Z)(Win* this, int, int (__cdecl *)(), Win*)
// callers   1   call targets   2
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x005FC700 0x005FD120
// indirect  0x005EE1E2 0x005EE200 0x005EE208 0x005EE216 0x005EE21D 0x005EE233 0x005EE241 0x005EE268

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_modal@Win@@QAEHHP6AHXZPAVWin@@@Z  at 0x005EE190  (235 bytes)
//
...
// This body dispatches through slot(s): 1, 4, 58, 59
class VCall { public:
...
class Win { public:
    ...
    int set_modal(int, int (__cdecl *)(), Win *);
};
typedef void *(__stdcall *PFN_LoadCursorA)(void *, const char *);
typedef void *(__stdcall *PFN_SetCursor)(void *);

// VCall's slots don't fit this shape (arg on slot01, checked return on
// slot59), so this call set is shadowed here under its own name.
...
int Win::set_modal(int a1, int (__cdecl *a2)(), Win * a3) {
    ...
    *g_009b7ad0 = 0;
    ...
    if (prior != 0 && prior != this) {
        reinterpret_cast<VCallModal *>(prior)->slot04();
        *g_009b7abc = 0;
    }
    *g_009b7ac4 = 0;
    if (a3 != 0) {
        *g_009b7adc = reinterpret_cast<int>(a3);
        reinterpret_cast<VCallModal *>(a3)->slot01(0);
    }
    reinterpret_cast<VCallModal *>(this)->slot01(0);
    flush_input();
    ...
    if (*g_009b7ae0 == reinterpret_cast<int>(this)) {
        for (;;) {
            int r = reinterpret_cast<VCallModal *>(this)->slot59();
            if (r == 0) {
                break;
            }
            if (a2 != 0) {
