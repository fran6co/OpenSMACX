// ORIGINAL: 0x004A0810 FILE
// working copy - scaffold materialised by --work
// name      ?sat_edit@@YAXHHH@Z
// size      194 bytes
// spans     0x004A0810-0x004A08D2
// prototype void (__cdecl ?sat_edit@@YAXHHH@Z)(int a1, int factionID, int type)
// callers   1   call targets   2
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x005A96D0 0x005D5A70
// indirect  0x004A082E

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?sat_edit@@YAXHHH@Z  at 0x004A0810  (194 bytes)
//
...
extern int g_0096d1e8_arr[];
extern int g_0096d1f4_arr[];
extern int g_0096cd44_arr[];

void __cdecl sat_edit(int a1, int a2, int a3) {
    if (a3 < 4 && a1 != 0) {
        short state = (*reinterpret_cast<FnGetAsyncKeyState *>(g_00669330))(0x10);
        unsigned char highbyte = static_cast<unsigned char>(state >> 8);
        if (highbyte == 0) {
            g_0096d1e8_arr[a2 * 0x833 + a3] = g_0096d1e8_arr[a2 * 0x833 + a3] + 1;
        } else {
            int idx = a2 * 0x833 + a3;
            if (g_0096d1e8_arr[idx] != 0) {
                g_0096d1e8_arr[idx] = g_0096d1e8_arr[idx] - 1;
            }
            if (a3 == 3 && (g_0096d1f4_arr[a2 * 0x833] - g_0096cd44_arr[a2 * 0x833]) < 0) {
                g_0096cd44_arr[a2 * 0x833] = g_0096d1f4_arr[a2 * 0x833];
                see_map_check();
