...
// calls     0x00467970 0x00510490 0x00510520

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_patrol@Console@@QAEXH@Z  at 0x004D7EE0  (127 bytes)
//
...
void Console::set_patrol(int a1) {
    reinterpret_cast<char *>(g_0095283a)[a1 * 0x34] = 0;
    if (field_23D10_ == 8) {
        cursor_off();
        return;
    }
    ...
    do {
        int val = *p;
        if (val != 0 && (p == g_007d3c3c || *reinterpret_cast<int *>(val + 0x1dd74) != 0)) {
            *reinterpret_cast<unsigned int *>(val + 0x1dd70) |= 0x400000;
            reinterpret_cast<MapWin *>(*p)->draw_base_dest(1);
        }
        p++;
    } while (reinterpret_cast<int>(p) < reinterpret_cast<int>(g_007d3c5c));
    reinterpret_cast<Console *>(g_009156b0)->cursor_on(8, -1);
}
