...
// calls     (none)
// indirect  0x00433953 0x00433974 0x0043399E 0x004339B3

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_up@SelectPartWin@@QAEXHH@Z  at 0x00433940  (127 bytes)
//
...
void SelectPartWin::on_left_up(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    ((VCallArg2 *)this)->slot017(a1, a2);
    if (*(int *)(self + 0x4648) == 0) {
        *(int *)(self + 0x2b80) = -1;
        if (*g_009b7abc == (int)self) {
            *g_009b7abc = 0;
            ((VCall *)this)->slot004();
        }
    } else if (*g_009b7abc == (int)self) {
        *g_009b7abc = 0;
        ((VCall *)this)->slot004();
    }
