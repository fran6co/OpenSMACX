// ORIGINAL: 0x00477740 FILE
// name      ?mon_first_in_space@@YAXH@Z
// size      254 bytes
// spans     0x00477740-0x0047783E
// prototype 
...
// subject: ?mon_first_in_space@@YAXH@Z  at 0x00477740  (254 bytes)
//
...
static int *const g_0094cc80 = (int *)0x0094CC80;
static int *const g_0094cc84 = (int *)0x0094CC84;
static int *const g_0094f420 = (int *)0x0094F420;
static int *const g_0094f424 = (int *)0x0094F424;
...
struct MonRecord {
    ...
    int active;
    int count;
    unsigned char pad_18[0x230 - 0x18];
    int state;
    unsigned char pad_end[0x4F4 - 0x230 - 4];
};

void __cdecl mon_first_in_space(int a1) {
    int year = game_year(*g_009a64d4);
    unsigned char flag = *(reinterpret_cast<unsigned char *>(g_00946f58) + a1 * 0x59c);
    if ((flag & 0x80) == 0) {
        MonRecord *table = reinterpret_cast<MonRecord *>(0x0094CC70);
