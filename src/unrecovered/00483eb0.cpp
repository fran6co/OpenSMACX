...
// TRIED: `#pragma function(strcat)` - without it VC6 inlines strcat as a scasb/movs sequence; with it plus a switch(a2){case 1: case 2:} (matching the dec/je/dec/jne shape) this reaches 0.96 mnemonic similarity, MISMATCH only on the final load()-call arg pushes.
...
// calls     0x00608980 0x00629490 0x00629780 0x00645470 0x0064FC88

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_group_clicked@NewTechWin@@QAEXHH@Z  at 0x00483EB0  (220 bytes)
//
...
static int *const g_00686968 = (int *)0x00686968;
static int *const g_00686970 = (int *)0x00686970;
static int *const g_00686978 = (int *)0x00686978;
...
class NewTechWin : public GraphicWin { public:
    ...
    void on_group_clicked(int, int);
};
extern "C" char *__cdecl itoa_impl(int, char *, int);
#pragma function(strcat)

void NewTechWin::on_group_clicked(int a1, int a2) {
    ...
    case 1: {
        *reinterpret_cast<char *>(g_009b86a0) = 0;
        strcat(reinterpret_cast<char *>(g_009b86a0), reinterpret_cast<char *>(g_00686968));
        itoa_impl(*reinterpret_cast<int *>(self + 0xb24), local_50, 10);
        strcat(reinterpret_cast<char *>(g_009b86a0), local_50);
        reinterpret_cast<StringBox *>(self + 0xdc24)->clear();
        title = *reinterpret_cast<char **>(g_00691b04);
        break;
    }
    case 2: {
        *reinterpret_cast<char *>(g_009b86a0) = 0;
        strcat(reinterpret_cast<char *>(g_009b86a0), reinterpret_cast<char *>(g_00686970));
        itoa_impl(*reinterpret_cast<int *>(self + 0xb24), local_50, 10);
        strcat(reinterpret_cast<char *>(g_009b86a0), local_50);
        reinterpret_cast<StringBox *>(self + 0xdc24)->clear();
        title = reinterpret_cast<char *>(g_00686978);
        break;
    }
    default:
        return;
    ...
    reinterpret_cast<StringList *>(self + 0x10794)->load(
        title, reinterpret_cast<char *>(g_009b86a0), 1, 0);
    reinterpret_cast<StringBox *>(self + 0xdc24)->add_fixup();
}
