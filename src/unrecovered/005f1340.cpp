...
// subject: ?OnPaint@Win@@QAA_NPAX@Z  at 0x005F1340  (98 bytes)
//
...
class Win { public:
    ...
    bool __cdecl OnPaint(void *);
};
struct Win_RECT_ { long left; long top; long right; long bottom; };
struct PAINTSTRUCT_ {
    HDC hdc;
    int fErase;
    Win_RECT_ rcPaint;
...
typedef HDC (__stdcall *BeginPaintProc)(void *, PAINTSTRUCT_ *);
typedef int (__stdcall *EndPaintProc)(void *, const PAINTSTRUCT_ *);

bool __cdecl Win::OnPaint(void * a1) {
    PAINTSTRUCT_ ps;
    BeginPaintProc beginPaint = *reinterpret_cast<BeginPaintProc *>(g_006692b8);
    EndPaintProc endPaint = *reinterpret_cast<EndPaintProc *>(g_006692b4);
