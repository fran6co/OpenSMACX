// ORIGINAL: 0x005FB100 FILE
// RULED-OUT: linear search over entries_[] for id==a1 (sentinel -1 terminates
//            early, cap at 15), then entries_[i].pull_down->add_item(a2, a3);
//            compiles and matches through the search, diverges at #1 in the
//            call-site register shuffle (push vs mov)
// working copy - scaffold materialised by --work
// name      ?add_menu_item@Menu@@QAEHHHPAD@Z
// size      89 bytes
// spans     0x005FB100-0x005FB159
...
// subject: ?add_menu_item@Menu@@QAEHHHPAD@Z  at 0x005FB100  (89 bytes)
//
...
int Menu::add_menu_item(int a1, int a2, char * a3) {
    MenuEntry *e = entries_;
    int i = 0;
    for (;;) {
        if (e->id == -1) {
            return 0xb;
    ...
    return e->pull_down->add_item(a2, a3);
}
