// ORIGINAL: 0x00612710 sub_612710 0x00612710-0x006127AA FILE
...
// calls     0x005D4DD0 0x00608E10 0x00611A90 0x0064557F

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_612710  at 0x00612710  (154 bytes)
//
...
static int *const g_006708c0 = (int *)0x006708C0;
static int *const g_006708cc = (int *)0x006708CC;
static int *const g_006708d4 = (int *)0x006708D4;
// SIGNATURE CHANGED: `lea edi,[ecx-0x8c]` and every subsequent access is
// through that adjusted `this`, with no matching stack slot - this is a
// __thiscall scalar deleting destructor (this in ecx, one stack flag,
// ret 4), not the stdcall free-function fallback.
extern "C" void __cdecl fn_0064557f_real(void *);

class Sub612710Rec {
public:
    void *scalar_delete_dtor(unsigned int flags);
};

void *Sub612710Rec::scalar_delete_dtor(unsigned int flags) {
    char *esi = reinterpret_cast<char *>(this);
    char *edi = esi - 0x8c;
    int *vbtable = *reinterpret_cast<int **>(edi);
    int disp1 = vbtable[1];
    *reinterpret_cast<int *>(edi + disp1) = (int)g_006708d4;
    *reinterpret_cast<int *>(esi + 0x3b8 + disp1) = (int)g_006708cc;
    int disp2 = vbtable[2];
    *reinterpret_cast<int *>(edi + disp2) = (int)g_006708c0;
    *reinterpret_cast<int *>(esi - 0x90 + disp1) = disp1 - 0x8c;
    *reinterpret_cast<int *>(esi - 0x90 + disp2) = disp2 - 0xaa4;
    reinterpret_cast<EditGroup *>(edi)->close();
    reinterpret_cast<Dialog *>(edi + 0xaa4)->~Dialog();
    reinterpret_cast<GraphicWin *>(esi)->~GraphicWin();
    if (flags & 1) {
        fn_0064557f_real(edi);
    }
    return edi;
}
