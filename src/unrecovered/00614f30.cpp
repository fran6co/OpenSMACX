...
// subject: ?close@EditBox@@QAEXXZ  at 0x00614F30  (161 bytes)
//
...
static int *const g_006971dc = (int *)0x006971DC;
static int *const g_006971e0 = (int *)0x006971E0;
static int *const g_006971e4 = (int *)0x006971E4;
...
void EditBox::close() {
    ...
    *reinterpret_cast<int *>(self + 0xb28) = *g_009b90b8;
    *reinterpret_cast<int *>(self + 0xb2c) = *g_009b90bc;
    *reinterpret_cast<int *>(self + 0xb30) = *g_006971e0;
    *reinterpret_cast<int *>(self + 0xb34) = *g_006971e4;
    *reinterpret_cast<int *>(self + 0xb1c) = *g_006971dc;
    *reinterpret_cast<int *>(self + 0xb20) = *g_006971f8;
    *reinterpret_cast<int *>(self + 0xb24) = *g_006971f4;
