...
// calls     0x0045BE80 0x0045C290 0x0045D2A0 0x0045D440 0x0045D970 0x005D5890 0x005D8200
// indirect  0x00422D04 0x00422D13 0x00422D23 0x00422D32 0x00422D72 0x00422D7F 0x00422D8D 0x00422D9A

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_status@BattleWin@@QAEXH@Z  at 0x00422CC0  (249 bytes)
//
...
static int *const g_007b2350 = (int *)0x007B2350;
...
class VCallObjV { public: void slot(); };
union VCallShimV {
    void (VCallObjV::*memberFn)();
    void *raw;
};

void BattleWin::on_status(int a1) {
    if (a1 != 0) {
        ((Buffer *)0x7aec64)->set_clip(0, 0, *(int *)0x7af5b0, -*(int *)0x7aece8);
        ((MainInterface *)0x7ae820)->restore_back(0);

        (reinterpret_cast<VCallObjI *>(0x7b1804)->*(*(VCallShimI *)((char *)*(void **)0x7b1804 + 4)).memberFn)(0);
        (reinterpret_cast<VCallObjI *>(0x7b2350)->*(*(VCallShimI *)((char *)*(void **)0x7b2350 + 4)).memberFn)(0);
        (reinterpret_cast<VCallObjI *>(0x7b39e8)->*(*(VCallShimI *)((char *)*(void **)0x7b39e8 + 4)).memberFn)(0);
        (reinterpret_cast<VCallObjI *>(0x7b4534)->*(*(VCallShimI *)((char *)*(void **)0x7b4534 + 4)).memberFn)(0);

        slide_show(0, 2);

        ((MainInterface *)0x7ae820)->set_alert(1);
        ((MainInterface *)0x7ae820)->set_date(0);
        ((GraphicWin *)0x7ae820)->soft_update();
        return;
    }

    (reinterpret_cast<VCallObjV *>(0x7b39e8)->*(*(VCallShimV *)((char *)*(void **)0x7b39e8 + 8)).memberFn)();
    (reinterpret_cast<VCallObjV *>(0x7b4534)->*(*(VCallShimV *)((char *)*(void **)0x7b4534 + 8)).memberFn)();
    (reinterpret_cast<VCallObjV *>(0x7b1804)->*(*(VCallShimV *)((char *)*(void **)0x7b1804 + 8)).memberFn)();
    (reinterpret_cast<VCallObjV *>(0x7b2350)->*(*(VCallShimV *)((char *)*(void **)0x7b2350 + 8)).memberFn)();

    ((MainInterface *)0x7ae820)->set_alert(0);
    slide_hide(0, 2);
}
