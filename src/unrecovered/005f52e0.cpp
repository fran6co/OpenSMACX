// ORIGINAL: 0x005F52E0 FILE
// RULED-OUT: MISMATCH, closest at 193/188 bytes (mnemonic_similarity 0.90).
//            An extra `push ebx` appears (register pressure from 4 live
//            locals in the z-order loop: entry/cur/j plus the 'this'-Win
//            receiver) that the original avoids; tried both a direct
//            `(*entry)->iSomeFlag_ & 1` and a cached `Win *w = *entry;`
//            form, no difference. `g_win_zorder_list` as its own
//            `extern Win *[]` (not the fixed-address alias) for the
//            indexed array walk, per the indexed-table-base lever.
// working copy - scaffold materialised by --work
// name      ?bring_child_to_top@Win@@QAEXPAVWin@@@Z
// size      188 bytes
// spans     0x005F52E0-0x005F539C
...
// subject: ?bring_child_to_top@Win@@QAEXPAVWin@@@Z  at 0x005F52E0  (188 bytes)
//
