...
// TRIED: register scheduling (mov vs push at entry) and imul-vs-lea strength reduction for a2*400 - both are compiler allocation choices, not source-form bugs; landed at MISMATCH.
// size      237 bytes
// prototype int (__thiscall ?fill_player@NetWin@@QAEXPAUPlayerData@@H@Z)(NetWin* this, player_data*, int)
// callers   1   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x006169A0 0x00645460 0x00645470

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?fill_player@NetWin@@QAEXPAUPlayerData@@H@Z  at 0x00481DA0  (237 bytes)
//
...
void NetWin::fill_player(PlayerData * a1, int a2) {
    if (a2 == -1) {
        char *dst = reinterpret_cast<char *>(a1) + 0x45;
        *dst = 0;
        char *tbl = *reinterpret_cast<char **>(g_009b90f8);
        strcat(dst, reinterpret_cast<char *>(
            reinterpret_cast<Strings *>(g_009b90d8)->get(
                *reinterpret_cast<int *>(tbl + 0xfe4))));
        return;
    }
    int off = a2 * 400;
    char *ab = reinterpret_cast<char *>(a1);
    unsigned int base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    strcpy(ab + 5, reinterpret_cast<char *>(base) + 0x22 + off);
    base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    strcpy(ab + 0x1d, reinterpret_cast<char *>(base) + 0x3a + off);
    base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    strcpy(ab + 0x45, reinterpret_cast<char *>(base) + 0x62 + off);
    base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    strcpy(ab + 0x5d, reinterpret_cast<char *>(base) + 0x7a + off);
    base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    strcpy(ab + 0xdd, reinterpret_cast<char *>(base) + 0xfa + off);
    base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    strcpy(ab + 0xf5, reinterpret_cast<char *>(base) + 0x112 + off);
    base = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(this) + 0x772c);
    ab[0x175] = *(reinterpret_cast<char *>(base) + 0x192 + off);
}
