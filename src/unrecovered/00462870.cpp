...
// subject: ?clear@MapWin@@QAEXH@Z  at 0x00462870  (233 bytes)
//
...
void MapWin::clear(int a1) {
    ...
    field_1DD78_ = a1;
    field_1DD70_ = 0;
    field_1DD98_ = (((*g_00939e5c < 1000) - 1) & 6) - 6;
    field_1DD74_ = (a1 == 0);

    int halfHeight = *g_00949874 / 2;
    field_1DDA0_ = halfHeight;
    int halfWidth = *g_00949870 / 2;
    field_1DD9C_ = (halfWidth ^ halfHeight) & 1 ^ halfWidth;

    if (a1 == 0) {
        int player = *g_009392b8;
        int cy = g_939340[player];
        int cx = g_9392c0[player];
        if (cy >= 0 && cy < *g_00949874 && cx >= 0 && cx < *g_00949870) {
            field_1DD9C_ = cx;
            field_1DDA0_ = g_939340[*g_009392b8];
        }
    }
