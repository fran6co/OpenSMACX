...
// TRIED: the 3 set_def_* callees needed `static` added by hand (the emitter leaves BasePop/Dialog/BaseButton members non-static); after that, MISMATCH #3 is /O2 hoisting the three unrelated global stores (6a721c/696ed0/696ed4/696ee0/697058) past the call-argument loads for scheduling - not a source-order issue, statement order already matches the Ghidra order.
...
// subject: sub_588800  at 0x00588800  (222 bytes)
//
...
extern "C" void __cdecl sub_588800() {
    *g_006a721c = 1;
    BasePop::set_def_string_font(reinterpret_cast<Font *>(*g_009403dc), reinterpret_cast<Font *>(*g_009457f4), reinterpret_cast<Font *>(*g_009457f0), 0);
    Dialog::set_def_dialog_font(reinterpret_cast<Font *>(*g_009403dc), reinterpret_cast<Font *>(*g_009457f4), reinterpret_cast<Font *>(*g_009457f0));
    BasePop::set_def_button_font(reinterpret_cast<Font *>(*g_009403dc), reinterpret_cast<Font *>(*g_009457f4), reinterpret_cast<Font *>(*g_009457f0));
    *g_00696ed0 = 3;
    *g_00696ed4 = 3;
    *g_00696ee0 = 0;
    BasePop::set_def_string_color(*g_0068a5a4, -1, 1, 1);
    BasePop::set_def_string_color2(*g_0068a5a4, -1, 1, 1);
    BasePop::set_def_string_color3(*g_0068a5a4, -1, 1, 1);
    *g_00697058 = 1;
    BaseButton::set_def_font(reinterpret_cast<Font *>(*g_009403dc), 0, 0);
