...
// subject: ?on_sys_key@Win@@QAGHIJHI@Z  at 0x005F6230  (152 bytes)
//
...
class Win { public:
    ...
    int __stdcall on_sys_key(unsigned int, long, int, unsigned int);
};
typedef int (__stdcall *PostMessageAFn)(void *, unsigned int, unsigned int, long);
typedef int (__stdcall *DefWindowProcAFn)(void *, unsigned int, unsigned int, long);

int __stdcall Win::on_sys_key(unsigned int a1, long a2, int a3, unsigned int a4) {
    void *hwnd;
    unsigned int lParam;
    if (a2 != 0) {
        hwnd = HandleMain;
