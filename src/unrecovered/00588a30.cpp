// ORIGINAL: 0x00588A30 sub_588a30 0x00588A30-0x00588A9A FILE
...
// subject: sub_588a30  at 0x00588A30  (106 bytes)
//
...
class BasePop : public GraphicWin { public:
    ...
    int set_def_button_font(Font *, Font *, Font *);
    int set_def_string_font(Font *, Font *, Font *, Font *);
};
...
class Dialog { public:
    ...
    uint32_t field_F0_;
    int set_def_dialog_font(Font *, Font *, Font *);
};
...
extern "C" int __cdecl fn_006048c0(Font *, Font *, Font *, Font *);
extern "C" int __cdecl fn_00609d20(Font *, Font *, Font *);
extern "C" int __cdecl fn_006049c0(Font *, Font *, Font *);

extern "C" int __cdecl sub_588a30() {
    *g_006a721c = 4;
    fn_006048c0((Font *)*g_00945770, (Font *)*g_009457fc,
               (Font *)*g_009457f8, (Font *)0);
    fn_00609d20((Font *)*g_00945770, (Font *)*g_009457fc,
               (Font *)*g_009457f8);
    fn_006049c0((Font *)*g_0094576c, (Font *)*g_0094580c,
               (Font *)*g_00945808);
    *g_00696ed0 = 2;
    *g_00696ed4 = 2;
    return 2;
