...
// calls     0x0060A020 0x0060C920 0x0060C9B0 0x0062B870

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?UNK3@MessageWin@@QAEHHHPAD@Z  at 0x004714D0  (91 bytes)
//
...
class MessageWinUNK3Shim : public MessageWin { public:
    int UNK3v2(int, int, char *, int);
};

int MessageWinUNK3Shim::UNK3v2(int a1, int a2, char * a3, int a4) {
    int id = (*g_00949870 * a2 + a1) | 0x80000000;
    ++(*g_009393d0);
    listBox_.item(a3, id);
    listBox_.set_selected_pos(-1, 1);
    listBox_.update_changes();
    return g_ButtonGroupAt7CD098->set(1000, 1);
}
