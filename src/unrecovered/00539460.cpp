...
// calls     0x00514880 0x005315C0 0x00592EE0 0x006262F0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?net_energy@@YAXHHHHH@Z  at 0x00539460  (166 bytes)
//
...
extern int g_96cc00_tbl[];

void __cdecl net_energy(int a1, int a2, int a3, int a4, int a5) {
    if (*g_0093f660 != 0) {
        log_say((char *)g_0068d4bc, a1, a3, a2);
        message_data(0x2447, 0, a1, a2, a3, a4);
        if (a5 != 0) {
        ...
        if (a1 != 0) {
            g_96cc00_tbl[a1 * 0x833] += a2;
        }
        if (a3 != 0) {
            g_96cc00_tbl[a3 * 0x833] += a4;
        }
