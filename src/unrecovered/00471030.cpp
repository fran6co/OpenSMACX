...
// calls     0x00462870 0x00470420 0x00470A90 0x00470ED0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?mapwin_system_init@@YAXH@Z  at 0x00471030  (175 bytes)
//
...
static int *const g_007d3c60 = (int *)0x007D3C60;
static int *const g_007d3c88 = (int *)0x007D3C88;
static int *const g_007d3d64 = (int *)0x007D3D64;
static int *const g_007d4060 = (int *)0x007D4060;
void __cdecl mapwin_system_init(int a1) {
    int *p;
    int i;
    int obj;

    reinterpret_cast<MapWin *>(0)->compute_lighting_table();

    p = g_007d3c60;
    do {
        if (reinterpret_cast<int>(p) < reinterpret_cast<int>(g_007d3c88) ||
            reinterpret_cast<int>(g_007d3d64) < reinterpret_cast<int>(p)) {
            *p = 0;
        } else {
            *p = 1;
        }
        p++;
    } while (reinterpret_cast<int>(p) < reinterpret_cast<int>(g_007d4060));
...
lab_a6:
                ...
                reinterpret_cast<MapWin *>(obj)->clear(i);
                obj = g_007d3c3c[i];
                reinterpret_cast<MapWin *>(obj)->field_1DD74_ = (i == 0);
                if (i != 1) goto lab_a6;
                reinterpret_cast<MapWin *>(*g_007d3c40)->field_1DD74_ = 1;
lab_aa:
                obj = g_007d3c3c[i];
                if (reinterpret_cast<MapWin *>(obj)->field_1DD74_ == 0) goto lab_cb;
            }
            reinterpret_cast<MapWin *>(g_007d3c3c[i])->init(0, 0);
        }
lab_cb:
        i++;
        if (i > 7) {
    ...
    reinterpret_cast<MapWin *>(g_007d4060)->init_dummy();
    //
