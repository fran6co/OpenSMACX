...
// calls     0x004AE4D0 0x005D5890
// indirect  0x004AE46F 0x004AE484

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_key_click@SetupWin@@QAEHHH@Z  at 0x004AE3E0  (189 bytes)
//
...
static int *const g_004ae4a0 = (int *)0x004AE4A0;

class SetupWin { public:
    int draw_item(int, int);
    int on_key_click(int, int);
};
int SetupWin::on_key_click(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    int *v3f4 = reinterpret_cast<int *>(self + 0xFD0);
    int *v3f3 = reinterpret_cast<int *>(self + 0xFCC);
    int cur, next;
    switch (a2) {
        case 0xd:
