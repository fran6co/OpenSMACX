// ORIGINAL: 0x00608C00 ??1Text@@QAE@XZ 0x00608C00-0x00608C05 FILE BYTE_EXACT
...
// subject: ??1Text@@QAE@XZ  at 0x00608C00  (5 bytes)
//
...
class TextShutdownShim { public:
    void shutdown();
};

Text::~Text() {
    reinterpret_cast<TextShutdownShim *>(this)->shutdown();
}
