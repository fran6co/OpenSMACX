...
// TRIED: named locals for a1/a4/a6 to hint push order - callee-saved register allocation order (ebx/ebp/esi/edi) still differs from source order; only the prologue's push/mov sequencing diverges
...
// calls     0x005D94B0 0x005DFB50 0x005E34A3 0x00617230 0x00618470

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?render_multi_table_dest@Caviar@@QAEXPAUBuffer@@HHHPAEH@Z  at 0x006171A0  (134 bytes)
//
...
void Caviar::render_multi_table_dest(Buffer * a1, int a2, int a3, int a4, unsigned char * a5, int a6) {
    reinterpret_cast<Buffer *>(g_009b9108)->fill(a4);
    if (render(a1, a2, a3, a6 | 8) == 0) {
        reinterpret_cast<Buffer *>(g_009b9108)->draw_multi_table_dest(a1, a4, a2 - 0x80, a3 - 0x80, 1, 1, a5);
        a1->free_data(1);
