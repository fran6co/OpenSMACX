...
// calls     0x0047A890 0x00531020 0x005310F0 0x00593220 0x00625EC0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?designate@Console@@QAEXH@Z  at 0x004D7CF0  (232 bytes)
//
...
static int *const g_00688e44 = (int *)0x00688E44;
static int *const g_00688e50 = (int *)0x00688E50;
...
extern char tbl_9ab88d[];
extern unsigned char tbl_94ae68[];
extern char tbl_95282c[];
extern char tbl_9ab868[];

void Console::designate(int a1) {
    short field1 = *reinterpret_cast<short *>(tbl_952832 + a1 * 0x34);
    unsigned char b = *reinterpret_cast<unsigned char *>(tbl_9ab88d + field1 * 0x34);
    unsigned char c = tbl_94ae68[b * 0x10];
    if (c != 0) {
        int lockResult = reinterpret_cast<NetDaemon *>(0x93CD90)->lock_veh(&a1, 0, -1, -1, 0);
        if (lockResult == 0) {
            *reinterpret_cast<unsigned int *>(tbl_95282c + a1 * 0x34) ^= 0x80;
            synch_veh(a1);
            reinterpret_cast<NetDaemon *>(0x93CD90)->unlock_veh();
            short field1b = *reinterpret_cast<short *>(tbl_952832 + a1 * 0x34);
            parse_says(0, tbl_9ab868 + field1b * 0x34, -1, -1);
            if ((*reinterpret_cast<unsigned char *>(tbl_95282c + a1 * 0x34) & 0x80) != 0) {
                reinterpret_cast<NetMsg *>(0x805338)->pop(reinterpret_cast<const char *>(g_00688e44), 5000, 0, 0);
                return;
            }
            reinterpret_cast<NetMsg *>(0x805338)->pop(reinterpret_cast<const char *>(g_00688e50), 5000, 0, 0);
        }
    }
