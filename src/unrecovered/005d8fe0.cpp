...
// symbol    ?sub_5d8fe0@BufferSelf@@QAEHHHHHH@Z
...
// subject: sub_5d8fe0  at 0x005D8FE0  (238 bytes)
//
...
class BufferSelf { public:
    ...
    int sub_5d8fe0(int, int, int, int, int);
};

int BufferSelf::sub_5d8fe0(int a1, int a2, int a3, int a4, int a5) {
    int transparent = a2;
    if (field_58_ == 0) {
        if (a2 == -1) {
...
tail:
    {
        int result = reinterpret_cast<Sprite *>(g_009b3a50)->draw(
