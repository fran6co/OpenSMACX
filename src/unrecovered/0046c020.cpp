...
// calls     0x0046A550 0x0046B510 0x005C5A30

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?UNK4@MapWin@@QAEXHH@Z  at 0x0046C020  (169 bytes)
//
...
extern MapWin *g_7d3c3c_tbl[];

void MapWin::UNK4(int a1, int a2) {
    editor(a1, a2, field_1DD8C_ & 2);
    field_1DD8C_ = 0;
    if ((*g_00945ae0 != 0) && (*g_00945ae0 != 2) && (*g_00945ae0 != 0x12)) {
        MapWin **p = g_7d3c3c_tbl;
        do {
            MapWin *w = *p;
            if ((w != 0) && ((p == g_7d3c3c_tbl) || (w->field_1DD74_ != 0))) {
                w->draw_map(1);
            }
            ++p;
        } while (reinterpret_cast<int>(p) < 0x7d3c5c);
        return;
    }
    world_climate();
    MapWin **p = g_7d3c3c_tbl;
