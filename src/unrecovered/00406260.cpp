// ORIGINAL: 0x00406260 FILE
// RULED-OUT: RECT localSpot = *(RECT*)(self+0x474) reproduces the
//            magic-number /10000==1000 check and the dead left/right
//            stores as a struct copy; MISMATCH from #24, the scroll rect
//            arithmetic scheduling around the init() args differs slightly
// working copy - scaffold materialised by --work
// name      ?on_listbox_scroll_create@Popup@@QAEHXZ
// size      195 bytes
// spans     0x00406260-0x00406323
...
// subject: ?on_listbox_scroll_create@Popup@@QAEHXZ  at 0x00406260  (195 bytes)
//
...
int Popup::on_listbox_scroll_create() {
    char *self = reinterpret_cast<char *>(this);
    if (*reinterpret_cast<int *>(self + 0x30ac) / 10000 == 1000) {
        return 0;
    }
    scroll_normal();

    RECT localSpot = *reinterpret_cast<RECT *>(self + 0x474);
    int arg4 = (((localSpot.bottom - *g_007cff88) - *g_007cff30 - (localSpot.top + 0xd) - 0x2c) / *g_007cff5c) * (*g_007cff5c)
               + *g_007cff88 + *g_007cff30 - 10;

    Scroll *scroll = reinterpret_cast<Scroll *>(self + 0x3230);
    scroll->init(*reinterpret_cast<int *>(self + 0x4c4) - 0x2b, 0x15, 0x18, arg4,
                 reinterpret_cast<Win *>(this), -1, 1);
