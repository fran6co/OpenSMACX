...
// calls     0x006048C0 0x00604900 0x00604930 0x00604960 0x006049C0 0x00607420 0x006074B0 0x00609D20

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?popups_tutorial@@YAXXZ  at 0x005888E0  (222 bytes)
//
...
class BaseButton : public GraphicWin { public:
    ...
    uint32_t field_AB0_;
    uint32_t field_AB4_;
    static int set_def_font(Font *, Font *, Font *);
    static void set_def_text_color(int, int, int, int);
};
...
class BasePop : public GraphicWin { public:
    ...
    static int set_def_button_font(Font *, Font *, Font *);
    static int set_def_string_font(Font *, Font *, Font *, Font *);
    static void set_def_string_color(int, int, int, int);
    static void set_def_string_color2(int, int, int, int);
    static void set_def_string_color3(int, int, int, int);
};
...
class Dialog { public:
    ...
    uint32_t field_F0_;
    static int set_def_dialog_font(Font *, Font *, Font *);
};
...
void __cdecl popups_tutorial() {
    Font *f_7f8 = reinterpret_cast<Font *>(*g_009457f8);
    Font *f_7fc = reinterpret_cast<Font *>(*g_009457fc);
    Font *f_770 = reinterpret_cast<Font *>(*g_00945770);
    *g_006a721c = 2;
    BasePop::set_def_string_font(f_770, f_7fc, f_7f8, 0);
    Dialog::set_def_dialog_font(
        reinterpret_cast<Font *>(*g_00945770),
        reinterpret_cast<Font *>(*g_009457fc),
        reinterpret_cast<Font *>(*g_009457f8));
    BasePop::set_def_button_font(
        reinterpret_cast<Font *>(*g_0094576c),
        reinterpret_cast<Font *>(*g_0094580c),
        reinterpret_cast<Font *>(*g_00945808));

    *g_00696ed0 = 3;
    *g_00696ed4 = 3;
    int color_val = *g_0068a5a4;
    *g_00696ee0 = 0;
    BasePop::set_def_string_color(color_val, -1, 1, 1);
    BasePop::set_def_string_color2(*g_0068a5a4, -1, 1, 1);
    BasePop::set_def_string_color3(*g_0068a5a4, -1, 1, 1);

    Font *f_403dc = reinterpret_cast<Font *>(*g_009403dc);
    *g_00697058 = 1;
    BaseButton::set_def_font(f_403dc, 0, 0);
    BaseButton::set_def_text_color(0, -1, 1, 1);

    *g_0069704c = *g_0068a5b8;
}
