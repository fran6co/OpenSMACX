...
// calls     0x005D7410 0x005E3820 0x005FAD00 0x006456E4

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ??1AlphaMenu@@QAE@XZ  at 0x0051DC10  (164 bytes)
//
...
static int *const g_0065d244 = (int *)0x0065D244;
static int *const g_0067b8a0 = (int *)0x0067B8A0;
...
AlphaMenu::~AlphaMenu() {
    ...
    fn_006456e4(self + 0x1118, 0x2c, 3, reinterpret_cast<void (*)(void *)>(g_00406850));
    reinterpret_cast<Sprite *>(self + 0x10ec)->close();
    reinterpret_cast<Buffer *>(self + 0xb64)->~Buffer();
    reinterpret_cast<Menu *>(self)->~Menu();
