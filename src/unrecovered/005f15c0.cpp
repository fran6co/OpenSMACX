// ORIGINAL: 0x005F15C0 FILE
// RULED-OUT: MISMATCH #1 test/push at the ternary-vs-if for the first
//            global select; body verified structurally correct otherwise
// working copy - scaffold materialised by --work
// name      ?OnKey@Win@@QAAXPAXIJHI@Z
// size      151 bytes
// spans     0x005F15C0-0x005F1657
// prototype 
// callers   0   call targets   1
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x005F7E90
// indirect  0x005F162F 0x005F1643

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?OnKey@Win@@QAAXPAXIJHI@Z  at 0x005F15C0  (151 bytes)
//
...
// This body dispatches through slot(s): 78
class VCall { public:
...
class Win { public:
    ...
    int is_visible();
    void __cdecl OnKey(void *, unsigned int, long, int, unsigned int);
};
// Second vtable shim: slot078 needs a real signature (this + 4 ints);
// the file's own VCall types every slot void().
class VCall2 { public:
    ...
    virtual void slot078(unsigned int, long, int, unsigned int);
};
    ...
    *p_9b7ac8 = chosen;
    ...
    if (chosen != 0) {
        ...
        if (inner != 0 && (*((unsigned char *)inner + 0x9c) & 1) != 0) {
            ...
            if (visible != 0) {
                ((VCall2 *)inner)->slot078(a2, a3, a4, a5);
            }
        }
    }
