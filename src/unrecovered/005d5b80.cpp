...
// TRIED: Win::get_hdc/release_hdc called w/ explicit this (mismatch at implicit-ecx call sites); LFSR loop as do/while matching asm
...
// calls     0x005DE8F0 0x005E3503 0x005E3563 0x005EC690 0x005EC6F0 0x005F2C60 0x005FE460 0x00628AB0
// indirect  0x005D5C1B

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_5d5b80  at 0x005D5B80  (206 bytes)
//
...
int bit_count_signed(int);

// ---- fixed globals this body references ----
// The const-pointer spelling reproduces the original's
// encoding including the address; `extern T *g` does not.
static int *const g_00669054 = (int *)0x00669054;
static int *const g_00696b6c = (int *)0x00696B6C;
static int *const g_009b8180 = (int *)0x009B8180;
class Sub5D5B80Self { public:
    int run();
};

int Sub5D5B80Self::run() {
    ...
    win->sync_palette();
    reinterpret_cast<Palette *>(*g_009b8180)->set();
    ...
    int bitCount = bit_count_signed(rows);
    unsigned int poly = *reinterpret_cast<unsigned int *>(reinterpret_cast<char *>(g_00696b6c) + bitCount * 4);

    unsigned int y = 1;
    do {
        if (static_cast<int>(y) < rows) {
            typedef int (__stdcall *BitBltFn)(void *, int, int, int, int, void *, int, int, unsigned int);
            (*reinterpret_cast<BitBltFn *>(g_00669054))(hdc, 0, y, width, 1, reinterpret_cast<void *>(bufferHdc), 0, y, 0xcc0020);
        }
        if ((y & 1) == 0) {
            y = (y >> 1) ^ poly;
        } else {
    ...
    win->release_hdc();
    buf->release_hdc(static_cast<int>(y));
