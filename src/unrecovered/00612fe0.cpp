// ORIGINAL: 0x00612FE0 FILE
// RULED-OUT: interleaved case grouping (1,6,11/2,7,12/...) compiles to a
//   direct 16-entry jump table; CONTIGUOUS ranges (1-3/4-6/7-9/10-12/13-16)
//   compile to the byte-selector + address-table dispatch the original
//   uses, matching mov/dec/cmp/ja/xor/mov/jmp exactly (99.2% mnemonic sim,
//   only diverges 2 bytes past the final ret - same isolated-compile jump
//   table alignment artifact noted on 0x006130E0's sibling).
// working copy - scaffold materialised by --work
// name      ?attach@Dialogs@@QAEHPAUGraphicWin@@HHH@Z
// size      206 bytes
// spans     0x00612FE0-0x006130AE
...
// calls     0x0060A670 0x0060D1F0 0x0060E800 0x00610540 0x00611AF0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?attach@Dialogs@@QAEHPAUGraphicWin@@HHH@Z  at 0x00612FE0  (206 bytes)
//
...
static int *const g_006130b0 = (int *)0x006130B0;
...
int Dialogs::attach(GraphicWin * a1, int a2, int a3, int a4) {
    char *self = reinterpret_cast<char *>(this);
    int type_id = *reinterpret_cast<int *>(self - 0xa20);
    switch (type_id) {
    case 1: case 2: case 3:
        return reinterpret_cast<RadioButton *>(self - 0x12C)->attach(a1, a2, a3, a4);
    case 4: case 5: case 6:
        return reinterpret_cast<ListBox *>(self - 0x140)->attach(a1, a2, a3, a4);
    case 7: case 8: case 9:
        return reinterpret_cast<CheckBox *>(self - 0x114)->attach(a1, a2, a3, a4);
    case 10: case 11: case 12:
        return reinterpret_cast<SpriteBox *>(self - 0x8C)->attach(a1, a2, a3, a4);
    case 13: case 14: case 15: case 16:
        return reinterpret_cast<EditGroup *>(self - 4)->attach(a1, a2, a3, a4);
    default:
        return 7;
    }
}
