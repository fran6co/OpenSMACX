// ORIGINAL: 0x005D8650 sub_5d8650 0x005D8650-0x005D873E FILE BYTE_EXACT
// symbol    ?draw_UNK2@BufferSelf@@QAEHHHHHH@Z
...
// calls     0x005E4AEA
// indirect  0x005D8707
// 005d8840/005d8a30/005d8df0/005d8fe0/005d91d0/005d93c0: a thiscall Buffer
...
// function's - so this stays a self-contained unit.
// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_5d8650  at 0x005D8650  (238 bytes)
//
...
class BufferSelf { public:
    ...
    int draw_UNK2(int, int, int, int, int);
};

int BufferSelf::draw_UNK2(int a1, int a2, int a3, int a4, int a5) {
    int transparent = a2;
    if (field_58_ == 0) {
        if (a2 == -1) {
...
tail:
    {
        int result = reinterpret_cast<Sprite *>(g_009b3a50)->UNK2(a1, a2, a3, a4, a5);
        *g_009b3a54 = 0;
        return result;
    }
}
