...
// TRIED: `check(a1, a2, &a1, &a2)` for the out-params (wrong operand order); the push order decodes to check(a1,a2,&a2,&a1). Explicit __thiscall function-pointer typedef for the vtable slot at +0xE4 (C4234) - a member-function-pointer/union shim compiles. MISMATCH #16 'inc' vs 'cmp' remains open.
