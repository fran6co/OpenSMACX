...
// subject: ?string@BasePop@@QAEHPAD@Z  at 0x00601980  (110 bytes)
//
...
int BasePop::string(char * a1) {
    ...
    *(char **)(self + 0x219C) = str;
    *(int *)(self + 0x21A0) = count;
    *(int *)(self + 0x21A4) = 0;
    StringStruct *ss = (StringStruct *)(self + 0x2180);
    return ss->add(0) != 0;
}
