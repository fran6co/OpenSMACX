// ORIGINAL: 0x0046FE00 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?get_relative_alt@MapWin@@QAEHHHH@Z
// size      103 bytes
// spans     0x0046FE00-0x0046FE67
// prototype int (__thiscall ?get_relative_alt@MapWin@@QAEHHHH@Z)(MapWin* this, int, int, int)
...
// subject: ?get_relative_alt@MapWin@@QAEHHHH@Z  at 0x0046FE00  (103 bytes)
//
...
int MapWin::get_relative_alt(int a1, int a2, int a3) {
    get_alt(a1, a2, a3);
    if (owned_ == 0) {
        return 0;
    }
    ...
    int row = (*g_00949870 >> 1) * a2 + (a1 >> 1);
    unsigned short val = *reinterpret_cast<unsigned short *>((char *)owned_ + 10 + row * 12);
    int shift = (a3 - 1) * 4;
