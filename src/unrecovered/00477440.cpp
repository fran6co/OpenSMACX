...
static int *const g_0094cbd8 = (int *)0x0094CBD8;
static int *const g_0094cbdc = (int *)0x0094CBDC;
static int *const g_0094f378 = (int *)0x0094F378;
...
struct MonRecord {
    ...
    int active;
    int count;
    unsigned char pad_18[0x2D8 - 0x18];
    int state;
    unsigned char pad_end[0x4F4 - 0x2D8 - 4];
};

void __cdecl mon_naval_unit_built(int a1) {
    int year = game_year(*g_009a64d4);
    unsigned char flag = *(reinterpret_cast<unsigned char *>(g_00946f58) + a1 * 0x59c);
    if ((flag & 0x80) == 0) {
        MonRecord *table = reinterpret_cast<MonRecord *>(0x0094CBC8);
