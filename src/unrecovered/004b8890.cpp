// ORIGINAL: 0x004B8890 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?on_redraw@StatusWin@@QAEXXZ
// size      219 bytes
// spans     0x004B8890-0x004B896B
// prototype void (__thiscall ?on_redraw@StatusWin@@QAEXXZ)(StatusWin* this)
// callers   3   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x004B6570 0x005D5930 0x00618F40
// indirect  0x004B8946 0x004B8955

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_redraw@StatusWin@@QAEXXZ  at 0x004B8890  (219 bytes)
//
...
void StatusWin::on_redraw() {
    char *self = reinterpret_cast<char *>(this);
    int fontSize = ((*g_009b7b1c != 0x320) ? 2 : 0) + 10;

    if (fontSize != *reinterpret_cast<int *>(self + 0x15ac)) {
        *reinterpret_cast<int *>(self + 0x15ac) = fontSize;
        reinterpret_cast<Font *>(self + 0x1530)->init(reinterpret_cast<char *>(*g_00691b2c), fontSize, 0);
        reinterpret_cast<Font *>(self + 0x1558)->init(reinterpret_cast<char *>(*g_00691b2c), fontSize, 2);
        reinterpret_cast<Font *>(self + 0x1580)->init(reinterpret_cast<char *>(*g_00691b2c), fontSize, 1);
    }
    ...
    unionRect(&rect, reinterpret_cast<RECT *>(g_007af50c), reinterpret_cast<RECT *>(g_007af4ec));
