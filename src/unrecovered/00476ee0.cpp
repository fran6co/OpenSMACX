// ORIGINAL: 0x00476EE0 FILE
// name      ?mon_prototype_built@@YAXH@Z
// size      254 bytes
// spans     0x00476EE0-0x00476FDE
// prototype 
...
// subject: ?mon_prototype_built@@YAXH@Z  at 0x00476EE0  (254 bytes)
//
...
static int *const g_0094cac0 = (int *)0x0094CAC0;
static int *const g_0094cac4 = (int *)0x0094CAC4;
...
struct MonRecord {
    ...
    int active;
    int count;
    unsigned char pad_18[0x3F0 - 0x18];
    int state;
    unsigned char pad_end[0x4F4 - 0x3F0 - 4];
};

void __cdecl mon_prototype_built(int a1) {
    int year = game_year(*g_009a64d4);
    unsigned char flag = *(reinterpret_cast<unsigned char *>(g_00946f58) + a1 * 0x59c);
    if ((flag & 0x80) == 0) {
        MonRecord *table = reinterpret_cast<MonRecord *>(0x0094CAB0);
