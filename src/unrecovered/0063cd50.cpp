// ORIGINAL: 0x0063CD50 sub_63cd50 0x0063CD50-0x0063CDBB FILE
...
// calls     0x005D5350 0x005E3203

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_63cd50  at 0x0063CD50  (107 bytes)
//
...
// `mov edi, ecx` with no stack access before the calls -> the receiver is
// `this`; this is a __thiscall member, not a free __cdecl function.
class Obj63CD50 { public:
    void method();
};

void Obj63CD50::method() {
    char *self = reinterpret_cast<char *>(this);
    RECT *rect = reinterpret_cast<RECT *>(self + 0x371c);
    int fillColor = *reinterpret_cast<int *>(self + 0x372c);
    reinterpret_cast<GraphicWin *>(self)->fill(rect, fillColor);
    int count = *reinterpret_cast<int *>(self + 0x3738);
    if (count > 0) {
        Buffer *buf = reinterpret_cast<Buffer *>(self + 0x444);
        int i = 0;
        do {
            int v3730 = *reinterpret_cast<int *>(self + 0x3730);
            int v3734 = *reinterpret_cast<int *>(self + 0x3734);
            buf->box(rect, v3730, v3734);
            rect->left++;
            rect->right--;
            rect->top++;
            rect->bottom--;
