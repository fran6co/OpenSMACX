...
// calls     0x005EEDC0
// indirect  0x005EEE2D 0x005EEE39 0x005EEE49 0x005EEE54

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?key_up_event@Win@@QAEHH@Z  at 0x005EEDC0  (167 bytes)
//
...
int Win::key_up_event(int a1) {
    ...
    *g_009b7ab8 = reinterpret_cast<int>(this);
    ...
    result += reinterpret_cast<VCall2 *>(this)->slot027(a1);
    Win *child = *reinterpret_cast<Win **>(self + 0x40);
    if (child != 0) {
        if (reinterpret_cast<VCall2 *>(child)->slot023() == 0) {
