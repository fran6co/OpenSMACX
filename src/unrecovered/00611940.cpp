...
static int *const g_0066303d = (int *)0x0066303D;
...
static int *const g_00670a3c = (int *)0x00670A3C;
static int *const g_0067fd18 = (int *)0x0067FD18;
...
EditGroup::EditGroup(int a1) {
    ...
    if (a1 != 0) {
        *reinterpret_cast<int *>(self) = reinterpret_cast<int>(g_00670a3c);
        new (self + 0x8c) GraphicWin();
        try {
            new (self + 0xaa4) Dialog();
        } catch (...) {
            reinterpret_cast<GraphicWin *>(self + 0x8c)->GraphicWin::~GraphicWin();
            throw;
        }
    }

    int off;
    off = *reinterpret_cast<int *>(*reinterpret_cast<char **>(self) + 4);
    *reinterpret_cast<int *>(self + off) = reinterpret_cast<int>(g_006708d4);

    off = *reinterpret_cast<int *>(*reinterpret_cast<char **>(self) + 4);
    *reinterpret_cast<int *>(self + off + 0x444) = reinterpret_cast<int>(g_006708cc);

    off = *reinterpret_cast<int *>(*reinterpret_cast<char **>(self) + 8);
    *reinterpret_cast<int *>(self + off) = reinterpret_cast<int>(g_006708c0);

    off = *reinterpret_cast<int *>(*reinterpret_cast<char **>(self) + 4);
    *reinterpret_cast<int *>(self + off - 4) = off - 0x8c;

    off = *reinterpret_cast<int *>(*reinterpret_cast<char **>(self) + 8);
    *reinterpret_cast<int *>(self + off - 4) = off - 0xaa4;

    for (int i = 0; i < 10; i++) {
        *reinterpret_cast<int *>(self + 4 + 4 * i) = 0;
        *reinterpret_cast<int *>(self + 0x2c + 4 * i) = 0;
        *reinterpret_cast<int *>(self + 0x54 + 4 * i) = 10;
    }
