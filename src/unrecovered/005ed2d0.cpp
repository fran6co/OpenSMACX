// ORIGINAL: 0x005ED2D0 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?screen_to_client@Win@@QAEXPAHPAH@Z
// size      133 bytes
// spans     0x005ED2D0-0x005ED355
...
// subject: ?screen_to_client@Win@@QAEXPAHPAH@Z  at 0x005ED2D0  (133 bytes)
//
...
void Win::screen_to_client(int * a1, int * a2) {
    *a1 -= client_rect_.left + outer_rect_.left;
    *a2 -= client_rect_.top + outer_rect_.top;
    if ((iFlags_ & 0x20) && win_parent_) {
        win_parent_->screen_to_client(a1, a2);
        if (iFlags_ & 0x8000) {
