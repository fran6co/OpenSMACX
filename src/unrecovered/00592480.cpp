...
// TRIED: idx*0x2c direct multiply (compiler drops the lea/lea *11 decomposition); byte 0x66efbc/0x66f440 offset tables need a distinct extern (not caught by the fixed-global scanner since they're addressed as [reg+imm] with no separate mov).
