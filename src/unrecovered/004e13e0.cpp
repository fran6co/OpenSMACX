...
// calls     0x0046B190 0x005ABF20 0x005BF3F0 0x005C3440

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?editor_fungus@Console@@QAEXXZ  at 0x004E13E0  (187 bytes)
//
...
static int *const g_0068915c = (int *)0x0068915C;
static int *const g_00689168 = (int *)0x00689168;
...
void Console::editor_fungus() {
    auto_undo();
    int r1 = X_pop((const char *)g_0068915c, 0x40, 0);
    if (r1 >= 0) {
        bool doFungus = true;
        if (r1 > 0) {
            int r2 = X_pop((const char *)g_00689168, 0x40, 0);
            if (r2 < 0) {
                return;
            }
            doFungus = (r2 != 0);
        ...
        if (doFungus) {
            ...
            if (count > 0) {
                char *entry = (char *)*g_0094a30c;
                int i = 0;
                do {
                    *reinterpret_cast<unsigned int *>(entry + 8) &= 0xFFFFFFDFu;
                    field_23BD4_ = 1;
                    do {
                        *reinterpret_cast<unsigned int *>(entry + 0xC + field_23BD4_ * 4) =
                            *reinterpret_cast<unsigned int *>(entry + 8);
                        field_23BD4_ = field_23BD4_ + 1;
                    } while (field_23BD4_ < 8);
                    i++;
                    entry += 0x2C;
                } while (i < count);
            }
        }
        int saved = *g_0094a2b8;
        if (r1 > 0) {
            *g_0094a2b8 = r1 - 1;
            world_fungus();
        }
