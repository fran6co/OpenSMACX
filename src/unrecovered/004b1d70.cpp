...
// calls     0x004B0410 0x004B1080 0x005FCBB0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_button_passover@SocialWin@@QAEXHH@Z  at 0x004B1D70  (131 bytes)
//
...
void SocialWin::on_button_passover(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    if (a1 >= 0 && a1 < 0x10 && a2 != 0 &&
        *reinterpret_cast<int *>(self + 0xa2c) != a1) {
        *reinterpret_cast<int *>(self + 0xa2c) = a1;
        draw_mouseover();
    }
    if (a1 > 0x10 && a1 < 0x1c) {
        if (a2 == 0) {
            if (*reinterpret_cast<int *>(self + 0xa30) != -1) {
                *reinterpret_cast<int *>(self + 0xa30) = -1;
                draw_overview();
                do_all_draws();
                return;
            }
        } else if (*reinterpret_cast<int *>(self + 0xa30) != a1) {
            *reinterpret_cast<int *>(self + 0xa30) = a1;
            draw_overview();
        }
    }
    do_all_draws();
