...
// TRIED: straightforward if/else on the bit-test, reusing the already declared NetMsg::pop / MainInterface::draw_edit_pane / this member set_view(1). MISMATCH #0 'push' vs 'mov' remains open (register allocation for `this`/esi differs from the start).
...
// calls     0x0045B550 0x0047A890 0x00511480

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?editor_lock2@Console@@QAEXXZ  at 0x004E1F70  (134 bytes)
//
...
static int *const g_00689198 = (int *)0x00689198;
static int *const g_006891a4 = (int *)0x006891A4;
...
void Console::editor_lock2() {
    int flags = *g_009a64c0;
    if (flags & 0x8000000) {
        *g_009a64c0 = flags & 0xf7ffffff;
        reinterpret_cast<NetMsg *>(g_00805338)->pop(reinterpret_cast<const char *>(g_00689198), 5000, 0, 0);
        reinterpret_cast<MainInterface *>(g_007ae820)->draw_edit_pane();
        return;
    }
    *g_009a64c0 = flags | 0x8000000;
    reinterpret_cast<NetMsg *>(g_00805338)->pop(reinterpret_cast<const char *>(g_006891a4), 5000, 0, 0);
    if (*g_00939288 != 0) {
        set_view(1);
    }
    reinterpret_cast<MainInterface *>(g_007ae820)->draw_edit_pane();
