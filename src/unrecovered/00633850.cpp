...
// calls     0x005DFF00 0x005E4B9A

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_redraw@CheckButton@@QAEXXZ  at 0x00633850  (194 bytes)
//
...
void CheckButton::on_redraw() {
    char *self = reinterpret_cast<char *>(this);
    void *parent = *reinterpret_cast<void **>(self + 0xc4);
    if (parent != 0) {
        int left = *reinterpret_cast<int *>(self + 0x14c);
        int top = *reinterpret_cast<int *>(self + 0x150);
        int right = *reinterpret_cast<int *>(self + 0x154);
        int bottom = *reinterpret_cast<int *>(self + 0x158);
        (void)right;
        (void)bottom;
        char *src = (self != 0) ? (self + 0x444) : 0;
        int f4c8 = *reinterpret_cast<int *>(self + 0x4c8);
        int f4c4 = *reinterpret_cast<int *>(self + 0x4c4);
        int f478 = *reinterpret_cast<int *>(self + 0x478);
        int f474 = *reinterpret_cast<int *>(self + 0x474);
        Buffer *dst = reinterpret_cast<Buffer *>(reinterpret_cast<char *>(parent) + 0x444);
        dst->copy(reinterpret_cast<Buffer *>(src), left - f474, top - f478, 0, 0, f4c4, -f4c8);

        char *sprBuf;
        char *entryPtr;
        if (*reinterpret_cast<int *>(self + 0xa14) != 0) {
            sprBuf = (self != 0) ? (self + 0x444) : 0;
            entryPtr = *reinterpret_cast<char **>(self + 0xa28);
        } else {
            entryPtr = *reinterpret_cast<char **>(self + 0xa24);
            sprBuf = (self != 0) ? (self + 0x444) : 0;
        }
        unsigned char flag = *reinterpret_cast<unsigned char *>(entryPtr + 8);
        reinterpret_cast<Sprite *>(entryPtr)->draw(reinterpret_cast<Buffer *>(sprBuf), flag, 0, 0);
    }
}
