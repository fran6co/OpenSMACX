...
// calls     0x005F1820 0x005F6F10 0x005F7580
// indirect  0x005F2306 0x005F2328

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?OnMouseMove@Win@@QAAXPAXHHI@Z  at 0x005F2290  (157 bytes)
//
...
// This body dispatches through slot(s): 16, 18
class VCall { public:
...
class Win { public:
    ...
    void __cdecl OnMouseMove(void *, int, int, unsigned int);
};
// Second vtable shim: slot16 (offset 0x40) and slot18 (offset 0x48) need
// arguments, unlike the scaffold's nullary VCall.
class VCall2 { public:
    virtual void slot000();
    virtual void slot001();
    virtual void slot002();
    ...
    virtual void slot014();
    virtual void slot015();
    virtual void slot016(int, int, unsigned int, int);
    virtual void slot017();
    ...
    *g_009b7b3c = 0;
    ...
    if (hit != 0) {
        if (*g_009b7a7c != 0 &&
            ...
            reinterpret_cast<VCall2 *>(*g_009b7a7c)->slot018(a2, a3);
        }
        *g_009b7a7c = (int)hit;
        reinterpret_cast<VCall2 *>(hit)->slot016(a2, a3, a4, *g_009b7aa4);
    }
}
