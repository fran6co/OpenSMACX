...
// subject: ?OnQueryNewPalette@Win@@QAAHPAX@Z  at 0x005F1070  (209 bytes)
//
...
class Win { public:
    ...
    int __cdecl OnQueryNewPalette(void *);
};
    ...
    if (eax != 0) {
        ...
        *g_009b3ab0 = eax;
        ...
        if (eax != 0) {
            ...
            eax = reinterpret_cast<int>((*reinterpret_cast<GetDCFn *>(g_0066927c))(*g_009b7b28));
            *g_009b7b2c = eax;
        }
        if (eax == 0) {
            return 0;
