// ORIGINAL: 0x00477540 FILE
// name      ?mon_air_unit_built@@YAXH@Z
// size      254 bytes
// spans     0x00477540-0x0047763E
// prototype 
...
// subject: ?mon_air_unit_built@@YAXH@Z  at 0x00477540  (254 bytes)
//
...
static int *const g_0094cc10 = (int *)0x0094CC10;
static int *const g_0094cc14 = (int *)0x0094CC14;
static int *const g_0094f3b0 = (int *)0x0094F3B0;
static int *const g_0094f3b4 = (int *)0x0094F3B4;
...
struct MonRecord {
    ...
    int active;
    int count;
    unsigned char pad_18[0x2A0 - 0x18];
    int state;
    unsigned char pad_end[0x4F4 - 0x2A0 - 4];
};

void __cdecl mon_air_unit_built(int a1) {
    int year = game_year(*g_009a64d4);
    unsigned char flag = *(reinterpret_cast<unsigned char *>(g_00946f58) + a1 * 0x59c);
    if ((flag & 0x80) == 0) {
        MonRecord *table = reinterpret_cast<MonRecord *>(0x0094CC00);
