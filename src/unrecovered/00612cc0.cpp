// ORIGINAL: 0x00612CC0 FILE
// working copy - scaffold materialised by --work
// name      ?on_key_down@Dialogs@@QAEHH@Z
// size      105 bytes
// spans     0x00612CC0-0x00612D29
// prototype int (__thiscall ?on_key_down@Dialogs@@QAEHH@Z)(Dialogs* this, int)
// callers   0   call targets   4
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x0060AF90 0x0060E020 0x0060F8B0 0x00611400

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_key_down@Dialogs@@QAEHH@Z  at 0x00612CC0  (105 bytes)
//
...
static int *const g_00612d2c = (int *)0x00612D2C;
...
int Dialogs::on_key_down(int a1) {
    char *self = reinterpret_cast<char *>(this);
    int kind = *reinterpret_cast<int *>(self - 8);
    switch (kind) {
    case 16:
        return reinterpret_cast<RadioButton *>(self - 0x12C)->on_key_down(a1);
    case 2:
        reinterpret_cast<ListBox *>(self - 0x140)->on_key_down(a1);
        break;
    case 1:
        return reinterpret_cast<CheckBox *>(self - 0x114)->on_key_down(a1);
    case 8:
        return reinterpret_cast<SpriteBox *>(self - 0x8C)->on_key_down(a1);
    default:
        return 0;
    }
}
