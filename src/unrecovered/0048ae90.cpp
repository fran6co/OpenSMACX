// ORIGINAL: 0x0048AE90 ?add_line@PlanWin@@QAEXHHH@Z 0x0048AE90-0x0048AF14 FILE BYTE_EXACT
// size      132 bytes
...
void PlanWin::add_line(int a1, int a2, int a3) {
    char *self = reinterpret_cast<char *>(this);
    int line1_y = *reinterpret_cast<short *>(0x97d042 + a2 * 0x134);
    int line1_x = *reinterpret_cast<short *>(0x97d040 + a2 * 0x134);
    int line0_y = *reinterpret_cast<short *>(0x97d042 + a1 * 0x134);
    if (*reinterpret_cast<int *>(self + 0x21ff8) < 4) {
        int *line = reinterpret_cast<int *>(
            self + 0x2200c + *reinterpret_cast<int *>(self + 0x21ff8) * 0x10);
        int line0_x = *reinterpret_cast<short *>(0x97d040 + a1 * 0x134);
        line[0] = line0_x;
        line[1] = line0_y;
        line[2] = line1_x;
        line[3] = line1_y;
        *reinterpret_cast<int *>(self + 0x21ffc +
            *reinterpret_cast<int *>(self + 0x21ff8) * 4) = a3;
