...
// subject: ??0RadioButton@@QAE@H@Z  at 0x0060D0E0  (230 bytes)
//
...
static int *const g_00662f3a = (int *)0x00662F3A;
...
static int *const g_00670590 = (int *)0x00670590;
static int *const g_0067fc08 = (int *)0x0067FC08;
static int *const g_006970f0 = (int *)0x006970F0;
static int *const g_006970f4 = (int *)0x006970F4;

class RadioButton { public:
    RadioButton(int);
};
// Same shape as PlanWin::PlanWin (0x0048BCD0): SEH frame protecting a
// conditionally-constructed embedded GraphicWin at +0x18, needs
// GraphicWin's destructor which the scaffold does not declare - not
// modeled, see RULED-OUT. Placement `new` reproduces the plain
// GraphicWin()/Dialog() constructor calls at their fixed offsets.
...
RadioButton::RadioButton(int a1) {
    ...
    if (a1 != 0) {
        *reinterpret_cast<void **>(esi) = g_00670590;
        new (esi + 0x18) GraphicWin();
    }

    new (esi + 0xa30) Dialog();

    int *vtbl = *reinterpret_cast<int **>(esi);
    int off1 = *reinterpret_cast<int *>(reinterpret_cast<char *>(vtbl) + 4);
    *reinterpret_cast<void **>(esi + off1) = g_00669a6c;

    int *vtbl2 = *reinterpret_cast<int **>(esi);
    int off1b = *reinterpret_cast<int *>(reinterpret_cast<char *>(vtbl2) + 4);
    *reinterpret_cast<void **>(esi + off1b + 0x444) = g_00669a64;

    int *vtbl3 = *reinterpret_cast<int **>(esi);
    int off2 = *reinterpret_cast<int *>(reinterpret_cast<char *>(vtbl3) + 8);
    *reinterpret_cast<void **>(esi + off2) = g_00669a58;

    int *vtbl4 = *reinterpret_cast<int **>(esi);
    int off1c = *reinterpret_cast<int *>(reinterpret_cast<char *>(vtbl4) + 4);
    *reinterpret_cast<int *>(esi + off1c - 4) = off1c - 0x18;

    int *vtbl5 = *reinterpret_cast<int **>(esi);
    int off2b = *reinterpret_cast<int *>(reinterpret_cast<char *>(vtbl5) + 8);
    *reinterpret_cast<int *>(esi + off2b - 4) = off2b - 0xa30;

    *reinterpret_cast<int *>(esi + 0xc) = 0;
    *reinterpret_cast<int *>(esi + 0x10) = 0;
    *reinterpret_cast<int *>(esi + 8) = *g_006970f4;
    *reinterpret_cast<int *>(esi + 4) = *g_006970f0;
}
