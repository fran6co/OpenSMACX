...
// calls     0x00530630 0x00592EE0 0x006262F0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?lock_base@NetDaemon@@QAEHHHHH@Z  at 0x00530D50  (248 bytes)
//
...
static int *const g_0068c2f4 = (int *)0x0068C2F4;
static int *const g_0068c300 = (int *)0x0068C300;
...
extern char g_Bases[][0x134];  // 0x0097D040, Base records (x@0, y@2, state@0x30)

int NetDaemon::lock_base(int a1, int a2, int a3, int a4) {
    char *self = reinterpret_cast<char *>(this);

    log_say(reinterpret_cast<char *>(g_0068c2f4), *g_0093a934, *g_0093a938, *g_00689370);
    if (*g_0093f660 == 0) {
        return 0;
    }
    if (*g_0093a934 != 0) {
        *reinterpret_cast<int *>(g_Bases[a1] + 0x30) |= 0x10000000;
        message_data(0x4304, 0, 0, 0, 0, 0);
        return 0;
    }
    if (*g_0093a938 != 0) {
        return 1;
    }
    if (*reinterpret_cast<int *>(self + 0x1b38) != 0) {
        return 1;
    }

    char *baseRec = g_Bases[a1];
    log_say(reinterpret_cast<char *>(g_0068c300), a1,
            *reinterpret_cast<short *>(baseRec + 0),
            *reinterpret_cast<short *>(baseRec + 2));
    return lock(a2 | 4, *reinterpret_cast<short *>(baseRec + 0),
                *reinterpret_cast<short *>(baseRec + 2), 0, a3, a4);
}
