...
// calls     0x005DAC70 0x00607210
// indirect  0x006071FD

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?UNK1@BaseButton@@QAEHPAUFont@@PADHHHHPAUWin@@H@Z  at 0x00607190  (122 bytes)
//
...
class BaseButton : public GraphicWin { public:
    ...
    int UNK1(Font *, char *, int, int, int, int, Win *, int);
};
int BaseButton::UNK1(Font * a1, char * a2, int a3, int a4, int a5, int a6, Win * a7, int a8) {
    if (a1 == 0) {
        return 3;
    }
    int divided = (a1->height_ * 7) / 4;
    int result = init(a2, a3, a4, a5, a6, divided, a7, a8);
    if (result != 0) {
        return result;
    }
    buffer_.set_font(a1, 0, 0, 0);
