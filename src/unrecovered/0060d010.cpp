...
// calls     0x005D4DD0 0x00608E10 0x00609F20 0x0064557F

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_60d010  at 0x0060D010  (144 bytes)
//
...
extern "C" int __cdecl call_0064557f(int);

extern "C" int __stdcall sub_60d010(int a1, int a2) {
    int p1 = a1 - *reinterpret_cast<int *>(a1 - 0x448);
    int iVar2 = p1 - 0x444;
    int *piVar1 = reinterpret_cast<int *>(p1 - 0x48c);

    *reinterpret_cast<int *>(*reinterpret_cast<int *>(*piVar1 + 4) - 0x48 + iVar2) =
        reinterpret_cast<int>(g_0067041c);
    *reinterpret_cast<int *>(*reinterpret_cast<int *>(*piVar1 + 4) + 0x3fc + iVar2) =
        reinterpret_cast<int>(g_00670414);
    *reinterpret_cast<int *>(*reinterpret_cast<int *>(*piVar1 + 8) - 0x48 + iVar2) =
        reinterpret_cast<int>(g_00670408);
    *reinterpret_cast<int *>(*reinterpret_cast<int *>(*piVar1 + 4) - 0x4c + iVar2) =
        *reinterpret_cast<int *>(*piVar1 + 4) - 0x48;
    *reinterpret_cast<int *>(*reinterpret_cast<int *>(*piVar1 + 8) - 0x4c + iVar2) =
        *reinterpret_cast<int *>(*piVar1 + 8) - 0xa60;

    reinterpret_cast<ListBox *>(piVar1)->close();
    reinterpret_cast<Dialog *>(reinterpret_cast<char *>(piVar1) + 0xa60)->~Dialog();
    reinterpret_cast<GraphicWin *>(reinterpret_cast<char *>(piVar1) + 0x48)->~GraphicWin();

    if (a2 & 1) {
        call_0064557f(reinterpret_cast<int>(piVar1));
    }
    return reinterpret_cast<int>(piVar1);
}
