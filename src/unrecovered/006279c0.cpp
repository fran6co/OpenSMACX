// ORIGINAL: 0x006279C0 FILE
// RULED-OUT: byte-exact - 96.1% mnemonic similarity, same shape as sibling
//            0x00627B60 (a2 here is the real itoa value, a1 passes straight
//            through to BasePop::start's const char* slot with no cast
//            needed). Same _itoa/_strcat nullary-alias trick to force real
//            calls instead of intrinsic expansion.
// working copy - scaffold materialised by --work
// name      ?pop_ask_number@@YAHPADHP6AHXZ@Z
// size      203 bytes
// spans     0x006279C0-0x00627A8B
// prototype int (__cdecl ?pop_ask_number@@YAHPADHP6AHXZ@Z)(int8* sectionID, int, int (__cdecl *)())
// callers   0   call targets   9
// kind      game
// flags     sp_ready;purged_ok
// calls     0x005F7E90 0x005FCBB0 0x00600F00 0x00601BB0 0x00601BF0 0x00602600 0x00645470 0x00645DA7 0x0064FC88

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?pop_ask_number@@YAHPADHP6AHXZ@Z  at 0x006279C0  (203 bytes)
//
...
int __cdecl pop_ask_number(char * a1, int a2, int (__cdecl *a3)()) {
    char buf[80];
    int visible = reinterpret_cast<Win *>(*g_009bc074)->is_visible();
    BasePop *win = reinterpret_cast<BasePop *>(visible != 0 ? *g_009bc078 : *g_009bc074);
    *reinterpret_cast<char *>(g_009b86a0) = 0;
    reinterpret_cast<ItoaFn>(_itoa)(a2, buf, 10);
    reinterpret_cast<StrcatFn>(_strcat)(reinterpret_cast<char *>(g_009b86a0), buf);
    int started = win->start(reinterpret_cast<char *>(g_009b8aa8), a1, 9,
                              reinterpret_cast<char *>(g_009b86a0), 0x44, 0);
    if (started != 0) {
        return -1;
    }
    win->write_check(*g_009bc06c);
    int ret = win->exec(0, a3);
    if (win->field_A14_ == 0) {
        do_all_draws();
    }
    *g_009bc070 = win->field_3100_;
    *g_009bb598 = reinterpret_cast<AtoiFn>(atoi)(reinterpret_cast<const char *>(g_009bb5e8));
    win->close();
    return ret;
}
