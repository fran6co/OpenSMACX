...
// calls     0x00401100 0x005DC360

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?item@ListBox@@QAEHPADH@Z  at 0x0060C920  (137 bytes)
//
...
int ListBox::item(char * a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    if (a1 == 0) {
        return 3;
    }

    int *base = *reinterpret_cast<int **>(self);
    int off8 = *reinterpret_cast<int *>(reinterpret_cast<char *>(base) + 8);
    int count = *reinterpret_cast<int *>(self + off8 + 0x2c) - *g_009b8dd4;

    if (count > 0) {
        int off4 = *reinterpret_cast<int *>(reinterpret_cast<char *>(base) + 4);
        Buffer *buf = reinterpret_cast<Buffer *>(self + off4 + 0x444);
        buf->wrap_height(a1, count);
    }

    int height;
    if (count > 0) {
        int *base2 = *reinterpret_cast<int **>(self);
        int off4b = *reinterpret_cast<int *>(reinterpret_cast<char *>(base2) + 4);
        height = *reinterpret_cast<int *>(self + off4b + 0x45c);
    } else {
        height = 1;
    }

    *reinterpret_cast<int *>(self + 0x20) += height;

    int *base3 = *reinterpret_cast<int **>(self);
    int off8c = *reinterpret_cast<int *>(reinterpret_cast<char *>(base3) + 8);
    *reinterpret_cast<char **>(self + off8c + 0xd8) = a1;

    StringStruct *ss = reinterpret_cast<StringStruct *>(self + off8c + 0xbc);
    *reinterpret_cast<int *>(reinterpret_cast<char *>(ss) + 0x20) = 0;
    *reinterpret_cast<int *>(reinterpret_cast<char *>(ss) + 0x24) = height;
