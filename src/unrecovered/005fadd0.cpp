// ORIGINAL: 0x005FADD0 FILE
// RULED-OUT: GraphicWin::init declared void per mangled name (QAEX), yet caller
//            tests eax post-call; treated eax as the surviving "scale" local
//            (register-allocated across the call) rather than a fabricated
//            int-returning redeclaration of init. Body compiles, MISMATCH
//            (#0 push/mov, 177 vs 153 bytes) - extra prologue/epilogue shape
//            from locals, not yet chased further.
// working copy - scaffold materialised by --work
// name      ?init@Menu@@QAEHPAUWin@@@Z
// size      153 bytes
// spans     0x005FADD0-0x005FAE69
// prototype int (__thiscall ?init@Menu@@QAEHPAUWin@@@Z)(Menu* this, Win*)
// callers   0   call targets   1
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x005D4EF0
// indirect  0x005FAE53 0x005FAE5F

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?init@Menu@@QAEHPAUWin@@@Z  at 0x005FADD0  (153 bytes)
//
...
// This body dispatches through slot(s): 1, 93
class VCall { public:
...
static int *const g_009b7b94 = (int *)0x009B7B94;
...
int Menu::init(Win * a1) {
    ...
    *reinterpret_cast<int *>(self + 0xA28) = 0;
    if (*g_009b7b94 == 0) {
        *g_009b7b94 = *g_009bb484;
        if (*g_009bb484 == 0) {
            return 7;
        }
    }
    char *win = reinterpret_cast<char *>(a1);
    int field13c = *reinterpret_cast<int *>(win + 0x13c);
    int field140 = *reinterpret_cast<int *>(win + 0x140);
    int field144 = *reinterpret_cast<int *>(win + 0x144);
    int scale = *reinterpret_cast<int *>(*g_009b7b94 + 0x10) * 2;
    this->GraphicWin::init(field13c, field140 - scale, field144 - field13c, scale,
         (char *)0, 0x8020, a1, (Menu *)0, (BorderSizing *)0);
    if (scale != 0) {
        return scale;
    }
    *reinterpret_cast<int *>(self + 0x964) = 0;
    reinterpret_cast<VCall *>(this)->slot093();
    ((VCallArg1 *)this)->slot001(0);
    return 0;
}
