...
// TRIED: two separate null-check ifs (worse fit); localRect copy before set_clip (worse fit); closest is buf cached once, single || null check, localRect copied after set_clip - 5-edit MISMATCH
...
// calls     0x005D5350 0x005D8000 0x005DACB0 0x005E2DD3

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_iface_dialog_item_back_draw@DiploWin@@QAEHPAUGraphicWin@@HHPAURECT@@@Z  at 0x00443E50  (188 bytes)
//
...
int DiploWin::on_iface_dialog_item_back_draw(GraphicWin * a1, int a2, int a3, RECT * a4) {
    if (a1 == 0 || a4 == 0) {
        return 0;
    }
    ...
    RECT localRect = *a4;
    int colorA = *reinterpret_cast<int *>(reinterpret_cast<char *>(g_008c6c9c) - a3 * 8);
    int colorB = *reinterpret_cast<int *>(reinterpret_cast<char *>(g_008c6ca0) - a3 * 8);
    ...
    buf->box_sprite(&localRect,
        reinterpret_cast<BoxSpriteParams *>(reinterpret_cast<char *>(g_0078d960) + a3 * 0x28));
    return 1;
}
