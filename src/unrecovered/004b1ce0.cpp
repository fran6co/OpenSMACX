// ORIGINAL: 0x004B1CE0 FILE
// working copy - scaffold materialised by --work
// name      ?on_group_clicked@SocialWin@@QAEXHH@Z
// size      132 bytes
// spans     0x004B1CE0-0x004B1D64
// prototype void (__thiscall ?on_group_clicked@SocialWin@@QAEXHH@Z)(SocialWin* this, int, int)
// callers   0   call targets   3
// kind      game
// flags     frame;sp_ready;purged_ok
// calls     0x004AEBF0 0x004AF110 0x0062B870
// indirect  0x004B1D59

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_group_clicked@SocialWin@@QAEXHH@Z  at 0x004B1CE0  (132 bytes)
//
...
void SocialWin::on_group_clicked(int a1, int a2) {
    if (a2 >= 0x11 && a2 < 0x1b) {
        int idx = a2 - 0x11;
        if (idx >= 3) {
            idx++;
    ...
    if (a2 >= 0 && a2 < 0x10) {
        int rem = a2 & 0x80000003;
        if (rem < 0) {
            rem = (rem - 1 | 0xfffffffc) + 1;
        }
        int idx = (a2 + (((int32_t)a2 >> 31) & 3)) >> 2;
        UNK1(idx, rem);
        if (effectMaximize_ == (uint32_t)-1 && field_2C28_ == 0) {
