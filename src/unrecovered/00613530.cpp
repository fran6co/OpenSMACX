// ORIGINAL: 0x00613530 FILE
// working copy - scaffold materialised by --work
// name      ?init@Dialogs@@QAEHHHHHPAUHeap@@@Z
// size      210 bytes
// spans     0x00613530-0x00613602
// prototype int (__thiscall ?init@Dialogs@@QAEHHHHHPAUHeap@@@Z)(Dialogs* this, int, int, int, int, Heap*)
// callers   0   call targets   6
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x00609730 0x00609F20 0x0060D1B0 0x0060E7C0 0x006104D0 0x00611A90

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?init@Dialogs@@QAEHHHHHPAUHeap@@@Z  at 0x00613530  (210 bytes)
//
...
int Dialogs::init(int a1, int a2, int a3, int a4, Heap * a5) {
    reinterpret_cast<RadioButton *>(reinterpret_cast<char *>(this) + 0x44)->close();
    int result = dialog_.init(a1, a2, a3, a4, a5);
    if (result != 0) {
        return result;
    }
    reinterpret_cast<ListBox *>(this)->close();
    result = dialog_.init(a1, a2, a3, a4, a5);
    if (result != 0) {
        return result;
    }
    reinterpret_cast<CheckBox *>(reinterpret_cast<char *>(this) + 0x58)->close();
    result = dialog_.init(a1, a2, a3, a4, a5);
    if (result != 0) {
        return result;
    }
    ...
    reinterpret_cast<EditGroup *>(reinterpret_cast<char *>(this) + 0xf8)->close();
    return dialog_.init(a1, a2, a3, a4, a5);
}
