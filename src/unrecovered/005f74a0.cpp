...
// calls     0x005ED240 0x005F7320

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?update_window@Win@@QAEHPAURECT@@@Z  at 0x005F74A0  (223 bytes)
//
...
extern "C" int __cdecl update_screen_free(RECT *, Win *);

int Win::update_window(RECT * a1) {
    char *self = reinterpret_cast<char *>(this);
    if (a1 == 0) {
        return update_screen_free(0, this);
    }
    ...
    return update_screen_free(&r, this);
}
