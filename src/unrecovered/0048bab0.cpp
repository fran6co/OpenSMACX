// ORIGINAL: 0x0048BAB0 FILE
// RULED-OUT: extern short table array for the runtime-indexed 0x97d040
//            lookup (lever: address does index arithmetic); vbase-adjustor
//            read from vtbl+4 for the Buffer receiver. MISMATCH from #14:
//            the a1*0x9a index multiply lowers via a different lea/shl
//            chain than the original's
// working copy - scaffold materialised by --work
// name      ?draw_line_base@PlanWin@@QAEXHHH@Z
// size      194 bytes
// spans     0x0048BAB0-0x0048BB72
// prototype void (__thiscall ?draw_line_base@PlanWin@@QAEXHHH@Z)(PlanWin* this, int, int, int)
// callers   0   call targets   2
// kind      game
// flags     frame;sp_ready;purged_ok
// calls     0x00462F00 0x005E09D0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?draw_line_base@PlanWin@@QAEXHHH@Z  at 0x0048BAB0  (194 bytes)
//
...
class PlanWin { public:
    void draw_line_base(int, int, int);
};
extern short g_97d040_arr[];

void PlanWin::draw_line_base(int a1, int a2, int a3) {
    char *self = reinterpret_cast<char *>(this);

    short *e1 = g_97d040_arr + a1 * 0x9a;
    int pixelY1;
    reinterpret_cast<MapWin *>(this)->tile_to_pixel(e1[0], e1[1], &a1, &pixelY1);

    short *e2 = g_97d040_arr + a2 * 0x9a;
    int pixelX2, pixelY2;
    reinterpret_cast<MapWin *>(this)->tile_to_pixel(e2[0], e2[1], &pixelX2, &pixelY2);

    int offsetX = *reinterpret_cast<int *>(self + 0x1ddbc);
    int offsetY = *reinterpret_cast<int *>(self + 0x1ddc0);
    int pixelX1 = a1 + offsetX;
    pixelX2 += offsetX;
    pixelY1 += offsetY;
    pixelY2 += offsetY;
    ...
    Buffer *buf = reinterpret_cast<Buffer *>(self + 0x444 + vbaseOff);
    buf->line(pixelX1, pixelY1, pixelX2, pixelY2, 0, a3, 4, 4, *g_00939fd4);
