...
// subject: ?set_rects@GraphicWin@@QAEXXZ  at 0x005D63E0  (5 bytes)
//
...
// Tail call to Win::set_rects() on the same `this`; a fresh minimal class
// (rather than editing the scaffold's Win, which has fields but no
// methods here) is enough to get the thiscall forwarding call compiled.
class Win5D63E0 { public:
    void set_rects();
};

void GraphicWin::set_rects() {
    reinterpret_cast<Win5D63E0 *>(this)->set_rects();
}
