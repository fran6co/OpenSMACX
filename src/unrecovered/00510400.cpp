// ORIGINAL: 0x00510400 FILE
// working copy - scaffold materialised by --work
// name      ?cursor_on@Console@@QAEXH@Z
// size      144 bytes
// spans     0x00510400-0x00510490
// prototype void (__thiscall ?cursor_on@Console@@QAEXH@Z)(Console* this, int)
// callers   0   call targets   2
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x005EC740 0x005FCA30

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?cursor_on@Console@@QAEXH@Z  at 0x00510400  (144 bytes)
//
...
void Console::cursor_on(int a1) {
    int *iter = g_007d3c3c;
    do {
        int val = *iter;
        if (val != 0) {
            int ok = (iter == g_007d3c3c) || (*(int *)((char *)val + 0x1dd74) != 0);
            if (ok) {
                char *sprite_ptr = (char *)g_0093aa70 + a1 * 0x2c;
                int cur = *(int *)((char *)val + 0x1ef4c);
                if (cur != (int)sprite_ptr) {
                    int p1 = g_0093aa40[a1];
                    int p2 = g_0093aa10[a1];
                    int *layout = *(int **)val;
                    int adj = *(int *)((char *)layout + 4);
                    Win *target = (Win *)((char *)val + adj);
                    target->set_cursor((Sprite *)sprite_ptr, p2, p1);
                    *(int *)((char *)val + 0x1ef4c) = (int)sprite_ptr;
                }
            }
        }
        iter++;
    } while (iter < g_007d3c5c);
    do_non_input();
}
