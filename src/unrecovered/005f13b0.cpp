// ORIGINAL: 0x005F13B0 FILE
// RULED-OUT: zero-arg contract (disasm reads one stack arg -> HWND); reusing
//            the auto-generated nullary `VCall::slot074` (own `PaintVCall`
//            class instead, real signature). Register allocation in the
//            prologue still MISMATCHes.
// working copy - scaffold materialised by --work
// name      sub_5f13b0
// size      107 bytes
// spans     0x005F13B0-0x005F141B
// prototype 
// callers   0   call targets   0
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     (none)
// indirect  0x005F13BC 0x005F13CE 0x005F1403 0x005F140F

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: sub_5f13b0  at 0x005F13B0  (107 bytes)
//
...
// This body dispatches through slot(s): 74
class VCall { public:
...
typedef void *(__stdcall *BeginPaintFn)(void *, void *);
typedef int (__stdcall *EndPaintFn)(void *, const void *);

struct PaintRect { int left, top, right, bottom; };
struct PaintStructShape {
    void *hdc;
    int fErase;
    PaintRect rcPaint;
    int fRestore;
...
class PaintVCall { public:
    ...
    virtual void slot074(PaintRect *rect, int flag);  // <-- used, real signature
};

extern "C" int __cdecl sub_5f13b0(int hwnd) {
    void *win = reinterpret_cast<void *>(hwnd);
    GetWindowLongFn get_window_long = (GetWindowLongFn)*g_0066934c;
    BeginPaintFn begin_paint = (BeginPaintFn)*g_006692b8;
    EndPaintFn end_paint = (EndPaintFn)*g_006692b4;

    PaintVCall *obj = (PaintVCall *)get_window_long(win, -0x15);
    if (obj == 0) {
        return 0;
    }
    PaintStructShape ps;
    void *hdc = begin_paint(win, &ps);
    if (hdc == 0) {
        return 0;
    }
    PaintRect rect_copy = ps.rcPaint;
    obj->slot074(&rect_copy, -1);
    end_paint(win, &ps);
    return 0;
}
