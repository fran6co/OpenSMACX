...
// subject: ?write_right_l@Buffer@@QAEHPAVFont@@PADHHH@Z  at 0x005DB8D0  (89 bytes)
//
...
class Buffer { public:
    ...
    int write_right_l(Font *, char *, int, int, int);
};
int Buffer::write_right_l(Font * a1, char * a2, int a3, int a4, int a5) {
    Font *savedFont1 = font1_;
    Font *savedFont2 = font2_;
    Font *savedFont3 = font3_;
    if (a1 != 0 && a1->font_obj_ != 0) {
        font1_ = a1;
        font2_ = 0;
        font3_ = 0;
    }
    int result = write_right_l(a2, a3, a4, a5);
    font1_ = savedFont1;
    font2_ = savedFont2;
    font3_ = savedFont3;
    return result;
