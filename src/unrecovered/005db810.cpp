...
// subject: ?write_cent_l@Buffer@@QAEHPAVFont@@PADHHH@Z  at 0x005DB810  (89 bytes)
//
...
class Buffer { public:
    ...
    int write_cent_l(Font *, char *, int, int, int);
};
int Buffer::write_cent_l(Font * a1, char * a2, int a3, int a4, int a5) {
    ...
    int result = write_cent_l(a2, a3, a4, a5);
    font1_ = savedFont1;
    font2_ = savedFont2;
    font3_ = savedFont3;
    return result;
