...
// subject: ?draw_line@PlanWin@@QAEXHHHHH@Z  at 0x0048BB80  (148 bytes)
//
...
void PlanWin::draw_line(int a1, int a2, int a3, int a4, int a5) {
    MapWin *map = reinterpret_cast<MapWin *>(this);
    int outB, outA;
    map->tile_to_pixel(a1, a2, &a2, &a1);
    map->tile_to_pixel(a3, a4, &outB, &outA);
    char *self = reinterpret_cast<char *>(this);
    int *vt = *reinterpret_cast<int **>(self);
    Buffer *buf = reinterpret_cast<Buffer *>(self + vt[1] + 0x444);
    buf->line(a2 + map->field_1DDBC_, a1 + map->field_1DDC0_,
              outB + map->field_1DDBC_, outA + map->field_1DDC0_,
              0, a5, 4, 4, *g_00939fd4);
}
