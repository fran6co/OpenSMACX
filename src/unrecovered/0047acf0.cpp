...
// subject: ??0NetMsg@@QAE@HHH@Z  at 0x0047ACF0  (144 bytes)
//
...
static int *const g_00656448 = (int *)0x00656448;
static int *const g_0066cb58 = (int *)0x0066CB58;
static int *const g_0066cb60 = (int *)0x0066CB60;
static int *const g_00676230 = (int *)0x00676230;
...
NetMsg::NetMsg(int a1, int a2, int a3) {
    ...
    new (self + 0x538c) Time();

    *reinterpret_cast<int *>(self + 0x5380) = a2;
    *reinterpret_cast<int *>(self + 0x537c) = a1;
    *reinterpret_cast<void **>(self + 0x0) = g_0066cb60;
    *reinterpret_cast<void **>(self + 0x444) = g_0066cb58;
    *reinterpret_cast<int *>(self + 0x5384) = 0;
    *reinterpret_cast<int *>(self + 0x5388) = a3;
}
