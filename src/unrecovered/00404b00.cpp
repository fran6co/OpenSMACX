// ORIGINAL: 0x00404B00 BYTE_EXACT FILE
...
// subject: ?on_redraw@Popup@@QAEXXZ  at 0x00404B00  (5 bytes)
//
...
class BasePopRedrawShim { public:
    void on_redraw();
};

void Popup::on_redraw() {
    reinterpret_cast<BasePopRedrawShim *>(this)->on_redraw();
}
