// ORIGINAL: 0x0060C5D0 FILE
// working copy - scaffold materialised by --work
// name      ?on_scrolling@ListBox@@QAEXHH@Z
// size      193 bytes
// spans     0x0060C5D0-0x0060C691
// prototype void (__thiscall ?on_scrolling@ListBox@@QAEXHH@Z)(ListBox* this, int, int)
// callers   2   call targets   3
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x005D5890 0x0060A020 0x0060B530
// indirect  0x0060C645

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_scrolling@ListBox@@QAEXHH@Z  at 0x0060C5D0  (193 bytes)
//
...
void ListBox::on_scrolling(int a1, int a2) {
    char *esi = reinterpret_cast<char *>(this);
    char *edi = esi - 0x48;
    int *vbt = *reinterpret_cast<int **>(edi);
    int off1 = *reinterpret_cast<int *>(reinterpret_cast<char *>(vbt) + 4);
    int val1 = *reinterpret_cast<int *>(esi + off1 + 0x7c);
    *g_009b7ab8 = val1;

    vbt = *reinterpret_cast<int **>(edi);
    int selPos = *reinterpret_cast<int *>(esi - 0x30);
    int off2 = *reinterpret_cast<int *>(reinterpret_cast<char *>(vbt) + 8);
    int val2 = *reinterpret_cast<int *>(esi + off2 + 0xa4);
    char *dlgBase = esi + off2;

    if (a1 == -2) {
        int stride = *reinterpret_cast<int *>(dlgBase + 0x10);
        *reinterpret_cast<int *>(esi - 0x30) = stride * a2;
    } else if (a1 == -1) {
        *reinterpret_cast<int *>(esi - 0x30) = a2;
    }

    if (*g_009b8ddc != 0) {
        int pos = *reinterpret_cast<int *>(esi - 0x30);
        reinterpret_cast<ListBox *>(edi)->set_selected_pos(pos, 1);
    }

    if (*reinterpret_cast<int *>(esi - 0x30) == selPos) {
        vbt = *reinterpret_cast<int **>(edi);
        int off1b = *reinterpret_cast<int *>(reinterpret_cast<char *>(vbt) + 4);
        char *sub = esi + off1b - 0x48;
        reinterpret_cast<VCall *>(sub)->slot062();
    } else {
        reinterpret_cast<ListBox *>(edi)->draw_item(val2);
        vbt = *reinterpret_cast<int **>(edi);
        int off2b = *reinterpret_cast<int *>(reinterpret_cast<char *>(vbt) + 8);
        int val2b = *reinterpret_cast<int *>(esi + off2b + 0xa4);
        reinterpret_cast<ListBox *>(edi)->draw_item(val2b);
        vbt = *reinterpret_cast<int **>(edi);
        int off1c = *reinterpret_cast<int *>(reinterpret_cast<char *>(vbt) + 4);
        reinterpret_cast<GraphicWin *>(esi + off1c - 0x48)->soft_update();
    }
}
