// ORIGINAL: 0x00426EE0 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?on_mouse_move@CouncWin@@QAEXHH@Z
// size      152 bytes
// spans     0x00426EE0-0x00426F78
// prototype void (__thiscall ?on_mouse_move@CouncWin@@QAEXHH@Z)(CouncWin* this, int xCoord, int yCoord)
// callers   0   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x00425DB0 0x005F7E90 0x005FAB00

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_mouse_move@CouncWin@@QAEXHH@Z  at 0x00426EE0  (152 bytes)
//
...
void CouncWin::on_mouse_move(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    Spot *spot = reinterpret_cast<Spot *>(self + 0xa48);
    int check_result = spot->check(a1, a2, &a2, 0);
    if (check_result == -1) {
        int leader = *reinterpret_cast<int *>(self + 0xa34);
        if (leader != -1) {
    ...
    Win *win = reinterpret_cast<Win *>(self + 0x4610);
    if (win->is_visible()) {
        return;
    }
    if (a2 == *g_00939284) {
    ...
    int cur = *reinterpret_cast<int *>(self + 0xa34);
    if (cur == a2) {
        return;
    }
    if (cur != -1) {
    ...
    *reinterpret_cast<int *>(self + 0xa34) = a2;
    draw_leader(a2);
