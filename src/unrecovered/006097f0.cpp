// ORIGINAL: 0x006097F0 FILE
// RULED-OUT: separate width/height locals vs `right -= left; bottom -= top;`
//            in place - both diverge at the same instruction (field_2c/30
//            store). This is the "this-adjusting thunk" shape (vtbl[1] holds
//            a byte offset, not a function pointer) modelled with a
//            single-virtual-slot Slot0Iface + raw pointer chasing.
// working copy - scaffold materialised by --work
// name      ?init@Dialog@@QAEHPAURECT@@PAUHeap@@@Z
// size      216 bytes
// spans     0x006097F0-0x006098C8
