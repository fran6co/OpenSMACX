...
// subject: ??0FlatButton@@QAE@XZ  at 0x00607CF0  (166 bytes)
//
...
// Moved ahead of Scroll: Scroll embeds FlatButton BY VALUE, so the
// definition has to be complete before Scroll's, not after it - the
// emitter's declaration order (alphabetical) does not account for that.
...
FlatButton::FlatButton() {
    char *self = (char *)this;
    *(int *)(self + 0x0) = 0x669754;
    *(int *)(self + 0x444) = 0x66974c;
    *(int *)(self + 0xa18) = 0;
    *(int *)(self + 0xa14) = 0;
    *(int *)(self + 0xab8) = -1;
    char *base = self + 0xae0;
    int off = 0;
    do {
        *(int *)(base - 0x24) = -1;
        *(int *)(base + 0x00) = *(int *)((char *)g_9b8e44 + off);
        *(int *)(base + 0x0c) = *(int *)((char *)g_9b8e50 + off);
        *(int *)(base + 0x18) = *(int *)((char *)g_9b8e5c + off);
        *(int *)(base + 0x24) = *(int *)((char *)g_9b8e68 + off);
        *(int *)(base + 0x30) = *(int *)((char *)g_9b8e74 + off);
        *(int *)(base + 0x3c) = *(int *)((char *)g_9b8e80 + off);
        *(int *)(base + 0x48) = *(int *)((char *)g_9b8e8c + off);
        *(int *)(base + 0x54) = *(int *)((char *)g_9b8e98 + off);
        *(int *)(base + 0x60) = *(int *)((char *)g_9b8ea4 + off);
        *(int *)(base - 0x0c) = 0;
        *(int *)(base - 0x18) = 0;
        off += 4;
        base += 4;
