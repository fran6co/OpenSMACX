...
// subject: ?survey@Console@@QAEXXZ  at 0x00515450  (219 bytes)
//
...
void Console::survey() {
    ...
    int state = *reinterpret_cast<int *>(self + 0x23C00);
    if (state == 1) {
        *reinterpret_cast<int *>(self + 0x23C00) = 2;
        MapWin *mw = reinterpret_cast<MapWin *>(*g_007d3c3c);
        int saved = *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70);
        *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70) = 0x603;
        reinterpret_cast<MapWin *>(*g_007d3c3c)->draw_map(1);
        mw = reinterpret_cast<MapWin *>(*g_007d3c3c);
        *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70) = saved;
        return;
    }
    if (state == 2) {
        *reinterpret_cast<int *>(self + 0x23C00) = 3;
        MapWin *mw = reinterpret_cast<MapWin *>(*g_007d3c3c);
        int saved = *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70);
        *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70) = 0x402;
        reinterpret_cast<MapWin *>(*g_007d3c3c)->draw_map(1);
        mw = reinterpret_cast<MapWin *>(*g_007d3c3c);
        *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70) = saved;
        return;
    ...
    *reinterpret_cast<int *>(self + 0x23C00) = 1;
    MapWin *mw = reinterpret_cast<MapWin *>(*g_007d3c3c);
    int saved = *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70);
    *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70) = 0x623;
    reinterpret_cast<MapWin *>(*g_007d3c3c)->draw_map(1);
    mw = reinterpret_cast<MapWin *>(*g_007d3c3c);
    *reinterpret_cast<int *>(reinterpret_cast<char *>(mw) + 0x1dd70) = saved;
}
