...
// calls     0x005ED7D0
// indirect  0x004032C7 0x00403322 0x0040332C

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?adjust@AlphaMenu@@QAEXXZ  at 0x004032A0  (149 bytes)
//
...
// This body dispatches through slot(s): 3, 62, 92
class VCall { public:
...
static int *const g_007af240 = (int *)0x007AF240;
static int *const g_007af248 = (int *)0x007AF248;
...
void AlphaMenu::adjust() {
    char *self = reinterpret_cast<char *>(this);
    int computed = *reinterpret_cast<int *>(self + 0x1134) * *reinterpret_cast<int *>(self + 0xa18)
                   + *reinterpret_cast<int *>(self + 0x1108);
    int field_1104 = *reinterpret_cast<int *>(self + 0x1104);

    VCall3 *vt3 = *reinterpret_cast<VCall3 **>(self);
    vt3->slot003(field_1104, computed, 0);

    int x;
    if (*g_009b7b1c == 0x320) {
        x = 0;
    } else {
        x = (*g_009b7b1c - 0x400) / 2;
    }
    int y = (*g_007af240 - *g_007af248) - computed + *g_009b7b20;
    reinterpret_cast<Win *>(this)->move(x, y);

    (*reinterpret_cast<VCall **>(self))->slot062();
    (*reinterpret_cast<VCall **>(self))->slot092();
}
