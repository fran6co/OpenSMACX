...
// subject: ??0CheckBox@@QAE@H@Z  at 0x0060E670  (233 bytes)
//
...
static int *const g_00662f7a = (int *)0x00662F7A;
...
static int *const g_00670718 = (int *)0x00670718;
static int *const g_0067fc58 = (int *)0x0067FC58;
...
CheckBox::CheckBox(int a1) {
    ...
    if (a1 != 0) {
        *self = 0x670718;
        new (reinterpret_cast<char *>(self) + 0x1c) GraphicWin();
        new (reinterpret_cast<char *>(self) + 0xa34) Dialog();
    }
    char *base = reinterpret_cast<char *>(self);
    int vt0 = *self;
    int off1 = *reinterpret_cast<int *>(vt0 + 4);
    *reinterpret_cast<int *>(base + off1) = 0x6705b0;
    *reinterpret_cast<int *>(base + off1 + 0x444) = 0x6705a8;
    int off2 = *reinterpret_cast<int *>(vt0 + 8);
    *reinterpret_cast<int *>(base + off2) = 0x67059c;
    *reinterpret_cast<int *>(base + off1 - 4) = off1 - 0x1c;
    *reinterpret_cast<int *>(base + off2 - 4) = off2 - 0xa34;
    self[1] = 0;
    self[2] = 0;
    self[3] = 0;
    self[5] = *g_00697108;
