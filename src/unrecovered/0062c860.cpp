...
// calls     0x005D4510 0x00612A70 0x00645930

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: Callback  at 0x0062C860  (119 bytes)
//
...
static int *const g_009bc2cc = (int *)0x009BC2CC;
static int *const g_009bc2e0 = (int *)0x009BC2E0;
extern "C" int __stdcall Callback(int a1, int a2, int a3, int a4) {
    Dialogs *dlg = reinterpret_cast<Dialogs *>(reinterpret_cast<char *>(a4) + 0x21d0);
    dlg->item(reinterpret_cast<char *>(a2), *g_009bc2cc);
    ...
    void *buf = mem_get(0x10);
    int idx = *g_009bc2cc;
    g_009bc2e0[idx] = reinterpret_cast<int>(buf);
    if (buf != 0) {
        *g_009bc2cc = idx + 1;
        memcpy(buf, reinterpret_cast<void *>(a1), 0x10);
    }
    return 1;
}
