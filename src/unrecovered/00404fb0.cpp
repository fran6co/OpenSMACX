// ORIGINAL: 0x00404FB0 FILE
// RULED-OUT: manual operator-new + placement-new(BasePop)+try{placement-new
//            (Scroll)}catch(...){~BasePop();delete;throw;} - compiles but
//            longer (142-157B) than original's 108B; plain `new Popup` is
//            shorter (88B) and closer (matches through the null check and
//            both ctor calls, diverges at the EH state-byte store before
//            Scroll's ctor and the two trailing vtable-pointer patches)
...
// subject: ?alloc@Popup@@QAAHXZ  at 0x00404FB0  (137 bytes)
//
...
static int *const g_00650785 = (int *)0x00650785;
static int *const g_006695c0 = (int *)0x006695C0;
static int *const g_006695c8 = (int *)0x006695C8;
static int *const g_00671a80 = (int *)0x00671A80;
