...
// subject: ?scan_out_line_poly@@YAIHH@Z  at 0x006265A0  (115 bytes)
//
...
void __cdecl scan_out_line_poly(int a1, int a2) {
    unsigned char pixel = *reinterpret_cast<unsigned char *>(g_009bc008);
