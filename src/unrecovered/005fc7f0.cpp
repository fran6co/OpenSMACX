...
// indirect  0x005FC847 0x005FC852 0x005FC859 0x005FC881 0x005FC88C 0x005FC893 0x005FC8B4

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?do_task@@YAHXZ  at 0x005FC7F0  (248 bytes)
//
...
typedef int(__stdcall *PeekMessageAFn)(tagMSG_ *, HWND, UINT, UINT, UINT);
typedef int(__stdcall *TranslateMessageFn)(const tagMSG_ *);
typedef long(__stdcall *DispatchMessageAFn)(const tagMSG_ *);
...
int __cdecl do_task() {
    ...
    *g_009b7b9c = 0;
    ...
    while (true) {
        *g_009b7b9c = 1;
        ...
        check_net();
        do_net();
        if (!peekMessage(&msg, 0, 0xf, 0xf, 1)) {
            break;
        }
    ...
    *g_009b7b9c = 0;
    if (!peekMessage(&msg, 0, 0, 0x400, 1)) {
        if (!peekMessage(&msg, 0, 0x400, 0xffff, 1)) {
            return 0;
        }
