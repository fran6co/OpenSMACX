...
// subject: ?draw_dest_unk1@Sprite@@QAEHPAUBuffer@@HHHHPAE@Z  at 0x005E73CC  (75 bytes)
//
...
int Sprite::draw_dest_unk1(Buffer * a1, int a2, int a3, int a4, int a5, unsigned char * a6) {
    int saved18 = *g_00696d18;
    int saved1c = *g_00696d1c;
    *g_00696d18 = a4;
    *g_00696d1c = a5;
    int result = draw_dest_unk1(a1, a2, a3, a6);
    *g_00696d1c = saved1c;
    *g_00696d18 = saved18;
    return result;
}
