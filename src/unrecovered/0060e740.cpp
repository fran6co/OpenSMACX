...
// subject: ??1CheckBox@@QAE@XZ  at 0x0060E740  (128 bytes)
//
...
CheckBox::~CheckBox() {
    char *ecx_ = reinterpret_cast<char *>(this);
    char *esi = ecx_ - 0x1c;

    int eax = *reinterpret_cast<int *>(ecx_ - 0x1c);
    int edx = *reinterpret_cast<int *>(eax + 4);
    *reinterpret_cast<int *>(esi + edx) = 0x6705b0;

    eax = *reinterpret_cast<int *>(esi);
    edx = *reinterpret_cast<int *>(eax + 4);
    *reinterpret_cast<int *>(ecx_ + 0x428 + edx) = 0x6705a8;

    eax = *reinterpret_cast<int *>(esi);
    edx = *reinterpret_cast<int *>(eax + 8);
    *reinterpret_cast<int *>(esi + edx) = 0x67059c;

    eax = *reinterpret_cast<int *>(esi);
    eax = *reinterpret_cast<int *>(eax + 4);
    edx = eax - 0x1c;
    *reinterpret_cast<int *>(ecx_ - 0x20 + eax) = edx;

    eax = *reinterpret_cast<int *>(esi);
    eax = *reinterpret_cast<int *>(eax + 8);
    edx = eax - 0xa34;
    *reinterpret_cast<int *>(ecx_ - 0x20 + eax) = edx;

    int *edxPtr = *reinterpret_cast<int **>(esi);
    *reinterpret_cast<int *>(esi + 4) = 0;
    *reinterpret_cast<int *>(esi + 8) = 0;
    *reinterpret_cast<int *>(esi + 0xc) = 0;
    *reinterpret_cast<int *>(esi + 0x14) = *g_00697108;
    *reinterpret_cast<int *>(esi + 0x10) = *g_00697104;

    int off = *reinterpret_cast<int *>(reinterpret_cast<char *>(edxPtr) + 8);
    reinterpret_cast<Dialog *>(esi + off)->close();

    eax = *reinterpret_cast<int *>(esi);
    int off2 = *reinterpret_cast<int *>(eax + 4);
    reinterpret_cast<GraphicWin *>(esi + off2)->close();
}
