...
// calls     0x005D4EF0 0x005D5250 0x00616350 0x00618F40

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?init@MultiDebug@@QAEHPAUNet@@PAUWin@@PAE@Z  at 0x005C9860  (123 bytes)
//
...
static int *const g_005c9900 = (int *)0x005C9900;
static int *const g_00691e80 = (int *)0x00691E80;

class MultiDebug { public:
    int init(Net *, Win *, unsigned char *);
};
class GraphicWinInitShim { public:
    int init(int, int, int, int, char *, int, Win *, Menu *, BorderSizing *);
};

int MultiDebug::init(Net * a1, Win * a2, unsigned char * a3) {
    char *self = reinterpret_cast<char *>(this);
    *reinterpret_cast<Net **>(self + 0xa3c) = a1;
    int result = reinterpret_cast<GraphicWinInitShim *>(this)->init(
        0, 0, 0x96, 0x12c, 0, 0x1000002, a2, 0, 0);
    if (result == 0) {
        *reinterpret_cast<unsigned char **>(self + 0xa0) = a3;
        reinterpret_cast<Font *>(self + 0xa14)->init(
            reinterpret_cast<char *>(g_00691e80), 0xa, 0);
        reinterpret_cast<GraphicWin *>(this)->fill(0);
        reinterpret_cast<Time *>(self + 0xa40)->start(
            reinterpret_cast<void (__cdecl *)(int)>(g_005c9900),
            reinterpret_cast<int>(this), 0x3e8, 5);
        result = 0;
    }
    return result;
}
