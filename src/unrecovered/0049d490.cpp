// ORIGINAL: 0x0049D490 FILE
// working copy - scaffold materialised by --work
// name      ?on_selected@ReportWin@@QAEXHH@Z
// size      165 bytes
// spans     0x0049D490-0x0049D535
// prototype void (__thiscall ?on_selected@ReportWin@@QAEXHH@Z)(ReportWin* this, int, int)
// callers   0   call targets   5
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x00496BB0 0x0049BCD0 0x005D5890 0x00609FA0 0x0060A020

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_selected@ReportWin@@QAEXHH@Z  at 0x0049D490  (165 bytes)
//
...
static int *const g_00890d5c = (int *)0x00890D5C;
...
void ReportWin::on_selected(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    ListBox *lb1 = reinterpret_cast<ListBox *>(g_00890208);
    ListBox *lb2 = reinterpret_cast<ListBox *>(g_00890d5c);

    if (a1 < 0x400) {
        *reinterpret_cast<int *>(self + 0x59ac) = a1;
        *reinterpret_cast<int *>(self + 0x59b0) = 0;
        lb1->set_selected_pos(-1, 1);
        lb2->set_selected_id(a1);
    } else {
        if (a1 > 0x5f5e0fd) {
            reinterpret_cast<ListBox *>(self + 0x5a0c)->set_selected_id(99999999);
            return;
        }
        *reinterpret_cast<int *>(self + 0x59ac) = a1 - 0x400;
        *reinterpret_cast<int *>(self + 0x59b0) = 1;
        lb1->set_selected_id(a1);
