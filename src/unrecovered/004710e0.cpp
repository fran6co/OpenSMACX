...
// subject: ?mapwin_system_shutdown@@YAXXZ  at 0x004710E0  (127 bytes)
//
...
static int *const g_007d4064 = (int *)0x007D4064;
void __cdecl mapwin_system_shutdown() {
    int *p = g_007d3c3c;
    do {
        int obj = *p;
        if (obj != 0 && p != g_007d3c3c && *reinterpret_cast<int *>(obj + 0x1dd74) != 0) {
            if (*reinterpret_cast<int *>(obj + 4) != 0) {
                free(reinterpret_cast<void *>(*reinterpret_cast<int *>(obj + 4)));
                *reinterpret_cast<int *>(obj + 4) = 0;
            }
            int vtable = *reinterpret_cast<int *>(obj);
            int offset = *reinterpret_cast<int *>(vtable + 4);
            reinterpret_cast<GraphicWin *>(obj + offset)->close();
        }
        p = p + 1;
    } while (reinterpret_cast<int>(p) < reinterpret_cast<int>(g_007d3c5c));

    if (*g_007d4064 != 0) {
        free(reinterpret_cast<void *>(*g_007d4064));
        *g_007d4064 = 0;
    }
    int vtable2 = *g_007d4060;
    int offset2 = *reinterpret_cast<int *>(vtable2 + 4);
    reinterpret_cast<GraphicWin *>(reinterpret_cast<char *>(g_007d4060) + offset2)->close();
}
