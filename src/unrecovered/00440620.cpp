...
// calls     0x00440080 0x005ED9D0 0x005EDCD0 0x00607C80 0x0062B870
// indirect  0x00440643 0x00440672 0x0044069A

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_iface_group_clicked@DiploPop@@QAEXHHH@Z  at 0x00440620  (171 bytes)
//
...
// This body dispatches through slot(s): 1, 2, 13
class VCall { public:
...
void DiploPop::on_iface_group_clicked(int a1, int a2, int a3) {
    char *self = (char *)this;
    int adjusted = a3;
    if (adjusted > 1000) {
        adjusted -= 1000;
    ...
    int arg;
    if (adjusted == 0) {
        Win *w = (Win *)g_008e9f60;
        w->show(0);

        char *g = *(char **)g_007d3c40;
        char *h = *(char **)g;
        char *i = *(char **)(h + 4);
        char *vbase = (char *)((int)i + (int)g);
        ((VCall2 *)vbase)->slot002();
        ...
        char *i = *(char **)(h + 4);
        char *vbase = (char *)((int)i + (int)g);
        ((VCall2 *)vbase)->slot001(0);

        arg = 0x3ef;
    } else {
        ((VCall2 *)self)->slot013(2);
        ((DiploPop *)(self - 0xa14))->draw_hq();
        return;
    }

    ButtonGroup *bg = (ButtonGroup *)g_007cd12c;
    bg->set(arg, 0);
    ((BaseButton *)(self + 0x2ddc))->set(0);
    ((DiploPop *)(self - 0xa14))->draw_hq();
}
