// ORIGINAL: 0x005FA6B0 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?on_mouse_move@PullDown@@QAEXHH@Z
// size      134 bytes
// spans     0x005FA6B0-0x005FA736
// prototype void (__thiscall ?on_mouse_move@PullDown@@QAEXHH@Z)(PullDown* this, int, int)
// callers   0   call targets   4
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     0x005ED240 0x005F9590 0x005FA7E0 0x005FBDB0
// indirect  0x005FA6FC

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_mouse_move@PullDown@@QAEXHH@Z  at 0x005FA6B0  (134 bytes)
//
...
void PullDown::on_mouse_move(int a1, int a2) {
    RECT *rect = reinterpret_cast<RECT *>(reinterpret_cast<char *>(this) + 0x474);
    ...
    if (menu_ != 0) {
        client_to_screen(&a1, &a2);
        menu_->mouse_move(a1, a2);
    }
}
