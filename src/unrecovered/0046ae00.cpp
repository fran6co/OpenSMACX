...
// name      ?draw_cursor@@YAXXZ
// size      237 bytes
// spans     0x0046AE00-0x0046AEED
// prototype 
// callers   10   call targets   2
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x0046A2A0 0x004BDEA0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?draw_cursor@@YAXXZ  at 0x0046AE00  (237 bytes)
//
...
void __cdecl draw_cursor() {
    extern MapWin *g_win_slots_7d3c3c[];
    extern int g_arr_939340[];
    extern int g_arr_9392c0[];

    if (*g_009392b0 == 0) {
        MapWin **p = g_win_slots_7d3c3c;
        do {
            MapWin *obj = *p;
            if (obj != 0 &&
                (p == g_win_slots_7d3c3c ||
                 *reinterpret_cast<int *>(reinterpret_cast<char *>(obj) + 0x1dd74) != 0)) {
                int idx = *g_009392b8;
                int v2 = g_arr_939340[idx];
                int v3 = g_arr_9392c0[idx];
                char *base = reinterpret_cast<char *>(obj);
                if (*reinterpret_cast<int *>(base + 0x1dda8) <= v2 &&
                    v2 < *reinterpret_cast<int *>(base + 0x1ddd8) +
                         *reinterpret_cast<int *>(base + 0x1ddd0) +
                         *reinterpret_cast<int *>(base + 0x1dda8)) {
                    int v4 = v3;
                    if ((*g_0094988c & 1) == 0) {
                        if (v3 < *reinterpret_cast<int *>(base + 0x1dda4)) {
                            v4 = *g_00949870 + v3;
                        }
                        if (*reinterpret_cast<int *>(base + 0x1ddd4) +
                            *reinterpret_cast<int *>(base + 0x1ddcc) +
                            *reinterpret_cast<int *>(base + 0x1dda4) <= v4) {
                            v4 = v4 - *g_00949870;
                        }
                    }
                    if (*reinterpret_cast<int *>(base + 0x1dda4) <= v4 &&
                        v4 < *reinterpret_cast<int *>(base + 0x1ddd4) +
                             *reinterpret_cast<int *>(base + 0x1ddcc) +
                             *reinterpret_cast<int *>(base + 0x1dda4)) {
                        obj->draw_radius(v3, v2, 0, 2);
                    }
                }
            }
            p++;
        } while (p < reinterpret_cast<MapWin **>(0x7d3c5c));
    }
    reinterpret_cast<TutWin *>(0x008C6E68)->draw_arrow();
}
