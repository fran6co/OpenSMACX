// ORIGINAL: 0x00510520 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?cursor_off@Console@@QAEXXZ
// size      158 bytes
// spans     0x00510520-0x005105BE
// prototype void (__thiscall ?cursor_off@Console@@QAEXXZ)(Console* this)
...
// subject: ?cursor_off@Console@@QAEXXZ  at 0x00510520  (158 bytes)
//
...
void Console::cursor_off() {
    ...
    *reinterpret_cast<int *>(self + 0x23D10) = 0;
    int *entry = g_007d3c3c;
    do {
        int obj = *entry;
        if (obj != 0 && (entry == g_007d3c3c || *reinterpret_cast<int *>(obj + 0x1dd74) != 0)) {
            if (*reinterpret_cast<int *>(obj + 0x1ef4c) != 0 ||
                *reinterpret_cast<int *>(obj + 0x1ef50) != 0x7f00) {
                ...
                reinterpret_cast<Win *>(obj + adjust)->set_cursor(0x7f00);
                *reinterpret_cast<int *>(obj + 0x1ef50) = 0x7f00;
                *reinterpret_cast<int *>(obj + 0x1ef4c) = 0;
            }
            unsigned int flags = *reinterpret_cast<unsigned int *>(*entry + 0x1dd70);
            if ((flags & 0xc40000) != 0) {
                *reinterpret_cast<unsigned int *>(*entry + 0x1dd70) = flags & 0xff3bffff;
                reinterpret_cast<MapWin *>(*entry)->draw_map(1);
            }
            do_non_input();
        }
        ++entry;
    } while (reinterpret_cast<int>(entry) < reinterpret_cast<int>(g_007d3c5c));
