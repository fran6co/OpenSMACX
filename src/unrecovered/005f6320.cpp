...
// subject: ?on_mouse_move@Win@@QAEXHHIH@Z  at 0x005F6320  (155 bytes)
//
...
class Win { public:
    ...
    void on_mouse_move(int, int, unsigned int, int);
};
class VCallX { public:
    virtual void slot000();
    virtual void slot001();
...
void Win::on_mouse_move(int a1, int a2, unsigned int a3, int a4) {
    ...
    if (a4 == 0) {
        *g_009b7ab8 = reinterpret_cast<int>(this);
        MouseCallbackFn fn = *reinterpret_cast<MouseCallbackFn *>(self + 0x408);
        if (fn != 0) {
            fn(a1, a2);
        }
        reinterpret_cast<VCallX *>(this)->slot017(a1, a2);
        void *child = *reinterpret_cast<void **>(self + 0x1c);
        if (child != 0) {
        ...
        void *child = *reinterpret_cast<void **>(self + 0x4c);
        if (child != 0) {
            if (reinterpret_cast<VCallX *>(child)->slot023() == 0) {
                reinterpret_cast<VCallX *>(child)->slot007();
            }
