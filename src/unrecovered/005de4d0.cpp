...
// subject: sub_5de4d0  at 0x005DE4D0  (176 bytes)
//
...
class BufferX : public Buffer { public:
    int sub_5de4d0();
};

int BufferX::sub_5de4d0() {
    if (*(char *)g_009b33cc != 0) {
        char *str = (char *)g_009b33cc;
        unsigned int len = strlen(str);
        write_cent_l(str, *g_009b3a90, *g_009b3a94, *g_009b3a98, (int)len);
        field_18_++;
    }
    *(char *)g_009b33cc = 0;
    *g_009b3a98 = 0;
    ...
    Font *f = font1_;
    if (f->unk_1_ < 0) {
        return *g_009b3a94 + f->line_height_;
    }
    return f->height_ + f->unk_1_ + *g_009b3a94;
}
