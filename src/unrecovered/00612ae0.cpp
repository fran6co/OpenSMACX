...
// calls     0x0060CE10 0x0060E4A0 0x0060FC30 0x00611050

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_mouse_leave@Dialogs@@QAEXHH@Z  at 0x00612AE0  (120 bytes)
//
...
static int *const g_00612b58 = (int *)0x00612B58;
...
// A jump-table switch on a discriminant stored 8 bytes BEFORE `this`
// (this points into an embedded widget sub-object). Case values and the
// per-case adjustor offsets were read straight out of the compiled byte
// table at 0x612B70 and pointer table at 0x612B58: D=1 -> CheckBox
// (this-0x114), D=2 -> ListBox (this-0x140), D=8 -> SpriteBox (this-0x8C),
// D=16 -> RadioButton (this-0x12C); every other D in [1,16] is a no-op.
void Dialogs::on_mouse_leave(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    int kind = *reinterpret_cast<int *>(self - 8);
    switch (kind) {
    case 1:
        reinterpret_cast<CheckBox *>(self - 0x114)->on_mouse_leave(a1, a2);
        break;
    case 2:
        reinterpret_cast<ListBox *>(self - 0x140)->on_mouse_leave(a1, a2);
        break;
    case 8:
        reinterpret_cast<SpriteBox *>(self - 0x8C)->on_mouse_leave(a1, a2);
        break;
    case 16:
        reinterpret_cast<RadioButton *>(self - 0x12C)->on_mouse_leave(a1, a2);
        break;
    default:
        break;
    }
