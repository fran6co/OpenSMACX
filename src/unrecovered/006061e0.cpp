// ORIGINAL: 0x006061E0 FILE
// working copy - scaffold materialised by --work
// name      ?on_left_down@Scroll@@QAEXHH@Z
// size      216 bytes
// spans     0x006061E0-0x006062B8
// prototype void (__thiscall ?on_left_down@Scroll@@QAEXHH@Z)(Scroll* this, int, int)
// callers   0   call targets   0
// kind      game
// flags     hidden;sp_ready;purged_ok
// calls     (none)
// indirect  0x0060622C 0x00606253 0x00606280

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_down@Scroll@@QAEXHH@Z  at 0x006061E0  (216 bytes)
//
...
// This body dispatches slot 17 with two int args, so a second shim class
// (matching layout up to that slot) replaces the file's nullary VCall for
// this call site only.
class VCall2 { public:
    virtual void slot000();
    virtual void slot001();
...
void Scroll::on_left_down(int a1, int a2) {
    if (win_parent_ == 0) {
        return;
    }
    if (-static_cast<int>(GraphicWin::buffer_.height_) < static_cast<int>(GraphicWin::buffer_.width_)) {
        if (a1 < thumb_rect_.left) {
            field_A44_ = 0xffffffff;
            field_A38_ = 0;
            reinterpret_cast<VCall2 *>(this)->slot017(a1, a2);
            goto tail;
        }
        if (thumb_rect_.right < a1) {
            field_A44_ = 1;
            field_A38_ = 0;
            reinterpret_cast<VCall2 *>(this)->slot017(a1, a2);
            goto tail;
        ...
        if (a2 < thumb_rect_.top) {
            field_A44_ = 0xffffffff;
        } else {
            if (a2 <= thumb_rect_.bottom) {
                field_A44_ = 0;
                goto tail;
            }
            field_A44_ = 1;
