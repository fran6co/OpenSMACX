...
// calls     0x0062B870
// indirect  0x004717E3 0x004717F5 0x00471815

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?clear@MessageWin@@QAEXXZ  at 0x004717A0  (196 bytes)
//
...
void MessageWin::clear() {
    *g_009393d0 = 0;
    char *self = reinterpret_cast<char *>(this);
    int disp = (*reinterpret_cast<int **>(self + 0x64))[2];
    char *base = self + disp + 0x120;
    if (*reinterpret_cast<DialogEntry **>(base + 8) != 0) {
        int i;
        for (i = 0; i < *reinterpret_cast<int *>(base + 0x10); ++i) {
            DialogEntry *item = *reinterpret_cast<DialogEntry **>(base + 8);
            *reinterpret_cast<DialogEntry **>(base + 0xc) = item->next;
            void *payload = item->payload;
            reinterpret_cast<MgrVCall *>(base)->slot1(payload);
            if (payload != 0) {
                char *vtbl = *reinterpret_cast<char **>(payload);
                int adjdisp = *reinterpret_cast<int *>(vtbl + 4);
                char *adjusted = reinterpret_cast<char *>(payload) + adjdisp;
                reinterpret_cast<AdjVCall *>(adjusted)->slot0(1);
            }
            (*reinterpret_cast<DialogEntry **>(base + 8))->payload = 0;
            DialogEntry *item2 = *reinterpret_cast<DialogEntry **>(base + 8);
            if (item2 != 0) {
                char *vtbl2 = *reinterpret_cast<char **>(item2);
                int adjdisp2 = *reinterpret_cast<int *>(vtbl2 + 4);
                char *adjusted2 = reinterpret_cast<char *>(item2) + adjdisp2;
                reinterpret_cast<AdjVCall *>(adjusted2)->slot0(1);
            }
            *reinterpret_cast<DialogEntry **>(base + 8) = *reinterpret_cast<DialogEntry **>(base + 0xc);
        }
        *reinterpret_cast<DialogEntry **>(base + 8) = 0;
        *reinterpret_cast<int *>(base + 0x14) = 0;
        *reinterpret_cast<int *>(base + 0x10) = 0;
    }
    int disp2 = (*reinterpret_cast<int **>(self + 0x64))[2];
    *reinterpret_cast<int *>(self + disp2 + 0x150) = 0;
