// ORIGINAL: 0x00515530 FILE
// RULED-OUT: caching `MapWin *w = ...` upfront (mismatch #1, push vs test -
//            original reloads *g_007d3c3c fresh at each use); re-reading
//            *g_007d3c3c inline at every access reaches SHAPE_EXACT (same
//            197 bytes, same mnemonics/operand kinds, one constant differs)
// working copy - scaffold materialised by --work
// name      ?survey2@Console@@QAEXXZ
// size      197 bytes
// spans     0x00515530-0x005155F5
// prototype void (__thiscall ?survey2@Console@@QAEXXZ)(Console* this)
// callers   0   call targets   3
// kind      game
// flags     sp_ready;purged_ok
// calls     0x0046A550 0x004BA5F0 0x004BE650

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?survey2@Console@@QAEXXZ  at 0x00515530  (197 bytes)
//
...
static int *const g_0068a8e0 = (int *)0x0068A8E0;
...
void Console::survey2() {
    ...
    field_23C00_ = 1;
    unsigned int saved = reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_;
    reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_ = saved & 0xfffff7ff;
    reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_ =
        reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_ | 0x1000;
    reinterpret_cast<MapWin *>(*g_007d3c3c)->draw_map(1);
    reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_ = saved;
    reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_ =
        reinterpret_cast<MapWin *>(*g_007d3c3c)->field_1DD70_ & 0xffffefff;
    if (tut_check(0x400) != 0) {
        int idx = *g_009392b8;
        int p_table2 = reinterpret_cast<int *>(g_009392c0)[idx];
        int p_table1 = reinterpret_cast<int *>(g_00939340)[idx];
        reinterpret_cast<TutWin *>(g_008c6e68)->tut_map(
            reinterpret_cast<const char *>(g_0068a8e0), p_table2, p_table1, -1, 0, 0, -1, -1);
    }
}
