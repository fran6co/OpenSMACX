...
// calls     0x00467430 0x005D5250 0x005D56B0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?draw_my_dest@@YAXH@Z  at 0x004B4BF0  (213 bytes)
//
...
void __cdecl draw_my_dest(int a1) {
    extern int g_9a64c8;
    extern int g_939284;
    extern unsigned char g_9a64c0;
    extern unsigned char g_952836[];
    extern unsigned char g_952839[];
    extern char g_952828[];
    extern char g_95282a[];
    extern char g_95283c[];
    extern char g_952844[];
    extern char g_952832[];
    extern unsigned char g_9ab88c[];
    extern unsigned char g_94a379[];
    extern int g_6874c4;
    ...
    int t = a1 + a1 * 2;
    int idx = (a1 + t * 4) * 4;
    if (g_952836[idx] != g_939284 && !(g_9a64c0 & 0x80)) {
        return;
    }
    if (g_952839[idx] != 0x18) {
        return;
    }

    reinterpret_cast<GraphicWin *>(0x937118)->fill(9);

    int typeIdx = *reinterpret_cast<short *>(g_952832 + idx);
    int u = typeIdx + typeIdx * 2;
    unsigned char byteVal = g_9ab88c[(typeIdx + u * 4) * 4];
    unsigned int v = byteVal + byteVal * 8;
    unsigned char color = g_94a379[v << 4];

    reinterpret_cast<MapWin *>(0x9156b0)->dest_line(
        *reinterpret_cast<short *>(g_952828 + idx),
        *reinterpret_cast<short *>(g_95282a + idx),
        *reinterpret_cast<short *>(g_95283c + idx),
        *reinterpret_cast<short *>(g_952844 + idx),
        typeIdx, g_952836[idx], color, 0, 3, 5, 1);

    reinterpret_cast<GraphicWin *>(0x937118)->update(0);
    g_6874c4 = a1;
}
