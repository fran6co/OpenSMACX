...
// subject: timeGetTime  at 0x005A58D0  (6 bytes)
//
...
typedef int (__cdecl *TimeGetTimeProc)();

extern "C" int __cdecl timeGetTime() {
    return (*reinterpret_cast<TimeGetTimeProc *>(g_00669368))();
}
