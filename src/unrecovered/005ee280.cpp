...
//            same 0.594 mnemonic similarity and diverge two instructions
//            in - original does `test edx,edx; je`, every spelling tried
//            compiles the same guard to `xor eax,eax; cmp ...; je`
//            instead, at every flag set the scorer swept. Semantics look
//            right (matches the Ghidra shape); the front-loaded decrement
//            and unconditional early store of the "count-1" value that
//            original performs before even reading the top-of-stack slot
//            did not reproduce.
