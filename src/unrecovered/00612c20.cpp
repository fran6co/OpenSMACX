...
// calls     0x0060AA60 0x0060DE10 0x0060F700 0x00611150

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_down@Dialogs@@QAEXHH@Z  at 0x00612C20  (120 bytes)
//
...
static int *const g_00612c98 = (int *)0x00612C98;
...
void Dialogs::on_left_down(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    switch (kind_) {
    case 1:
        reinterpret_cast<CheckBox *>(self + 0x74)->on_left_down(a1, a2);
        break;
    case 2:
        reinterpret_cast<ListBox *>(self + 0x48)->on_left_down(a1, a2);
        break;
    case 8:
        reinterpret_cast<SpriteBox *>(self + 0xfc)->on_left_down(a1, a2);
        break;
    case 16:
        reinterpret_cast<RadioButton *>(self + 0x5c)->on_left_down(a1, a2);
        break;
    default:
        break;
    }
