...
// subject: ?on_post_window_init@Popup@@QAEXXZ  at 0x00404EF0  (138 bytes)
//
...
class Win { public:
    ...
    void set_bottom_border_thickness(int);
...
class Popup : public BasePop { public:
    ...
    void on_post_window_init();
};
void Popup::on_post_window_init() {
    char *self = reinterpret_cast<char *>(this);
    if (field_A14_ == 0 && (int)field_30AC_ / 10000 != 1000) {
        *reinterpret_cast<int *>(self + 0x2218) = 0;
        *reinterpret_cast<int *>(self + 0x221c) = 0;
        set_border_thickness(0);
        set_caption_height(0);
        if (field_A48_ != 0) {
            field_16C_ = 0x1a;
            iFlags_ |= 0x4000000;
        }
        set_bottom_border_thickness(0);
    }
}
