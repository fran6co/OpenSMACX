// ORIGINAL: 0x005ECEC0 FILE
// RULED-OUT: guard-clause form (`if (w!=0 || w==this) return 1; if (w!=0)
//            {loop} return 0;`), matching Ghidra's redundant double
//            null-check; compiles and matches the loop body, diverges at #0
//            in prologue register-save order (mov vs push)
// working copy - scaffold materialised by --work
// name      ?UNK4@Win@@QAEHXZ
// size      92 bytes
// spans     0x005ECEC0-0x005ECF1C
...
// subject: ?UNK4@Win@@QAEHXZ  at 0x005ECEC0  (92 bytes)
//
