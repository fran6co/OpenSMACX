...
// calls     0x005EDCD0 0x00616730
// indirect  0x004AB56C 0x004AB58A

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?close_sat@ReportIf@@QAEXXZ  at 0x004AB550  (169 bytes)
//
...
static int *const g_00884738 = (int *)0x00884738;
static int *const g_00884760 = (int *)0x00884760;
static int *const g_00939284 = (int *)0x00939284;

class ReportIf { public:
    void close_sat();
};
void ReportIf::close_sat() {
    char *self = (char *)this;
    for (int i = 1; i < 8; ++i) {
        char *obj = self + 0x13778 + (i - 1) * 0xb4c;
        if (i != *g_00939284) {
            ((VCall *)obj)->slot002();
        }
    }
    char *obj2 = self + 0x18720;
    for (int j = 5; j != 0; --j) {
        ((VCall *)obj2)->slot002();
        obj2 += 0xb4c;
    }
    ...
    ((Win *)g_00880ed8)->hide();
    ((Time *)g_00884738)->stop();
    ((Time *)g_00884760)->stop();
}
