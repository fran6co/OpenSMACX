...
// calls     0x00462F00 0x004632D0 0x00466CA0 0x004688E0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?gen_tile@MapWin@@QAEXHHHH@Z  at 0x00468C20  (165 bytes)
//
...
class MapWin { public:
    ...
    void gen_tile(int, int, int, int);
};
void MapWin::gen_tile(int a1, int a2, int a3, int a4) {
    int px = a1;
    int py = a2;
    tile_to_pixel(a1, a2, &px, &py);
    char *self = (char *)this;
    Buffer *computed;
    if (this == 0) {
        computed = 0;
    } else {
        computed = (Buffer *)(*(int *)(*(int *)self + 4) + 0x444 + (int)self);
    }
    gen_terrain_poly(computed, this, field_1DD98_, a3, -1, field_1DD70_, a1, a2, px, py);
    if (a2 >= 0 && a2 < *g_00949874 && a1 >= 0 && a1 < *g_00949870 && a4 != 0) {
        draw_vehicles(a1, a2, px, py - field_1DDC0_, a3);
        gen_overlays(a1, a2);
    }
}
