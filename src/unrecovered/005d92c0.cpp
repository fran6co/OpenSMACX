...
// TRIED: same shape as 0x005D8740/0x005D90D0 - see 0x005D8740's note for the stdcall-Unlock form and the __fastcall(self, unused-edx, 7 stack ints) signature override.
...
// subject: sub_5d92c0  at 0x005D92C0  (248 bytes)
//
...
extern "C" int __fastcall sub_5d92c0(void *self, void * /*edx*/,
...
forward:
    {
        int result = reinterpret_cast<Sprite *>(g_009b3a50)
                         ->draw_dest_unk2(reinterpret_cast<Buffer *>(a1), a2, a3, a4, a5, a6,
                                          reinterpret_cast<unsigned char *>(a7));
        *g_009b3a54 = 0;
        return result;
    }
}
