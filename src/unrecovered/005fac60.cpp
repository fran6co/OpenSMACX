...
// subject: ??0Menu@@QAE@XZ  at 0x005FAC60  (168 bytes)
//
...
static int *const g_00662cf8 = (int *)0x00662CF8;
static int *const g_006700a8 = (int *)0x006700A8;
static int *const g_006700b0 = (int *)0x006700B0;
static int *const g_0067f960 = (int *)0x0067F960;
...
Menu::Menu() {
    ...
    *(int *)(self) = (int)g_006700b0;
    *(int *)(self + 0x444) = (int)g_006700a8;
    *(int *)(self + 0xa14) = 0;
    *(int *)(self + 0xa18) = 0;
    *(int *)(self + 0xa20) = 0;
    *(int *)(self + 0xa24) = -1;
