// ORIGINAL: 0x004AE380 FILE
// RULED-OUT: void return (no eax reload after soft_update); this+0xfd0/0xfd4
//            reached by offset since SetupWin carries no declared fields
// working copy - scaffold materialised by --work
// name      ?on_mouse_move@SetupWin@@QAEHHH@Z
// size      90 bytes
// spans     0x004AE380-0x004AE3DA
// prototype int (__thiscall ?on_mouse_move@SetupWin@@QAEHHH@Z)(SetupWin* this, int xCoord, int yCoord)
// callers   0   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x004AE4D0 0x005D5890 0x005FAB00

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_mouse_move@SetupWin@@QAEHHH@Z  at 0x004AE380  (90 bytes)
//
...
class SetupWin { public:
    ...
    int on_mouse_move(int, int);
};
int SetupWin::on_mouse_move(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    Spot *spotCheck = reinterpret_cast<Spot *>(self + 0xfd4);
    int *selectedItem = reinterpret_cast<int *>(self + 0xfd0);
    int result = spotCheck->check(a1, a2, &a2, 0);
    if (result == -1) {
        return result;
    }
    if (a2 == *selectedItem) {
