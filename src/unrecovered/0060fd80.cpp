...
// subject: sub_60fd80  at 0x0060FD80  (184 bytes)
//
...
class Sub60fd80Base { public:
    void *dtor(unsigned int flag);
};

void *Sub60fd80Base::dtor(unsigned int flag) {
    char *esi = (char *)this;
    char *edi = esi + 0x1c;
