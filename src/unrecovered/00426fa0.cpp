// ORIGINAL: 0x00426FA0 BYTE_EXACT FILE
// working copy - scaffold materialised by --work
// name      ?on_status@CouncWin@@QAEXH@Z
// size      180 bytes
// spans     0x00426FA0-0x00427054
// prototype void (__thiscall ?on_status@CouncWin@@QAEXH@Z)(CouncWin* this, int)
// callers   0   call targets   7
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x0045D380 0x0045D440 0x0045D970 0x005D56B0 0x005ED9D0 0x005EDCD0 0x005FCBB0
// indirect  0x00426FBD 0x00426FD3 0x0042701D

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_status@CouncWin@@QAEXH@Z  at 0x00426FA0  (180 bytes)
//
...
class VCallI { public:
    virtual void slot000();
    virtual void slot001(int); // offset 0x4
};

void CouncWin::on_status(int a1) {
    char *self = reinterpret_cast<char *>(this);
    if (a1 != 0) {
        char *iface = self - 0xa14;
        reinterpret_cast<VCall *>(iface)->slot012();
        int i = 0;
        char *elem = self + 0x380;
        do {
            if (i != 5) {
                reinterpret_cast<VCallI *>(elem)->slot001(0);
            }
            ++i;
            elem += 0xb4c;
        } while (i < 6);
        ...
        do_all_draws();
        slide_show(reinterpret_cast<GraphicWin *>(iface), 0);
        reinterpret_cast<Win *>(iface)->show(3);
        return;
    }
    char *elem = self + 0x380;
    for (int i = 6; i != 0; --i) {
        reinterpret_cast<VCall *>(elem)->slot002();
        elem += 0xb4c;
    }
    reinterpret_cast<SubInterface *>(self)->release_iface_mode();
    char *iface = self - 0xa14;
    slide_hide(reinterpret_cast<GraphicWin *>(iface), 0);
    reinterpret_cast<Win *>(iface)->hide();
    do_all_draws();
}
