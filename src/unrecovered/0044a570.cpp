// ORIGINAL: 0x0044A570 FILE
// working copy - scaffold materialised by --work
// name      ?on_button_clicked@FameWin@@QAEXH@Z
// size      208 bytes
// spans     0x0044A570-0x0044A640
// prototype void (__thiscall ?on_button_clicked@FameWin@@QAEXH@Z)(FameWin* this, int)
// callers   0   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x005D4E40 0x005D7470 0x0062B870
// indirect  0x0044A596 0x0044A603 0x0044A631

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_button_clicked@FameWin@@QAEXH@Z  at 0x0044A570  (208 bytes)
//
...
void FameWin::on_button_clicked(int a1) {
    if (a1 == 0x7b8) {
        reinterpret_cast<Buffer *>(reinterpret_cast<char *>(this) + 0xa91c)->close();
    ...
    if (idx >= 0 && idx <= 5) {
        int row = 0;
        unsigned char *base = g_009a3840_arr;
        do {
            int col = 0;
            unsigned char *entry = base;
            do {
                if ((entry[0] & 1) && ((1 << idx) & entry[1])) {
                    reinterpret_cast<ButtonGroup *>(reinterpret_cast<char *>(this) + 0x5970)->set(row + 1, 1);
                    field_a918_ = col;
            ...
            base += 0x2bc;
            ++row;
        } while (base < reinterpret_cast<unsigned char *>(g_009a4b64));
        reinterpret_cast<VCall *>(this)->slot062();
    }
}
