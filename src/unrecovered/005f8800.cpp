...
// subject: ??0PullDown@@QAE@XZ  at 0x005F8800  (147 bytes)
//
...
static int *const g_0066ff38 = (int *)0x0066FF38;
static int *const g_0066ff40 = (int *)0x0066FF40;
...
PullDown::PullDown() {
    *(int *)this = 0x66ff40;
    *(int *)((char *)this + 0x444) = 0x66ff38;
    for (int i = 0; i < 0x40; i++) {
        items_[i].text = 0;
        items_[i].right_text = 0;
        items_[i].id = -1;
        items_[i].flags = 0;
        items_[i].mnemonic = 0;
    }
    ...
    dirty_ = 1;
    field_A14_ = 0;
    field_F38_ = *g_009b7b58;
    field_F3C_ = *g_009b7b5c;
}
