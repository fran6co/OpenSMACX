...
// calls     0x0046A550 0x0046AD60 0x004B9EA0 0x005109B0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?set_cursor@Console@@QAEXHH@Z  at 0x005147E0  (157 bytes)
//
...
void Console::set_cursor(int a1, int a2) {
    if (a2 < 0 || a2 >= *g_00949874 || a1 < 0 || a1 >= *g_00949870) {
        return;
    }
