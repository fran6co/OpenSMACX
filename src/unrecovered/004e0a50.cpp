// ORIGINAL: 0x004E0A50 FILE
// RULED-OUT: `a1 > 5` (jl/jle flip at #12, fixed by `a1 >= 6`); `counter =
//            a1 - 6` as one expression (lea vs sub at #15, tried splitting
//            into `counter=a1; counter-=6;`, no change). Same size as
//            original (127/127), mismatch only at #15.
// working copy - scaffold materialised by --work
// name      ?editor_paints@Console@@QAEXH@Z
// size      127 bytes
// spans     0x004E0A50-0x004E0ACF
// prototype void (__thiscall ?editor_paints@Console@@QAEXH@Z)(Console* this, int)
// callers   5   call targets   3
// kind      game
// flags     frame;hidden;sp_ready;purged_ok
// calls     0x00458910 0x0045B550 0x0062B870

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?editor_paints@Console@@QAEXH@Z  at 0x004E0A50  (127 bytes)
//
...
static int *const g_007cd1c0 = (int *)0x007CD1C0;
static int *const g_007cd244 = (int *)0x007CD244;
...
void Console::editor_paints(int a1) {
    *g_00945ae0 = a1;
    *g_007ad330 = 7;
    ...
    if (a1 >= 6 && a1 < 0x1a) {
        ...
        int *p = g_00691ae8;
        do {
            if (*p == 0 && limit <= counter) {
                --counter;
            }
            p -= 8;
            --limit;
        } while (p >= g_00691888);
        result = counter + 0x3f9;
    }
    if (*g_007cd244 != result) {
        reinterpret_cast<ButtonGroup *>(g_007cd1c0)->set(result, 1);
    }
}
