...
// TRIED: read the embedded jump/byte tables at 0x612DD8/0x612DEC directly (tools/disasm.py --bytes) to recover the kind->handler mapping (1->CheckBox -276, 2->ListBox -320, 8->SpriteBox -140, 16->RadioButton -300; every other kind in [1,16] is a no-op) and wrote it as a plain `switch`. SHAPE_EXACT: same 35 mnemonics, only the compiler's own table addresses/immediates differ.
...
// calls     0x0060C710 0x0060E1E0 0x0060FA80 0x006112E0

// GENERATED SKELETON - tools/emit_translation_unit.py
// subject: ?on_left_double_click@Dialogs@@QAEXHH@Z  at 0x00612D60  (120 bytes)
//
...
static int *const g_00612dd8 = (int *)0x00612DD8;
...
void Dialogs::on_left_double_click(int a1, int a2) {
    char *self = reinterpret_cast<char *>(this);
    unsigned int kind = *reinterpret_cast<int *>(self - 8) - 1;
    if (kind > 0xf) {
        return;
    }
    switch (kind) {
    case 0:
        reinterpret_cast<CheckBox *>(self - 0x114)->on_left_double_click(a1, a2);
        break;
    case 1:
        reinterpret_cast<ListBox *>(self - 0x140)->on_left_double_click(a1, a2);
        break;
    case 7:
        reinterpret_cast<SpriteBox *>(self - 0x8c)->on_left_double_click(a1, a2);
        break;
    case 15:
        reinterpret_cast<RadioButton *>(self - 0x12c)->on_left_double_click(a1, a2);
        break;
    default:
        break;
    }
