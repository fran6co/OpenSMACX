...
#include "stringbox.h"
  ...
  * is exact; NewTechWin's own extent is not established and nothing pins its
  * sizeof.
  *
...
class NewTechWin : public GraphicWin {
 public:
  ...
  // 74 member(s) from the IDA database, 4 named; it starts a member at 0xA14, which is where src/ ends.
